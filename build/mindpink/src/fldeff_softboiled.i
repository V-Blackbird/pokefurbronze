...
{
    u16 maxHp = GetMonData(&gPlayerParty[GetCursorSelectionMonId()], 58);
    u16 curHp = GetMonData(&gPlayerParty[GetCursorSelectionMonId()], 57);
...
void Task_TryUseSoftboiledOnPartyMon(u8 taskId)
{
    ...
    {
        curHp = GetMonData(&gPlayerParty[recipientPartyId], 57);
        if (curHp == 0
            || userPartyId == recipientPartyId
            || GetMonData(&gPlayerParty[recipientPartyId], 58) == curHp)
