...
extern const u8 gText_PokeSum_EggOrigin_Trade[];
# 17 "src/learn_move.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/learn_move.c" 2
# 1 "include/constants/moves.h" 1
# 19 "src/learn_move.c" 2
# 116 "src/learn_move.c"
...
static __attribute__((section("ewram_data"))) struct LearnMoveGfxResources * sMoveRelearner = ((void *)0);
...
static const struct SpriteTemplate sSpriteTemplate_MoveRelearnerListMenuScrollIndicators = {
    5525, 5526, &sOamdata_MoveRelearnerListMenuScrollIndicators, sSpriteAnimTable_MoveRelearnerListMenuScrollIndicators, ((void *)0), gDummySpriteAffineAnimTable, SpriteCB_ListMenuScrollIndicators
};
...
static void MoveRelearnerLoadBgGfx(void)
{
    ...
    if (InitWindows(sWindowTemplates))
    {
        ...
        for (i = 0; i < (sizeof(sWindowTemplates) / sizeof((sWindowTemplates)[0])); i++)
        {
        ...
        LoadUserWindowGfx(0, 1, (0x000 + ((14) * 16)));
        ListMenuLoadStdPalAt((0x000 + ((13) * 16)), 1);
        LoadPalette(gMoveRelearner_Pal, (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
...
static void CB2_MoveRelearner(void)
{
    ...
    if (sMoveRelearner->scheduleMoveInfoUpdate)
    {
        ...
        sMoveRelearner->scheduleMoveInfoUpdate = 0;
    }
    RunTasks();
    RunTextPrinters();
    AnimateSprites();
...
static void MoveRelearnerStateMachine(void)
{
    ...
    case 0:
        ...
        PrintTeachWhichMoveToStrVar1(0);
        MoveLearnerInitListMenu();
        sMoveRelearner->scheduleMoveInfoUpdate = 1;
        break;
    case 1:
        if (!gPaletteFade.active)
    ...
    case 28:
        ...
        DrawTextBorderOnWindows6and7();
        MoveLearnerInitListMenu();
        PrintTeachWhichMoveToStrVar1(1);
        PrintMoveInfoHandleCancel_CopyToVram();
        break;
    case 29:
        if (!gPaletteFade.active)
        {
            ...
            {
                move = GetMonData(&gPlayerParty[sMoveRelearner->selectedPartyMember], 13 + sMoveRelearner->selectedMoveSlot);
...
static void InitMoveRelearnerStateVariables(void)
{
    ...
    sMoveRelearner->scheduleMoveInfoUpdate = 0;
    for (i = 0; i < 20; i++)
        sMoveRelearner->learnableMoves[i] = 0;
}
...
static void SpawnListMenuScrollIndicatorSprites(void)
{
    ...
    gSprites[sMoveRelearner->spriteIds[0]].data[2] = 1;
    for (i = 0; i < 2; i++)
        gSprites[sMoveRelearner->spriteIds[i]].invisible = 1;
}
...
static void MoveRelearnerInitListMenuBuffersEtc(void)
{
    ...
    GetMonData(&gPlayerParty[sMoveRelearner->selectedPartyMember], 2, nickname);
...
static void LoadMoveInfoUI(void)
{
    BlitMenuInfoIcon(0, (18 + 1), 1, 4);
    BlitMenuInfoIcon(1, (18 + 2), 0, 4);
    BlitMenuInfoIcon(1, (18 + 3), 0, 19);
    BlitMenuInfoIcon(0, (18 + 4), 1, 19);
    BlitMenuInfoIcon(0, (18 + 5), 1, 34);
    PutWindowTilemap(0);
    PutWindowTilemap(1);
    PutWindowTilemap(4);
    PutWindowTilemap(3);
...
static void PrintTextOnWindow(u8 windowId, const u8 *str, u8 x, u8 y, s32 speed, s32 colorIdx)
{
    ...
    if (colorIdx != 1)
        FillWindowPixelBuffer(windowId, ((sMoveRelearner->textColor[0]) | ((sMoveRelearner->textColor[0]) << 4)));
