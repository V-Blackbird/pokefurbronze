# 0 "src/wild_pokemon_area.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/wild_pokemon_area.c"
...
# 9 "src/wild_pokemon_area.c" 2
# 1 "include/constants/region_map_sections.h" 1
# 10 "src/wild_pokemon_area.c" 2
...
static const u16 sDexAreas_Kanto[][2] = {
    { 0x58, DEX_AREA_PALLET_TOWN },
    { 0x59, DEX_AREA_VIRIDIAN_CITY },
    { 0x5A, DEX_AREA_PEWTER_CITY },
    { 0x5B, DEX_AREA_CERULEAN_CITY },
    { 0x5C, DEX_AREA_LAVENDER_TOWN },
    { 0x5D, DEX_AREA_VERMILION_CITY },
    { 0x5E, DEX_AREA_CELADON_CITY },
    { 0x5F, DEX_AREA_FUCHSIA_CITY },
    { 0x60, DEX_AREA_CINNABAR_ISLAND },
    { 0x61, DEX_AREA_INDIGO_PLATEAU },
    { 0x62, DEX_AREA_SAFFRON_CITY },
    { 0x63, DEX_AREA_ROUTE_4 },
    { 0x64, DEX_AREA_ROUTE_10 },
    { 0x65, DEX_AREA_ROUTE_1 },
    { 0x66, DEX_AREA_ROUTE_2 },
    { 0x67, DEX_AREA_ROUTE_3 },
    { 0x68, DEX_AREA_ROUTE_4 },
    { 0x69, DEX_AREA_ROUTE_5 },
    { 0x6A, DEX_AREA_ROUTE_6 },
    { 0x6B, DEX_AREA_ROUTE_7 },
    { 0x6C, DEX_AREA_ROUTE_8 },
    { 0x6D, DEX_AREA_ROUTE_9 },
    { 0x6E, DEX_AREA_ROUTE_10 },
    { 0x6F, DEX_AREA_ROUTE_11 },
    { 0x70, DEX_AREA_ROUTE_12 },
    { 0x71, DEX_AREA_ROUTE_13 },
    { 0x72, DEX_AREA_ROUTE_14 },
    { 0x73, DEX_AREA_ROUTE_15 },
    { 0x74, DEX_AREA_ROUTE_16 },
    { 0x75, DEX_AREA_ROUTE_17 },
    { 0x76, DEX_AREA_ROUTE_18 },
    { 0x77, DEX_AREA_ROUTE_19 },
    { 0x78, DEX_AREA_ROUTE_20 },
    { 0x79, DEX_AREA_ROUTE_21 },
    { 0x7A, DEX_AREA_ROUTE_22 },
    { 0x7B, DEX_AREA_ROUTE_23 },
    { 0x7C, DEX_AREA_ROUTE_24 },
    { 0x7D, DEX_AREA_ROUTE_25 },
    { 0x7E, DEX_AREA_VIRIDIAN_FOREST },
    { 0x7F, DEX_AREA_MT_MOON },
    { 0x80, DEX_AREA_VERMILION_CITY },
    { 0x81, DEX_AREA_SAFFRON_CITY },
    { 0x82, DEX_AREA_SAFFRON_CITY },
    { 0x83, DEX_AREA_DIGLETTS_CAVE },
    { 0x84, DEX_AREA_VICTORY_ROAD },
    { 0x85, DEX_AREA_CELADON_CITY },
    { 0x86, DEX_AREA_SAFFRON_CITY },
    { 0x87, DEX_AREA_POKEMON_MANSION },
    { 0x88, DEX_AREA_SAFARI_ZONE },
    { 0x89, DEX_AREA_VICTORY_ROAD },
    { 0x8A, DEX_AREA_ROCK_TUNNEL },
    { 0x8B, DEX_AREA_SEAFOAM_ISLANDS },
    { 0x8C, DEX_AREA_POKEMON_TOWER },
    { 0x8D, DEX_AREA_CERULEAN_CAVE },
    { 0x8E, DEX_AREA_POWER_PLANT },
    { 0xC5, DEX_AREA_KAILO_TOWN }
};

static const u16 sDexAreas_Sevii1[][2] = {
 { 0x96, DEX_AREA_KINDLE_ROAD },
 { 0x97, DEX_AREA_TREASURE_BEACH },
 { 0x8F, DEX_AREA_ONE_ISLAND },
 { 0xAF, DEX_AREA_MT_EMBER }
};

static const u16 sDexAreas_Sevii2[][2] = {
 { 0x98, DEX_AREA_CAPE_BRINK },
 { 0x90, DEX_AREA_TWO_ISLAND }
};

static const u16 sDexAreas_Sevii3[][2] = {
 { 0x99, DEX_AREA_BOND_BRIDGE },
 { 0x9A, DEX_AREA_THREE_ISLE_PATH },
 { 0x91, DEX_AREA_THREE_ISLAND },
 { 0xB0, DEX_AREA_BERRY_FOREST },
 { 0xB9, DEX_AREA_THREE_ISLE_PATH }
};

static const u16 sDexAreas_Sevii4[][2] = {
 { 0x92, DEX_AREA_FOUR_ISLAND },
 { 0xB1, DEX_AREA_ICEFALL_CAVE }
};

static const u16 sDexAreas_Sevii5[][2] = {
 { 0x9F, DEX_AREA_RESORT_GORGEOUS },
 { 0xA0, DEX_AREA_WATER_LABYRINTH },
 { 0xA1, DEX_AREA_FIVE_ISLE_MEADOW },
 { 0xA2, DEX_AREA_MEMORIAL_PILLAR },
 { 0x93, DEX_AREA_FIVE_ISLAND },
 { 0xB2, DEX_AREA_FIVE_ISLE_MEADOW },
 { 0xB5, DEX_AREA_LOST_CAVE }
};

static const u16 sDexAreas_Sevii6[][2] = {
 { 0xA3, DEX_AREA_OUTCAST_ISLAND },
 { 0xA4, DEX_AREA_GREEN_PATH },
 { 0xA5, DEX_AREA_WATER_PATH },
 { 0xA6, DEX_AREA_RUIN_VALLEY },
 { 0xB4, DEX_AREA_DOTTED_HOLE },
 { 0xB6, DEX_AREA_PATTERN_BUSH },
 { 0xB7, DEX_AREA_ALTERING_CAVE }
};

static const u16 sDexAreas_Sevii7[][2] = {
 { 0xA7, DEX_AREA_TRAINER_TOWER },
 { 0xA8, DEX_AREA_CANYON_ENTRANCE },
 { 0xA9, DEX_AREA_SEVAULT_CANYON },
 { 0xAA, DEX_AREA_TANOBY_RUINS },
 { 0xBC, DEX_AREA_TANOBY_CHAMBER },
 { 0xBD, DEX_AREA_TANOBY_CHAMBER },
 { 0xBE, DEX_AREA_TANOBY_CHAMBER },
 { 0xBF, DEX_AREA_TANOBY_CHAMBER },
 { 0xC0, DEX_AREA_TANOBY_CHAMBER },
 { 0xC1, DEX_AREA_TANOBY_CHAMBER },
 { 0xC2, DEX_AREA_TANOBY_CHAMBER }
};
...
static const struct
{
    ...
    { sDexAreas_Sevii1, (sizeof(sDexAreas_Sevii1) / sizeof((sDexAreas_Sevii1)[0])) },
    { sDexAreas_Sevii2, (sizeof(sDexAreas_Sevii2) / sizeof((sDexAreas_Sevii2)[0])) },
    { sDexAreas_Sevii3, (sizeof(sDexAreas_Sevii3) / sizeof((sDexAreas_Sevii3)[0])) },
    { sDexAreas_Sevii4, (sizeof(sDexAreas_Sevii4) / sizeof((sDexAreas_Sevii4)[0])) },
    { sDexAreas_Sevii5, (sizeof(sDexAreas_Sevii5) / sizeof((sDexAreas_Sevii5)[0])) },
    { sDexAreas_Sevii6, (sizeof(sDexAreas_Sevii6) / sizeof((sDexAreas_Sevii6)[0])) },
    { sDexAreas_Sevii7, (sizeof(sDexAreas_Sevii7) / sizeof((sDexAreas_Sevii7)[0])) }
};
...
s32 GetSpeciesPokedexAreaMarkers(u16 species, struct Subsprite * subsprites)
{
    ...
    alteringCaveCount = 0;
    alteringCaveNum = VarGet(0x4024);
    if (alteringCaveNum >= 9)
        alteringCaveNum = 0;
    for (i = 0, areaCount = 0; gWildMonHeaders[i].mapGroup != ((0xFF | (0xFF << 8)) >> 8); i++)
    {
        ...
        if (IsSpeciesOnMap(&gWildMonHeaders[i], species))
        {
            ...
            tableIndex = 0;
            while (FindDexAreaByMapSec(mapSecId, sDexAreas_Kanto, (sizeof(sDexAreas_Kanto) / sizeof((sDexAreas_Kanto)[0])), &tableIndex, &dexArea))
            {
                if (dexArea != DEX_AREA_NONE)
                    GetAreaMarkerSubsprite(areaCount++, dexArea, subsprites);
            }

            for (j = 0; j < (sizeof(sSeviiDexAreas) / sizeof((sSeviiDexAreas)[0])); j++)
            {
                if ((seviiAreas >> j) & 1)
                {
...
{
    s32 i;
    for (i = 0; i < (sizeof(sRoamerPairs) / sizeof((sRoamerPairs)[0])); i++)
    {
...
static s32 GetRoamerPokedexAreaMarkers(u16 species, struct Subsprite * subsprites)
{
    ...
    tableIndex = 0;
    if (FindDexAreaByMapSec(mapSecId, sDexAreas_Kanto, (sizeof(sDexAreas_Kanto) / sizeof((sDexAreas_Kanto)[0])), &tableIndex, &dexArea))
    {
        if (dexArea != DEX_AREA_NONE)
        {
...
static bool32 IsSpeciesOnMap(const struct WildPokemonHeader * data, s32 species)
{
    if (IsSpeciesInEncounterTable(data->landMonsInfo, species, 12))
        return 1;
    if (IsSpeciesInEncounterTable(data->waterMonsInfo, species, 5))
        return 1;
    ...
    if (IsSpeciesInEncounterTable(data->fishingMonsInfo, species, 12))

        return 1;
    if (IsSpeciesInEncounterTable(data->rockSmashMonsInfo, species, 5))
        return 1;
