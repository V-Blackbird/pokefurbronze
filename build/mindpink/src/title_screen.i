    ...
    case 1:
        ...
        if (data[1] >= data[2])
        {
            ...
            CreateFlameSprite(
                ...
                xspeed,
                yspeed,
                (TitleScreen_rand(taskId, 3) % 16) < 32 ? 0 : 1
            );
            for (i = 0; i < 15; i++)
            {
                CreateFlameSprite(
                    data[5] + sFlameXPositions[TitleScreen_rand(taskId,3)%16],
                    y,
                    xspeed,
                    yspeed,
                    1
