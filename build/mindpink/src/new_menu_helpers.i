# 0 "src/new_menu_helpers.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/new_menu_helpers.c"
...
static __attribute__((section("ewram_data"))) u16 sTempTileDataBufferCursor = {0};
static __attribute__((section("ewram_data"))) void *sTempTileDataBuffers[0x20] = {((void *)0)};
...
void ResetTempTileDataBuffers(void)
{
    ...
    for (i = 0; i < (s32)(sizeof(sTempTileDataBuffers) / sizeof((sTempTileDataBuffers)[0])); i++)
    {
        sTempTileDataBuffers[i] = ((void *)0);
    }
...
bool8 FreeTempTileDataBuffersIfPossible(void)
{
    ...
    if (!IsDma3ManagerBusyWithBgCopy())
    {
        if (sTempTileDataBufferCursor)
        {
            ...
            {
                { Free(sTempTileDataBuffers[i]); sTempTileDataBuffers[i] = ((void *)0); };
            }
            sTempTileDataBufferCursor = 0;
        }
        return 0;
...
void *DecompressAndCopyTileDataToVram(u8 bgId, const void *src, u32 size, u16 offset, u8 mode)
{
    ...
    if (sTempTileDataBufferCursor < (sizeof(sTempTileDataBuffers) / sizeof((sTempTileDataBuffers)[0])))
    {
...
void AddTextPrinterDiffStyle(bool8 allowSkippingDelayWithButtonPress)
{
    ...
    if (color == 0)
        AddTextPrinterParameterized2(0, FONT_MALE, gStringVar4, GetTextSpeedSetting(), nptr, 0x8, 0x1, 0x3);
    else if (color == 1)
        AddTextPrinterParameterized2(0, FONT_FEMALE, gStringVar4, GetTextSpeedSetting(), nptr, 0x4, 0x1, 0x3);
    else
        AddTextPrinterParameterized2(0, FONT_NORMAL, gStringVar4, GetTextSpeedSetting(), nptr, 0x2, 0x1, 0x3);
}
...
{
    gTextFlags.canABSpeedUpPrint = allowSkippingDelayWithButtonPress;
    AddTextPrinterParameterized2(0, FONT_NORMAL, gStringVar4, speed, ((void *)0), 0x2, 0x1, 0x3);
}
...
void LoadStdWindowFrameGfx(void)
{
    ...
    {
        Menu_LoadStdPal();
        LoadMenuMessageWindowGfx(0, 0x200, (0x000 + ((15) * 16)));
    }
    LoadUserWindowGfx(0, 0x214, (0x000 + ((14) * 16)));
}
...
static void WindowFunc_DrawStandardFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 paletteNum)
{
    ...
    FillBgTilemapBufferRect(bg, 0x214 + 0, tilemapLeft - 1, tilemapTop - 1, 1, 1, 14);
    FillBgTilemapBufferRect(bg, 0x214 + 1, tilemapLeft, tilemapTop - 1, width, 1, 14);
    FillBgTilemapBufferRect(bg, 0x214 + 2, tilemapLeft + width, tilemapTop - 1, 1, 1, 14);
    for (i = tilemapTop; i < tilemapTop + height; i++)
    {
        FillBgTilemapBufferRect(bg, 0x214 + 3, tilemapLeft - 1, i, 1, 1, 14);
        FillBgTilemapBufferRect(bg, 0x214 + 5, tilemapLeft + width, i, 1, 1, 14);
    }
    FillBgTilemapBufferRect(bg, 0x214 + 6, tilemapLeft - 1, tilemapTop + height, 1, 1, 14);
    FillBgTilemapBufferRect(bg, 0x214 + 7, tilemapLeft, tilemapTop + height, width, 1, 14);
    FillBgTilemapBufferRect(bg, 0x214 + 8, tilemapLeft + width, tilemapTop + height, 1, 1, 14);
}
...
static void WindowFunc_DrawDialogueFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 paletteNum)
{
    ...
    {
        FillBgTilemapBufferRect(bg, 0x200 + 0, tilemapLeft - 2, tilemapTop - 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 1, tilemapLeft - 1, tilemapTop - 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 2, tilemapLeft, tilemapTop - 1, width, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 3, tilemapLeft + width, tilemapTop - 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 4, tilemapLeft + width + 1, tilemapTop - 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 5, tilemapLeft - 2, tilemapTop, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 6, tilemapLeft - 1, tilemapTop, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 8, tilemapLeft + width, tilemapTop, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 9, tilemapLeft + width + 1, tilemapTop, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 10, tilemapLeft - 2, tilemapTop + 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 11, tilemapLeft - 1, tilemapTop + 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 12, tilemapLeft + width, tilemapTop + 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 13, tilemapLeft + width + 1, tilemapTop + 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 10)), tilemapLeft - 2, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 11)), tilemapLeft - 1, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 12)), tilemapLeft + width, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 13)), tilemapLeft + width + 1, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 5)), tilemapLeft - 2, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 6)), tilemapLeft - 1, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 8)), tilemapLeft + width, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 9)), tilemapLeft + width + 1, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 0)), tilemapLeft - 2, tilemapTop + 4, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 1)), tilemapLeft - 1, tilemapTop + 4, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 2)), tilemapLeft, tilemapTop + 4, width, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 3)), tilemapLeft + width, tilemapTop + 4, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 4)), tilemapLeft + width + 1, tilemapTop + 4, 1, 1, 15);
    }
    else
    {
        FillBgTilemapBufferRect(bg, 0x200 + 0, tilemapLeft - 2, tilemapTop - 1, 1, 1, 15);
        ...
        FillBgTilemapBufferRect(bg, 0x200 + 12, tilemapLeft + width, tilemapTop + 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, 0x200 + 13, tilemapLeft + width + 1, tilemapTop + 1, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 5)), tilemapLeft - 2, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 6)), tilemapLeft - 1, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 8)), tilemapLeft + width, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 9)), tilemapLeft + width + 1, tilemapTop + 2, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 10)), tilemapLeft - 2, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 11)), tilemapLeft - 1, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 12)), tilemapLeft + width, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 13)), tilemapLeft + width + 1, tilemapTop + 3, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 0)), tilemapLeft - 2, tilemapTop + 4, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 1)), tilemapLeft - 1, tilemapTop + 4, 1, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 2)), tilemapLeft, tilemapTop + 4, width, 1, 15);
        FillBgTilemapBufferRect(bg, (0x800 + (0x200 + 3)), tilemapLeft + width, tilemapTop + 4, 1, 1, 15);
...
static void WindowFunc_ClearDialogWindowAndFrame(u8 bg, u8 tilemapLeft, u8 tilemapTop, u8 width, u8 height, u8 paletteNum)
{
    FillBgTilemapBufferRect(bg, 0, tilemapLeft - 2, tilemapTop - 1, width + 4, height + 2, 14);
}
...
void LoadMessageBoxAndFrameGfx(u8 windowId, bool8 copyToVram)
{
    ...
    {
        LoadMenuMessageWindowGfx(windowId, 0x200, (0x000 + ((15) * 16)));
    }
...
void Menu_LoadStdPal(void)
{
    LoadPalette(gStandardMenuPalette, (0x000 + ((14) * 16)), ((10) * sizeof(u16)));
}

void Menu_LoadStdPalAt(u16 offset)
{
    LoadPalette(gStandardMenuPalette, offset, ((10) * sizeof(u16)));
}
...
{
    LoadStdWindowFrameGfx();
    DisplayMessageAndContinueTask(taskId, 0, 0x200, 15, fontId, GetTextSpeedSetting(), string, callback);
    CopyWindowToVram(0, COPYWIN_FULL);
}

void DisplayYesNoMenuDefaultYes(void)
{
    CreateYesNoMenu(&sYesNo_WindowTemplate, FONT_NORMAL, 0, 2, 0x214, 14, 0);
}

void DisplayYesNoMenuDefaultNo(void)
{
    CreateYesNoMenu(&sYesNo_WindowTemplate, FONT_NORMAL, 0, 2, 0x214, 14, 1);
}
...
u8 CreateStartMenuWindow(u8 height)
{
    ...
    {
        struct WindowTemplate template = SetWindowTemplateFields(0, 0x16, 1, 7, height * 2 - 1, 15, 0x13D);
...
void DrawHelpMessageWindowWithText(const u8 * text)
{
    LoadHelpMessageWindowGfx(CreateHelpMessageWindow(), 0x200, (0x000 + ((15) * 16)));
...
{
    Menu_LoadStdPal();
    LoadSignpostWindowGfx(0, 0x200, (0x000 + ((15) * 16)));
    LoadUserWindowGfx(0, 0x214, (0x000 + ((14) * 16)));
}
