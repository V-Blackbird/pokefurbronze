...
static void PrintBerryPowderAmount(u8 windowId, u32 amount, u8 x, u8 y, u8 speed)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_SMALL, gStringVar1, x, y, speed, ((void *)0));
}

static void DrawPlayerPowderAmount(u8 windowId, u16 baseBlock, u8 palette, u32 amount)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, baseBlock, palette);
    AddTextPrinterParameterized(windowId, FONT_SMALL, gOtherText_Powder, 0, 0, -1, ((void *)0));
...
void DisplayBerryPowderVendorMenu(void)
{
    ...
    if (QuestLog_SchedulePlaybackCB(QLPlaybackCB_DestroyScriptMenuMonPicSprites) != 1)
    {
        ...
        LoadStdWindowGfx(sBerryPowderVendorWindowId, 0x21D, (0x000 + ((13) * 16)));
