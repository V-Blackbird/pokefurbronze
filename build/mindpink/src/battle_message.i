...
static const u8 sText_StarterPkmnFled[] = _("{PLAY_SE SE_FLEE}Wild {B_OPPONENT_MON1_NAME} fled!");
...
static const u8 sText_PlayerUsed[] = _("{B_PLAYER_NAME} used\nTackle!\p{B_OPPONENT_MON1_NAME} avoided\nthe attack!\p{B_OPPONENT_MON1_NAME} twitched\nits ears!{PAUSE_UNTIL_PRESS}");
static const u8 sText_WaitedForThat[] = _("{B_PLAYER_NAME}: No!\nI won't run away now!{PAUSE_UNTIL_PRESS}");

const u8 *const gBattleStringsTable[391 - 12] = {
    ...
    [258 - 12] = sText_BlackbirdUsedItem,
    ...
    [386 - 12] = sText_NowWatchClosely,
    [387 - 12] = sText_AreYouReadyVill,
    [389 - 12] = sText_PlayerUsed,
    [390 - 12] = sText_WaitedForThat
};
...
const u8 gText_CongratsPlotMonEvolved[] = _("Woah! {STR_VAR_1}\nevolved into {STR_VAR_2}!{WAIT_SE}\p");
