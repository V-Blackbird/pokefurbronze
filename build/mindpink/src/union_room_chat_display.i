# 0 "src/union_room_chat_display.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/union_room_chat_display.c"
...
# 2 "src/union_room_chat_display.c" 2
# 1 "include/gflib.h" 1
...
# 3 "src/union_room_chat_display.c" 2
...
# 4 "src/union_room_chat_display.c" 2
...
# 5 "src/union_room_chat_display.c" 2
# 1 "include/menu.h" 1
# 18 "include/menu.h"
struct MenuAction
{
...
# 6 "src/union_room_chat_display.c" 2
...
# 7 "src/union_room_chat_display.c" 2
...
# 8 "src/union_room_chat_display.c" 2
...
extern const u8 gText_PokeSum_EggOrigin_Trade[];
# 9 "src/union_room_chat_display.c" 2
...
# 10 "src/union_room_chat_display.c" 2
...
# 11 "src/union_room_chat_display.c" 2
# 1 "include/union_room_chat_display.h" 1
# 26 "include/union_room_chat_display.h"
...
# 12 "src/union_room_chat_display.c" 2
# 1 "include/union_room_chat_objects.h" 1
...
# 13 "src/union_room_chat_display.c" 2
# 26 "src/union_room_chat_display.c"
...
static __attribute__((section("ewram_data"))) struct UnionRoomChat2 * sWork = ((void *)0);
...
static const u16 gUnionRoomChat_Unused_Pal[] = INCBIN_U16("graphics/union_room_chat/unused.gbapal");
...
static const struct SubtaskInfo sSubtaskInfo[] = {
    {0, DisplaySubtask_LoadGfx},
    {3, DisplaySubtask_PrintWin3},
    {4, DisplaySubtask_HideWin3},
    {5, DisplaySubtask_SwitchPages},
    {1, DisplaySubtask_MoveSelectorCursorObj},
    {6, DisplaySubtask_ShowQuitChattingDialog},
    {7, DisplaySubtask_HideQuitChattingDialog},
    {8, DisplaySubtask_UpdateMessageBuffer},
    {9, DisplaySubtask_PrintRegisterWhere},
    {10, DisplaySubtask_CancelRegister},
    {11, DisplaySubtask_ReturnToKeyboard},
    {12, DisplaySubtask_ScrollChat},
    {2, DisplaySubtask_AnimateSelectorCursorBlink},
    {13, DisplaySubtask_PrintInputText},
    {18, DisplaySubtask_PrintExitingChat},
    {19, DisplaySubtask_PrintLeaderLeft},
    {14, DisplaySubtask_AskSave},
    {15, DisplaySubtask_AskOverwriteSave},
    {16, DisplaySubtask_PrintSavingDontTurnOffPower},
    {17, DisplaySubtask_PrintSavedTheGame},
    {20, DisplaySubtask_ShowConfirmLeaderLeaveDialog}
};
...
void UnionRoomChat_StartDisplaySubtask(u16 arg0, u8 arg1)
{
    ...
    for (i = 0; i < (sizeof(sSubtaskInfo) / sizeof((sSubtaskInfo)[0])); i++)
    {
        if (sSubtaskInfo[i].idx == arg0)
        {
            sWork->subtasks[arg1].callback = sSubtaskInfo[i].callback;
            sWork->subtasks[arg1].active = 1;
...
static bool32 DisplaySubtask_SwitchPages(u8 *state)
{
    ...
    {
    case 0:
        UnionRoomChat_ToggleSelectorCursorObjVisibility(1);
    ...
    case 2:
        ...
        UnionRoomChat_ToggleSelectorCursorObjVisibility(0);
...
static bool32 DisplaySubtask_UpdateMessageBuffer(u8 *state)
{
    ...
    case 0:
        ...
        FillWin1Rect(start, length, ((0) | ((0) << 4)));
        str = UnionRoomChat_GetMessageEntryBuffer();
        PrintOnWin1Parameterized(0, str, 0x3, 0x1, 0x2);
...
static bool32 DisplaySubtask_PrintRegisterWhere(u8 *state)
{
    ...
    case 0:
        ...
        FillWin1Rect(var0, length, ((6) | ((6) << 4)));
        PrintOnWin1Parameterized(var0, str, 0x0, 0x4, 0x5);
        CopyWindowToVram(1, COPYWIN_GFX);
        break;
    case 1:
        if (!IsDma3ManagerBusyWithBgCopy())
        {
            PlaceStdMessageWindow(1, 16);
            CopyWindowToVram(sWork->messageWindowId, COPYWIN_FULL);
        }
        else
        {
...
static bool32 DisplaySubtask_CancelRegister(u8 *state)
{
    ...
    case 0:
        ...
        str = UnionRoomChat_GetEndOfMessageEntryBuffer();
        length = StringLength_Multibyte(str);
        FillWin1Rect(x, length, ((0) | ((0) << 4)));
        PrintOnWin1Parameterized(x, str, 0x3, 0x1, 0x2);
        CopyWindowToVram(1, COPYWIN_GFX);
        break;
    case 1:
        if (!IsDma3ManagerBusyWithBgCopy())
...
static void PlaceYesNoMenuAt(u8 left, u8 top, u8 initialCursorPos)
{
    ...
    {
        FillWindowPixelBuffer(sWork->yesNoMenuWinId, ((1) | ((1) << 4)));
        PutWindowTilemap(sWork->yesNoMenuWinId);
        AddTextPrinterParameterized(sWork->yesNoMenuWinId, FONT_NORMAL, gText_Yes, 8, 2, 0xFF, ((void *)0));
        AddTextPrinterParameterized(sWork->yesNoMenuWinId, FONT_NORMAL, gText_No, 8, 16, 0xFF, ((void *)0));
...
static void HideYesNoMenuWindow(void)
{
    if (sWork->yesNoMenuWinId != 0xFF)
    {
        ClearStdWindowAndFrameToTransparent(sWork->yesNoMenuWinId, 0);
...
static void HideStdMessageWindow(void)
{
    if (sWork->messageWindowId != 0xFF)
    {
        ClearStdWindowAndFrameToTransparent(sWork->messageWindowId, 0);
...
static void PrintOnWin1Parameterized(u16 x, u8 *str, u8 bgColor, u8 fgColor, u8 shadowColor)
{
    ...
    AddTextPrinterParameterized3(1, FONT_NORMAL, x * 8, 1, color, 0xFF, strbuf);
}
...
static void PrintCurrentKeyboardPage(void)
{
    ...
    if (page != UNION_ROOM_KB_PAGE_COUNT)
    {
        ...
        for (i = 0, top = 0; i < 10; i++, top += 12)
        {
            ...
            AddTextPrinterParameterized3(2, FONT_SMALL, left, top, color, 0xFF, str);
        }
    }
    else
    {
        ...
        for (i = 0, top = 0; i < 10; i++, top += 12)
        {
            ...
            {
                AddTextPrinterParameterized3(2, FONT_SMALL, left, top, color, 0xFF, str2);
            }
            else
            {
                ...
                AddTextPrinterParameterized3(2, FONT_SMALL, left, top, color, 0xFF, str);
                AddTextPrinterParameterized3(2, FONT_SMALL, left + 35, top, color, 0xFF, gText_Ellipsis);
            }
        }
    }
}
...

{
    ...
    AddTextPrinterParameterized3(0, FONT_NORMAL, 0, row * 15, color, 0xFF, str);
}
...
static void ClearBg0(void)
{
    RequestDma3Fill(0, (void *)(void *)(0x6000000 + (0x4000 * (0))), 0x20, 1);
...
static void LoadUnionRoomChatPanelGfx(void)
{
    LoadPalette(gUnionRoomChat_Panel_Pal, (0x000 + ((7) * 16)), ((16) * sizeof(u16)));
    LoadPalette(sUnionRoomChat_TextEntry_Pal, (0x000 + ((12) * 16)), ((16) * sizeof(u16)));
...
static void LoadLinkMiscMenuGfx(void)
{
    ...
    LoadPalette(gUnionRoomChat_Bg_Pal, (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
...
static void LoadBg1Pal8(void)
{
    LoadPalette(gUnionRoomChat_Unused_Pal, (0x000 + ((8) * 16)), ((16) * sizeof(u16)));
    RequestDma3Fill(0, (void *)(void *)(0x6000000 + (0x4000 * (1))) + 0x20, 0x20, 1);
}

static void LoadWin0(void)
{
    LoadPalette(sUnionRoomChat_Messages_Pal, (0x000 + ((15) * 16)), ((16) * sizeof(u16)));
    PutWindowTilemap(0);
...
{
    FillWindowPixelBuffer(3, ((1) | ((1) << 4)));
    LoadUserWindowGfx(3, 1, (0x000 + ((13) * 16)));
    LoadStdWindowGfx(3, 0xA, (0x000 + ((2) * 16)));
    LoadPalette(gStandardMenuPalette, (0x000 + ((14) * 16)), ((16) * sizeof(u16)));
}
...
{
    { vu16 tmp = (vu16)(arg0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers[gScanlineEffect.srcBuffer], 0x00000000 | 0x01000000 | ((0x120)/(16/8) & 0x1FFFFF)); };
...
{
    { vu16 tmp = (vu16)(arg0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers[0], 0x00000000 | 0x01000000 | ((0x120)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers[0] + 0x90, 0x00000000 | 0x01000000 | ((0x20)/(16/8) & 0x1FFFFF)); };
    { vu16 tmp = (vu16)(arg0); CpuSet((void *)&tmp, gScanlineEffectRegBuffers[0] + 0x3C0, 0x00000000 | 0x01000000 | ((0x120)/(16/8) & 0x1FFFFF)); };
