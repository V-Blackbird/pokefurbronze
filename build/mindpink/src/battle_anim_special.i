# 0 "src/battle_anim_special.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_anim_special.c"
...
# 5 "src/battle_anim_special.c" 2
# 1 "include/battle_main.h" 1
# 6 "src/battle_anim_special.c" 2
...
# 10 "src/battle_anim_special.c" 2
...
# 11 "src/battle_anim_special.c" 2
# 1 "include/m4a.h" 1
...
# 12 "src/battle_anim_special.c" 2
...
# 13 "src/battle_anim_special.c" 2
# 1 "include/task.h" 1
# 14 "src/battle_anim_special.c" 2
# 1 "include/trig.h" 1
...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 15 "src/battle_anim_special.c" 2
# 1 "include/util.h" 1
...
# 16 "src/battle_anim_special.c" 2
# 1 "include/constants/items.h" 1
# 17 "src/battle_anim_special.c" 2
# 1 "include/constants/moves.h" 1
# 18 "src/battle_anim_special.c" 2
# 1 "include/constants/songs.h" 1
# 19 "src/battle_anim_special.c" 2
# 34 "src/battle_anim_special.c"
...
{
    [BALL_POKE] = {gBattleAnimSpriteGfx_Particles, 0x100, 55020},
    [BALL_GREAT] = {gBattleAnimSpriteGfx_Particles, 0x100, 55021},
    [BALL_SAFARI] = {gBattleAnimSpriteGfx_Particles, 0x100, 55022},
    [BALL_ULTRA] = {gBattleAnimSpriteGfx_Particles, 0x100, 55023},
    [BALL_MASTER] = {gBattleAnimSpriteGfx_Particles, 0x100, 55024},
    [BALL_NET] = {gBattleAnimSpriteGfx_Particles, 0x100, 55025},
    [BALL_DIVE] = {gBattleAnimSpriteGfx_Particles, 0x100, 55026},
    [BALL_NEST] = {gBattleAnimSpriteGfx_Particles, 0x100, 55027},
    [BALL_REPEAT] = {gBattleAnimSpriteGfx_Particles, 0x100, 55028},
    [BALL_TIMER] = {gBattleAnimSpriteGfx_Particles, 0x100, 55029},
    [BALL_LUXURY] = {gBattleAnimSpriteGfx_Particles, 0x100, 55030},
    [BALL_PREMIER] = {gBattleAnimSpriteGfx_Particles, 0x100, 55031},
    [BALL_SHADOW] = {gBattleAnimSpriteGfx_Particles, 0x100, 55032},
};

const struct CompressedSpritePalette gBallParticlePalettes[] =
{
    [BALL_POKE] = {gBattleAnimSpritePal_CircleImpact, 55020},
    [BALL_GREAT] = {gBattleAnimSpritePal_CircleImpact, 55021},
    [BALL_SAFARI] = {gBattleAnimSpritePal_CircleImpact, 55022},
    [BALL_ULTRA] = {gBattleAnimSpritePal_CircleImpact, 55023},
    [BALL_MASTER] = {gBattleAnimSpritePal_CircleImpact, 55024},
    [BALL_NET] = {gBattleAnimSpritePal_CircleImpact, 55025},
    [BALL_DIVE] = {gBattleAnimSpritePal_CircleImpact, 55026},
    [BALL_NEST] = {gBattleAnimSpritePal_CircleImpact, 55027},
    [BALL_REPEAT] = {gBattleAnimSpritePal_CircleImpact, 55028},
    [BALL_TIMER] = {gBattleAnimSpritePal_CircleImpact, 55029},
    [BALL_LUXURY] = {gBattleAnimSpritePal_CircleImpact, 55030},
    [BALL_PREMIER] = {gBattleAnimSpritePal_CircleImpact, 55031},
    [BALL_SHADOW] = {gBattleAnimSpritePal_CircleImpact, 55032},
};
...
void AnimTask_LevelUpHealthBox(u8 taskId)
{
    ...
    LoadCompressedPalette(gCureBubblesPal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
...
void DoLoadHealthboxPalsForLevelUp(u8 *paletteId1, u8 *paletteId2, u8 battler)
{
    ...
    *paletteId2 = AllocSpritePalette(55050);
    ...
    LoadPalette(&gPlttBufferUnfaded[offset1], (0x100 + ((*paletteId1) * 16)), ((16) * sizeof(u16)));
    LoadPalette(&gPlttBufferUnfaded[offset2], (0x100 + ((*paletteId2) * 16)), ((16) * sizeof(u16)));
...
void DoFreeHealthboxPalsForLevelUp(u8 battler)
{
    ...
    paletteId1 = IndexOfSpritePaletteTag(55039);
...
static void AnimTask_FlashHealthboxOnLevelUp_Step(u8 taskId)
{
    ...
    if (gTasks[taskId].data[0]++ >= gTasks[taskId].data[11])
    {
        ...
        case 0:
            ...
            paletteOffset = (0x100 + ((paletteNum) * 16));
...
void AnimTask_ThrowBallSpecial(u8 taskId)
{
    ...
    gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].callback = SpriteCB_PlayerThrowInit;
    gTasks[taskId].data[0] = spriteId;
...
static void AnimTask_ThrowBallSpecial_PlaySfx(u8 taskId)
{
    if (gBattleTypeFlags & (1 << 9))
    {
        if (gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].animCmdIndex == 4 && gSprites[gBattlerSpriteIds[GetBattlerAtPosition(0)]].animDelayCounter == 0)
        {
            PlaySE12WithPanning(54, 0);
...
static void CreateStarsWhenBallClicks(struct Sprite *sprite)
{
    ...
    for (i = 0; i < 3; i++)
    {
        ...
        if (spriteId != 64)
        {
            ...
            gSprites[spriteId].data[2] = sprite->x + sCaptureStar[i].xOffset;
            gSprites[spriteId].data[4] = sprite->y + sCaptureStar[i].yOffset;
            gSprites[spriteId].data[5] = sCaptureStar[i].amplitude;
...
u8 LaunchBallFadeMonTask(bool8 unfadeLater, u8 battler, u32 selectedPalettes, u8 ballId)
{
    ...
    if (!unfadeLater)
    {
        BlendPalette((0x100 + ((battler) * 16)), 16, 0, sBallOpenFadeColors[ballId]);
        gTasks[taskId].data[1] = 1;
    }
    else
    {
        BlendPalette((0x100 + ((battler) * 16)), 16, 16, sBallOpenFadeColors[ballId]);
...
static void Task_FadeMon_ToBallColor(u8 taskId)
{
    ...
    if (gTasks[taskId].data[2] <= 16)
    {
        BlendPalette((0x100 + ((gTasks[taskId].data[3]) * 16)), 16, gTasks[taskId].data[0], sBallOpenFadeColors[ballId]);
...
void AnimTask_SubstituteFadeToInvisible(u8 taskId)
{
    ...
    case 2:
        spriteId = gBattlerSpriteIds[gBattleAnimAttacker];
        RequestDma3Fill(0, (void *)(void *)(0x6000000 + 0x10000) + gSprites[spriteId].oam.tileNum * 32, 0x800, 1);
...
{
    if (gBattleCommunication[5] >= 3)
        gBattleAnimArgs[7] = 0;
    else
        gBattleAnimArgs[7] = gBattleCommunication[5];
