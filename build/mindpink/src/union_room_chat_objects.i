# 0 "src/union_room_chat_objects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/union_room_chat_objects.c"
...
# 2 "src/union_room_chat_objects.c" 2
# 1 "include/gflib.h" 1
...
# 3 "src/union_room_chat_objects.c" 2
...
# 4 "src/union_room_chat_objects.c" 2
...
# 5 "src/union_room_chat_objects.c" 2
...
# 6 "src/union_room_chat_objects.c" 2
...
static __attribute__((section("ewram_data"))) struct UnionRoomChat3 *sWork = ((void *)0);
...
void UnionRoomChat_UpdateObjPalCycle(int arg0)
{
    ...
    LoadPalette(palette, (0x100 + ((index) * 16)) + 1, ((2) * sizeof(u16)));
}
...
void CreatePageSwitchUISprites(void)
{
    ...
    sWork->chatIconsSprite->invisible = 1;
}
...
void UpdateVisibleUnionRoomChatIcon(void)
{
    if (GetCurrentKeyboardPage() == UNION_ROOM_KB_PAGE_COUNT)
    {
        if (UnionRoomChat_LenMessageEntryBuffer() != 0)
        {
            ...
            sWork->chatIconsSprite->invisible = 0;
