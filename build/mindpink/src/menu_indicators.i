# 0 "src/menu_indicators.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/menu_indicators.c"
...
static __attribute__((section("ewram_data"))) struct ScrollArrowsTemplate sTempScrollArrowTemplate = {0};
...
static void SpriteCallback_ScrollIndicatorArrow(struct Sprite *sprite)
{
    ...
    case 1:
        ...
        case 0:
            ...
            sprite->x2 = (gSineTable[(u8)(sprite->data[5])] * multiplier) / 256;
            break;
        case 1:
            multiplier = sprite->data[3];
            sprite->y2 = (gSineTable[(u8)(sprite->data[5])] * multiplier) / 256;
            break;
        }
...
u8 AddScrollIndicatorArrowPair(const struct ScrollArrowsTemplate *arrowInfo, u16 *scrollOffset)
{
    ...
    {
        LoadPalette(sRedArrowPal, (0x100 + ((arrowInfo->palNum) * 16)), sizeof(sRedArrowPal));
    }
    else
    {
...
u8 ListMenuAddRedOutlineCursorObject(const struct CursorStruct *cursor)
{
    ...
    {
        LoadPalette(sRedArrowPal, (0x100 + ((cursor->palNum) * 16)), sizeof(sRedArrowPal));
    }
    else
    {
        spritePal.data = sRedArrowPal;
