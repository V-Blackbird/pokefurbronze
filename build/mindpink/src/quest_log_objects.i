# 0 "src/quest_log_objects.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/quest_log_objects.c"
...
void SetSav1ObjectEventsFromQuestLog(const struct QuestLog * questLog, const struct ObjectEventTemplate * templates)
{
    ...
    { vu16 tmp = (vu16)(0); CpuSet((void *)&tmp, gObjectEvents, 0x00000000 | 0x01000000 | ((sizeof(gObjectEvents))/(16/8) & 0x1FFFFF)); };
    ...
    CpuSet(gObjectEvents, gSaveBlock1Ptr->objectEvents, 0x00000000 | ((sizeof(gObjectEvents))/(16/8) & 0x1FFFFF));
}
...
void sub_815A540(void)
{
    if (gQuestLogState == 2)
    {
        ...
        if (!MetatileBehavior_IsSurfable(MapGridGetMetatileBehaviorAt(x, y)) && TestPlayerAvatarFlags((1 << PLAYER_AVATAR_STATE_SURFING)))
        {
