# 0 "src/field_weather_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/field_weather_util.c"
...
# 4 "src/field_weather_util.c" 2
# 1 "include/constants/weather.h" 1
# 5 "src/field_weather_util.c" 2
