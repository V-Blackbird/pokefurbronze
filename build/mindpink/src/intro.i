...
static bool8 SetUpCopyrightScreen(void)
{
    ...
    case 0:
        ...
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x5000000 + sizeof(vu16)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((0x200 + 0x200) - sizeof(vu16))/(16/8))); dmaRegs[2]; }; };
        ResetPaletteFade();
        LoadCopyrightGraphics(0 * 0x4000, 7 * 0x800, (0x000 + ((0) * 16)));
        ScanlineEffect_Stop();
        ResetTasks();
        ResetSpriteData();
...
static void CB2_SetUpIntro(void)
{
    ...
    case 0:
        ...
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x6000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((0x18000)/(16/8))); dmaRegs[2]; }; };
        { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x7000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x400)/(32/8))); dmaRegs[2]; }; };
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(0x5000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((0x200 + 0x200))/(16/8))); dmaRegs[2]; }; };
        FillPalette(((0) | ((0) << 5) | ((0) << 10)), 0, (0x200 + 0x200));
        ...
        break;
    case 1:
        LoadPalette(sGameFreakBg_Pal, (0x000 + ((0) * 16)), sizeof(sGameFreakBg_Pal));
        ...
        LoadPalette(sGameFreakLogo_Pal, (0x000 + ((13) * 16)), sizeof(sGameFreakLogo_Pal));
        break;
    case 2:
...
static void IntroCB_Scene1(struct IntroSequenceData * this)
{
    ...
    case 0:
        SetVBlankCallback(((void *)0));
        LoadPalette(sScene1_Grass_Pal, (0x000 + ((1) * 16)), sizeof(sScene1_Grass_Pal));
        LoadPalette(sScene1_Bg_Pal, (0x000 + ((2) * 16)), sizeof(sScene1_Bg_Pal));
...
static void IntroCB_Scene2(struct IntroSequenceData * this)
{
    ...
    case 1:
        ...
        {
            SetVBlankCallback(((void *)0));
            LoadPalette(sScene2_Bg_Pal, (0x000 + ((1) * 16)), sizeof(sScene2_Bg_Pal));
            LoadPalette(sGengar_Pal, (0x000 + ((5) * 16)), sizeof(sGengar_Pal));
            LoadPalette(sScene2_NidorinoClose_Pal, (0x000 + ((6) * 16)), sizeof(sScene2_NidorinoClose_Pal));
            BlendPalettes((0x0000FFFF | 0xFFFF0000) & ~1, 16, ((31) | ((31) << 5) | ((31) << 10)));
...
static void IntroCB_Scene3_Entrance(struct IntroSequenceData * this)
{
    ...
    {
    case 0:
        LoadPalette(sScene3_Bg_Pal, (0x000 + ((1) * 16)), sizeof(sScene3_Bg_Pal));
        LoadPalette(sGengar_Pal, (0x000 + ((5) * 16)), sizeof(sGengar_Pal));
        BlendPalettes((0x0000FFFF | 0xFFFF0000) & ~1, 16, ((31) | ((31) << 5) | ((31) << 10)));
...
static void IntroCB_Scene3_Fight(struct IntroSequenceData * this)
{
    ...
    case 13:
        if (++this->timer > 8)
        {
            { vu16 tmp = (vu16)(((31) | ((31) << 5) | ((31) << 10))); CpuSet((void *)&tmp, &gPlttBufferUnfaded[(0x000 + ((1) * 16))], 0x00000000 | 0x01000000 | ((2 * ((16) * sizeof(u16)))/(16/8) & 0x1FFFFF)); };
