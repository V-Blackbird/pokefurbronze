...
static __attribute__((section("ewram_data"))) bool32 sStatsEnabled = 0;

void ClearMysteryGift(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock1Ptr->mysteryGift, 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->mysteryGift))/(32/8) & 0x1FFFFF)); };
...
bool32 SaveWonderNews(const struct WonderNews * news)
{
    ...
    gSaveBlock1Ptr->mysteryGift.newsCrc = CalcCRC16WithTable((void *)&(gSaveBlock1Ptr->mysteryGift.news), sizeof(gSaveBlock1Ptr->mysteryGift.news));
    return 1;
}

bool32 ValidateSavedWonderNews(void)
{
    if (CalcCRC16WithTable((void *)&(gSaveBlock1Ptr->mysteryGift.news), sizeof(gSaveBlock1Ptr->mysteryGift.news)) != gSaveBlock1Ptr->mysteryGift.newsCrc)
        return 0;
...
static void ClearSavedWonderNews(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, GetSavedWonderNews(), 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->mysteryGift.news))/(32/8) & 0x1FFFFF)); };
    gSaveBlock1Ptr->mysteryGift.newsCrc = 0;
}

static void ClearSavedWonderNewsMetadata(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, GetSavedWonderNewsMetadata(), 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->mysteryGift.newsMetadata))/(32/8) & 0x1FFFFF)); };
    WonderNews_Reset();
}
...
bool32 SaveWonderCard(const struct WonderCard * card)
{
    ...
    gSaveBlock1Ptr->mysteryGift.cardCrc = CalcCRC16WithTable((void *)&(gSaveBlock1Ptr->mysteryGift.card), sizeof(gSaveBlock1Ptr->mysteryGift.card));
...
bool32 ValidateSavedWonderCard(void)
{
    if (gSaveBlock1Ptr->mysteryGift.cardCrc != CalcCRC16WithTable((void *)&(gSaveBlock1Ptr->mysteryGift.card), sizeof(gSaveBlock1Ptr->mysteryGift.card)))
        return 0;
...
static void ClearSavedWonderCard(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock1Ptr->mysteryGift.card, 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->mysteryGift.card))/(32/8) & 0x1FFFFF)); };
    gSaveBlock1Ptr->mysteryGift.cardCrc = 0;
}

static void ClearSavedWonderCardMetadata(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, GetSavedWonderCardMetadata(), 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->mysteryGift.cardMetadata))/(32/8) & 0x1FFFFF)); };
...
{
    if (flagId >= 1000 && flagId < 1000 + (1 + 0x2BA - 0x2A7))
        return 1;
    return 0;
}
...
bool32 IsSavedWonderCardGiftNotReceived(void)
{
    ...
    if (FlagGet(sReceivedGiftFlags[value - 1000]) == 1)
        return 0;
    return 1;
}
...
# 337 "src/mystery_gift.c"
void MysteryGift_LoadLinkGameData(struct MysteryGiftLinkGameData * data)
{
    s32 i;
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, data, 0x04000000 | 0x01000000 | ((sizeof(*data))/(32/8) & 0x1FFFFF)); };
...
u16 MysteryGift_GetCardStatFromLinkData(const struct MysteryGiftLinkGameData * data, u32 stat)
{
    ...
    default:
        (0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent.c"), 825, "0", 1);;
        return 0;
    }
}
...
static void IncrementCardStat(u32 statType)
{
    ...
    if (card->type == 2)
    {
        ...
        if (stat == ((void *)0))
        {
             (0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent.c"), 868, "0", 1);;
        }
        else if (++(*stat) > 999)
        {
            *stat = 999;
...
u16 MysteryGift_GetCardStat(u32 stat)
{
    ...
    (0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent.c"), 913, "0", 1);;
    return 0;
}
    ...
    if (sStatsEnabled)
    {
        ...
        case 2:
            IncrementCardStatForNewTrainer(2,
                                            ...
                                            (sizeof(gSaveBlock1Ptr->mysteryGift.trainerIds[1]) / sizeof((gSaveBlock1Ptr->mysteryGift.trainerIds[1])[0])));
            break;
        case 0:
            IncrementCardStatForNewTrainer(0,
                                            trainerId,
                                            gSaveBlock1Ptr->mysteryGift.trainerIds[0],
                                            (sizeof(gSaveBlock1Ptr->mysteryGift.trainerIds[0]) / sizeof((gSaveBlock1Ptr->mysteryGift.trainerIds[0])[0])));
            break;
        case 1:
            ...
            break;
        default:
             (0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent.c"), 988, "0", 1);;
             break;
        }
    }
}
...
static void ClearSavedTrainerIds(void)
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, gSaveBlock1Ptr->mysteryGift.trainerIds, 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock1Ptr->mysteryGift.trainerIds))/(32/8) & 0x1FFFFF)); };
}
