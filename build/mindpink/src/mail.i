...
void ReadMail(struct Mail * mail, void (*savedCallback)(void), bool8 messageExists)
{
    ...
    if (((mail->itemId == 122 || mail->itemId == 123 || mail->itemId == 124 || mail->itemId == 125 || mail->itemId == 126 || mail->itemId == 127 || mail->itemId == 128 || mail->itemId == 129 || mail->itemId == 130 || mail->itemId == 131 || mail->itemId == 132 || mail->itemId == 133)))
    {
        sMailViewResources->mailType = (mail->itemId - 122);
    }
    else
    {
        sMailViewResources->mailType = (122 - 122);
        messageExists = 0;
    }
