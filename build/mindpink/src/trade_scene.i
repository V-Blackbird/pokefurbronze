...
# 7 "src/trade_scene.c" 2
# 1 "include/link.h" 1
# 8 "src/trade_scene.c" 2
# 1 "include/link_rfu.h" 1
# 9 "src/trade_scene.c" 2
...
# 31 "src/trade_scene.c" 2
# 1 "include/constants/items.h" 1
# 32 "src/trade_scene.c" 2
# 1 "include/constants/easy_chat.h" 1
# 33 "src/trade_scene.c" 2
# 1 "include/constants/songs.h" 1
# 34 "src/trade_scene.c" 2
# 1 "include/constants/region_map_sections.h" 1
# 35 "src/trade_scene.c" 2
# 1 "include/constants/moves.h" 1
# 36 "src/trade_scene.c" 2
...
struct {
             ...
             u8 linkPartnerName[7];
              ...
              u8 win0right;
              u8 win0bottom;
} static __attribute__((section("ewram_data"))) * sTradeAnim = ((void *)0);
...
static const u8 sPokeballSymbol_Gfx[] = INCBIN_U8("graphics/trade/pokeball_symbol.8bpp");
...
static const union AffineAnimCmd sAffineAnim_Pokeball_Unsquish[] = {
    {.frame = {.xScale = 96, .yScale = 256, .rotation = 0, .duration = 0}},
...
static const union AnimCmd sAnim_GbaScreen_Long[] = {
    {.frame = {0, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {32, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {64, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {96, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {64, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {32, 2, .hFlip = 1, .vFlip = 1}},
    {.frame = {0, 2, .hFlip = 1, .vFlip = 1}},
    {.loop = {.type = -3, .count = 8}},
...
static void SpriteCB_LinkMonShadow(struct Sprite *sprite)
{
    if (sprite->data[1] == 0)
    {
        if (++sprite->data[0] == 12)
            sprite->data[0] = 0;
        LoadPalette(&sLinkMonShadow_Pal[sprite->data[0]], ((((sprite->oam.paletteNum) + 16) * 16)) + 4, ((1) * sizeof(u16)));
    }
}
...
static void SetTradeBGAffine(void)
{
    ...
    SetGpuReg(0x20, affine.pa);
    SetGpuReg(0x22, affine.pb);
    SetGpuReg(0x24, affine.pc);
    SetGpuReg(0x26, affine.pd);
    SetGpuReg(0x28, affine.dx);
    SetGpuReg(0x2c, affine.dy);
}
...
static void SetTradeGpuRegs(void)
{
    ...
    SetGpuReg(0x16, sTradeAnim->bg1vofs);
    SetGpuReg(0x14, sTradeAnim->bg1hofs);

    dispcnt = GetGpuReg(0x0);
    if ((dispcnt & 7) == 0x0000)
    {
        SetGpuReg(0x1a, sTradeAnim->bg2vofs);
        SetGpuReg(0x18, sTradeAnim->bg2hofs);
    }
    else
    {
        SetTradeBGAffine();
...
static void LoadTradeMonPic(u8 whichParty, u8 state)
{
    ...
    case 1:
        ...
        gSprites[sTradeAnim->monSpriteIds[whichParty]].invisible = 1;
...
void CB2_LinkTrade(void)
{
    ...
    case 10:
        ...
        ShowBg(0);
        sTradeAnim->questLogSpecies[0] = GetMonData(&gPlayerParty[gSelectedTradeMonPositions[0]], 65);
        sTradeAnim->questLogSpecies[1] = GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], 65);
        memcpy(sTradeAnim->linkPartnerName, gLinkPlayers[GetMultiplayerId() ^ 1].name, 7);
        gMain.state++;
        break;
    case 11:
...
static void TradeAnimInit_LoadGfx(void)
{
    ...
    LoadCompressedPalette(gBattleInterface_Textbox_Pal, (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
...
static void TradeMons(u8 playerPartyIdx, u8 partnerPartyIdx)
{
    ...
    u16 playerMail = GetMonData(playerMon, 64);

    struct Pokemon * partnerMon = &gEnemyParty[partnerPartyIdx];
    u16 partnerMail = GetMonData(partnerMon, 64);


    if (playerMail != 0xFF)
        ClearMailStruct(&gSaveBlock1Ptr->mail[playerMail]);

    { sTradeAnim->tempMon = *playerMon; *playerMon = *partnerMon; *partnerMon = sTradeAnim->tempMon; };



    friendship = 70;
    if (!GetMonData(playerMon, 45))
        SetMonData(playerMon, 32, &friendship);
...
static void SetTradeSequenceBgGpuRegs(u8 state)
{
    ...
    case 0:
        ...
        SetGpuReg(0xc, (2) | ((1) << 2) | ((18) << 8) | 0x4000);
        LoadPalette(gTradeGba2_Pal, (0x000 + ((1) * 16)), 3 * ((16) * sizeof(u16)));
        { const void *_src = gTradeGba_Gfx; void *_dest = (void *)(void *)(0x6000000 + (0x4000 * (1))); u32 _size = 0x1420; while (1) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((0x1000))/(16/8))); dmaRegs[2]; }; _src += (0x1000); _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } } };
        { const void *_src = gTradeOrHatchMonShadowTilemap; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (18))); u32 _size = 0x1000; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        break;
    case 1:
        sTradeAnim->bg1hofs = 0;
        sTradeAnim->bg1vofs = 0x15C;
        SetGpuReg(0x16, 0x15C);
        SetGpuReg(0xa, (2) | ((0) << 2) | ((5) << 8) | 0x8000);
        SetGpuReg(0xc, (2) | ((1) << 2) | ((18) << 8) | 0x8000);
        if (sTradeAnim->isCableTrade)
        {
            { const void *_src = sGbaMapCable; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (5))); u32 _size = 0x1000; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        }
        else
        {
            { const void *_src = sGbaMapWireless; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (5))); u32 _size = 0x1000; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        }
        ...
        SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0200 | 0x1000);
        break;
    case 2:
        ...
        if (!sTradeAnim->isCableTrade)
        {
            SetGpuReg(0x0, 0x0001 | 0x0040 | 0x0200 | 0x1000);
            LZ77UnCompVram(sWirelessCloseup_Map, (void *)(void *)(0x6000000 + (0x800 * (5))));
            BlendPalettes(0x000000008, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
        }
        else
        {
            SetGpuReg(0x0, 0x0001 | 0x0040 | 0x0200 | 0x1000);
            { const void *_src = sCableCloseup_Map; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (5))); u32 _size = 0x800; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
            BlendPalettes(0x00000001, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
        }
        break;
    case 3:
        LoadPalette(sWirelessSignalAnimPals_Off, (0x000 + ((3) * 16)), ((16) * sizeof(u16)));
        LZ77UnCompVram(sWirelessSignal4bpp, (void *)(0x6000000 + (0x4000 * (1))));
        LZ77UnCompVram(sWirelessSignalTilemap, (void *)(0x6000000 + (0x800 * (18))));
        sTradeAnim->bg2vofs = 0x50;
        SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0200 | 0x0400 | 0x1000);
        break;
    case 4:
        SetGpuReg(0x0, 0x0001 | 0x0040 | 0x0400 | 0x1000);
        SetGpuReg(0xc, (3) | ((1) << 2) | 0x0080 | ((18) << 8) | 0x0000);
        sTradeAnim->bg2texX = 0x40;
        sTradeAnim->bg2texY = 0x5C;
        sTradeAnim->sXY = 0x20;
        sTradeAnim->bg2Zoom = 0x400;
        sTradeAnim->bg2alpha = 0;
        { const void *_src = sGbaAffine_Gfx; void *_dest = (void *)(void *)(0x6000000 + (0x4000 * (1))); u32 _size = 0x2840; while (1) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((0x1000))/(16/8))); dmaRegs[2]; }; _src += (0x1000); _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } } };
        if (sTradeAnim->isCableTrade)
        {
            { const void *_src = sGbaAffineMapCable; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (18))); u32 _size = 0x100; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        }
        else
        {
            { const void *_src = sGbaAffineMapWireless; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (18))); u32 _size = 0x100; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        }
        break;
    case 5:
        sTradeAnim->bg1vofs = 0;
    ...
    case 6:
        ...
        sTradeAnim->bg2alpha = 0;
        { const void *_src = sGbaAffine_Gfx; void *_dest = (void *)(0x6000000 + (0x4000 * (1))); u32 _size = 0x2840; while (1) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((0x1000))/(16/8))); dmaRegs[2]; }; _src += (0x1000); _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } } };
        if (sTradeAnim->isCableTrade)
        {
            { const void *_src = sGbaAffineMapCable; void *_dest = (void *)(void *)(0x6000000 + (0x800 * (18))); u32 _size = 0x100; { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; };
        }
...
static void TradeBufferOTnameAndNicknames(void)
{
    ...
    if (sTradeAnim->isLinkTrade)
    {
        ...
        GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], 2, nickname);
        StringCopy_Nickname(gStringVar3, nickname);
        GetMonData(&gPlayerParty[gSelectedTradeMonPositions[0]], 2, nickname);
...
enum {
    ...
    STATE_GBA_FLASH_SEND_WIRELESS = STATE_GBA_FLASH_SEND + 100,
    STATE_GBA_STOP_FLASH_SEND_WIRELESS,
    STATE_WAIT_WIRELESS_SIGNAL_SEND,
    STATE_PAN_TO_GBA_WIRELESS = STATE_PAN_TO_GBA + 100,
...
static bool8 DoTradeAnim_Cable(void)
{
    ...
    {
    case STATE_START:
        gSprites[sTradeAnim->monSpriteIds[0]].invisible = 0;
    ...
    case STATE_SEND_MSG:
        ...
        if (sTradeAnim->monSpecies[0] != 479)
    ...
    case STATE_CROSSING_BLEND_WHITE_1:
        BlendPalettes(0x1, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeAnim->state++;
        break;
    case STATE_CROSSING_BLEND_WHITE_2:
        BlendPalettes(0x1, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeAnim->state++;
        break;
    ...
    case STATE_CROSSING_CREATE_MON_PICS:
        if (!IsMonSpriteNotFlipped(sTradeAnim->monSpecies[0]))
        {
            ...
            gSprites[sTradeAnim->monSpriteIds[0]].oam.affineMode = 3;
            CalcCenterToCornerVec(&gSprites[sTradeAnim->monSpriteIds[0]], (((3 << 2) | (0)) & 0x03), ((((3 << 2) | (0)) >> 2) & 0x03), 3);
        ...
        gSprites[sTradeAnim->monSpriteIds[0]].invisible = 0;
        gSprites[sTradeAnim->monSpriteIds[1]].invisible = 0;
        sTradeAnim->state++;
        break;
    case STATE_CROSSING_MON_PICS_MOVE:
        ...
        if (gSprites[sTradeAnim->monSpriteIds[0]].y2 < -160
         && gSprites[sTradeAnim->monSpriteIds[0]].y2 >= -160 - 3)
        {
            PlaySE(39);
        }
        if (gSprites[sTradeAnim->monSpriteIds[0]].y2 < -222)
        {
            ...
            sTradeAnim->state++;
            gSprites[sTradeAnim->monSpriteIds[0]].invisible = 1;
            gSprites[sTradeAnim->monSpriteIds[1]].invisible = 1;
            BlendPalettes(0x1, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        }
        break;
    ...
    case STATE_POKEBALL_ARRIVE:
        ...
        BlendPalettes(1 << (16 + gSprites[sTradeAnim->bouncingPokeballSpriteId].oam.paletteNum), 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeAnim->state++;
        sTradeAnim->timer = 0;
        break;
    case STATE_FADE_POKEBALL_TO_NORMAL:
        BeginNormalPaletteFade(1 << (16 + gSprites[sTradeAnim->bouncingPokeballSpriteId].oam.paletteNum), 1, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeAnim->state++;
        break;
    case STATE_POKEBALL_ARRIVE_WAIT:
        if (gSprites[sTradeAnim->bouncingPokeballSpriteId].callback == SpriteCallbackDummy)
        {
            HandleLoadSpecialPokePic(&gMonFrontPicTable[sTradeAnim->monSpecies[1]],
    ...
    case STATE_SHOW_NEW_MON:
        ...
        CreatePokeballSpriteToReleaseMon(sTradeAnim->monSpriteIds[1], gSprites[sTradeAnim->monSpriteIds[1]].oam.paletteNum, 120, 84, 2, 1, 20, 0xFFFFF);
    ...
    case STATE_DELAY_FOR_MON_ANIM:
        if (++sTradeAnim->timer > 60)
        {
            if (sTradeAnim->monSpecies[1] != 479)
                PlayCry_Normal(sTradeAnim->monSpecies[1], 0);
    ...
    case STATE_WAIT_FADE_OUT_END:
        if (!gPaletteFade.active)
        {
            ...
            if (sTradeAnim)
            {
                ...
                FreeMonSpritesGfx();
                { Free(sTradeAnim); sTradeAnim = ((void *)0); };
            }
...
static bool8 DoTradeAnim_Wireless(void)
{
    ...
    case STATE_CROSSING_LINK_MONS_ENTER:
        ...
        break;
    case STATE_CROSSING_BLEND_WHITE_1:
        BlendPalettes(0x8, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
        sTradeAnim->state++;
        break;
    case STATE_CROSSING_BLEND_WHITE_2:
        BlendPalettes(0x8, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
...
static void CB2_TryLinkTradeEvolution(void)
{
    ...
    case 4:
        ...
        if (evoSpecies != 0)
            TradeEvolutionScene(&gPlayerParty[gSelectedTradeMonPositions[0]], evoSpecies, sTradeAnim->monSpriteIds[1], gSelectedTradeMonPositions[0]);
        else
...
static void SpriteCB_BouncingPokeballDepart(struct Sprite *sprite)
{
    ...
    if (++sprite->data[0] == 44)
    {
        ...
        sprite->data[0] = 0;
        BeginNormalPaletteFade(1 << (sprite->oam.paletteNum + 16), -1, 0, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
    }
}
...
static void CreateInGameTradePokemonInternal(u8 playerSlot, u8 inGameTradeIdx)
{
    ...
    u8 level = GetMonData(&gPlayerParty[playerSlot], 56);
    struct Mail mail;
    u8 metLocation = 0xFE;
    struct Pokemon * tradeMon = &gEnemyParty[0];
    u8 mailNum;
    CreateMon(tradeMon, inGameTrade->species, level, (31 + 1), 1, inGameTrade->personality, 1, inGameTrade->otId);
    SetMonData(tradeMon, 39, &inGameTrade->ivs[0]);
    SetMonData(tradeMon, 40, &inGameTrade->ivs[1]);
    SetMonData(tradeMon, 41, &inGameTrade->ivs[2]);
    SetMonData(tradeMon, 42, &inGameTrade->ivs[3]);
    SetMonData(tradeMon, 43, &inGameTrade->ivs[4]);
    SetMonData(tradeMon, 44, &inGameTrade->ivs[5]);
    SetMonData(tradeMon, 2, inGameTrade->nickname);
    SetMonData(tradeMon, 7, inGameTrade->otName);
    SetMonData(tradeMon, 49, &inGameTrade->otGender);
    SetMonData(tradeMon, 46, &inGameTrade->abilityNum);
    SetMonData(tradeMon, 23, &inGameTrade->conditions[1]);
    SetMonData(tradeMon, 24, &inGameTrade->conditions[2]);
    SetMonData(tradeMon, 22, &inGameTrade->conditions[0]);
    SetMonData(tradeMon, 33, &inGameTrade->conditions[3]);
    SetMonData(tradeMon, 47, &inGameTrade->conditions[4]);
    SetMonData(tradeMon, 48, &inGameTrade->sheen);
    SetMonData(tradeMon, 35, &metLocation);
    mailNum = 0;
    if (inGameTrade->heldItem != 0)
    {
        if (ItemIsMail(inGameTrade->heldItem))
        {
            ...
            SetMonData(tradeMon, 64, &mailNum);
            SetMonData(tradeMon, 12, &inGameTrade->heldItem);
        }
        else
        {
            SetMonData(tradeMon, 12, &inGameTrade->heldItem);
...
static void CB2_SaveAndEndTrade(void)
{
    ...
    case 50:
        if (InUnionRoom())
        {
            SetQuestLogEvent(18, sTradeAnim->questLogSpecies);
        }
        else
        {
            SetQuestLogEvent(12, sTradeAnim->questLogSpecies);
...
static void CheckPartnersMonForRibbons(void)
{
    ...
    u8 i;
    for (i = 0; i < (79 - 67); i++)
        numRibbons += GetMonData(&gEnemyParty[gSelectedTradeMonPositions[1] % 6], 67 + i);
...
static void Task_AnimateWirelessSignal(u8 taskId)
{
    ...
    u16 paletteIdx = 16 * sWirelessSignalAnimParams[data[0]][0];
    ...
    if (!data[2])
    {
        if (paletteIdx == 0x100)
            ...
            LoadPalette(&sWirelessSignalAnimPals_Outbound[paletteIdx], (0x000 + ((3) * 16)), ((16) * sizeof(u16)));
    }
    else
    {
        if (paletteIdx == 0x100)
            ...
            LoadPalette(&sWirelessSignalAnimPals_Inbound[paletteIdx], (0x000 + ((3) * 16)), ((16) * sizeof(u16)));
    }
...
static void Task_OpenCenterWhiteColumn(u8 taskId)
{
    ...
    if (data[0] == 0)
    {
        sTradeAnim->win0left = sTradeAnim->win0right = 240 / 2;
        sTradeAnim->win0top = 0;
        sTradeAnim->win0bottom = 160;
    ...
    SetGpuReg(0x40, ((sTradeAnim->win0right) | ((sTradeAnim->win0left) << 8)));
    SetGpuReg(0x44, ((sTradeAnim->win0bottom) | ((sTradeAnim->win0top) << 8)));
...
static void Task_CloseCenterWhiteColumn(u8 taskId)
{
    ...
    if (sTradeAnim->win0left != 240 / 2)
    {
        data[0]++;
        sTradeAnim->win0left += 5;
        sTradeAnim->win0right -= 5;

        if (sTradeAnim->win0left > 240 / 2 - 5)
            BlendPalettes(0x8, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
    }
    else
    {
