...
__attribute__((section("ewram_data"))) struct MapPosition gPlayerFacingPosition = {};
...
bool8 SetUpFieldMove_RockSmash(void)
{
    if (CheckObjectGraphicsInFrontOfPlayer(96) == 1)
    {
...
bool8 FldEff_UseRockSmash(void)
{
    ...
    gTasks[taskId].data[8] = (u32)StartRockSmashFieldEffect >> 16; gTasks[taskId].data[9] = (u32)StartRockSmashFieldEffect;;
