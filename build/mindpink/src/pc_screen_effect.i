# 0 "src/pc_screen_effect.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pc_screen_effect.c"
...
# 4 "src/pc_screen_effect.c" 2
# 19 "src/pc_screen_effect.c"
...
static void BeginPCScreenEffect(TaskFunc func, u16 speed, u16 unused, u8 priority)
{
    ...
    gTasks[taskId].data[1] = speed == 0 ? 16 : speed;
    gTasks[taskId].data[2] = speed == 0 ? 20 : speed;
...
static void Task_PCScreenEffect_TurnOn(u8 taskId)
{
    ...
    case 2:
        ...
        if (task->data[3] <= 0 || task->data[4] >= 240)
        {
            task->data[3] = 0;
            task->data[4] = 240;
            SetGpuReg(0x54, 0);
    ...
    case 3:
        ...
        if (task->data[5] <= 0 || task->data[6] >= 160)
        {
            task->data[5] = 0;
            task->data[6] = 160;
