...
static __attribute__((section("ewram_data"))) struct {
    ...
    s16 seqId;
    u8 unused[8];
} * sTMCaseDynamicResources = ((void *)0);
...
static __attribute__((section("ewram_data"))) struct {
    ...
    u16 selectedRow;
    u16 scrollOffset;
} * sPokedudeBagBackup = ((void *)0);

static __attribute__((section("ewram_data"))) void *sTilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) struct ListMenuItem * sListMenuItemsBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u8 (* sListMenuStringsBuffer)[29] = ((void *)0);
static __attribute__((section("ewram_data"))) u16 * sTMSpritePaletteBuffer = ((void *)0);
...
static __attribute__((aligned(4))) const u16 sPal3Override[] = {((8) | ((8) << 5) | ((8) << 10)), ((30) | ((16) << 5) | ((6) << 10))};
...
static const u16 sTMSpritePaletteOffsetByType[18] = {
    [0] = 0x000,
    [10] = 0x010,
    [11] = 0x020,
    [12] = 0x030,
...
void InitTMCase(u8 type, void (* exitCallback)(void), bool8 allowSelectClose)
{
    ...
    sTMCaseDynamicResources->nextScreenCallback = ((void *)0);
    sTMCaseDynamicResources->scrollArrowsTaskId = 0xFF;
...
static bool8 DoSetUpTMCaseUI(void)
{
    ...
    case 8:
        ...
        break;
    case 9:
        SortPocketAndPlaceHMsFirst(&gBagPockets[4 - 1]);
        gMain.state++;
        break;
    case 10:
    ...
    case 15:
        ...
        break;
    case 16:
        sTMCaseDynamicResources->discSpriteId = CreateDiscSprite(BagGetItemIdByPocketPosition(4, sTMCaseStaticResources.scrollOffset + sTMCaseStaticResources.selectedRow));
        gMain.state++;
        break;
    case 17:
...
{
    sTMCaseDynamicResources = ((void *)0);
    sTilemapBuffer = ((void *)0);
    sListMenuItemsBuffer = ((void *)0);
    sListMenuStringsBuffer = ((void *)0);
    sTMSpritePaletteBuffer = ((void *)0);
}
...
static bool8 HandleLoadTMCaseGraphicsAndPalettes(void)
{
    ...
    case 3:
        if (gSaveBlock2Ptr->playerGender == 0)
            LoadCompressedPalette(gTMCaseMenu_Male_Pal, (0x000 + ((0) * 16)), 4 * ((16) * sizeof(u16)));
        else
            LoadCompressedPalette(gTMCaseMenu_Female_Pal, (0x000 + ((0) * 16)), 4 * ((16) * sizeof(u16)));
        sTMCaseDynamicResources->seqId++;
        break;
    case 4:
...
static void CreateTMCaseListMenuBuffers(void)
{
    struct BagPocket * pocket = &gBagPockets[4 - 1];
...
static void GetTMNumberAndMoveString(u8 * dest, u16 itemId)
{
    ...
    if (itemId >= 340)
    {
        ...
        ConvertIntToDecimalStringN(gStringVar1, itemId - 340 + 1, STR_CONV_MODE_LEADING_ZEROS, 1);
        StringAppend(gStringVar4, gStringVar1);
    }
    else
    {
        StringAppend(gStringVar4, gText_NumberClear01);
        ConvertIntToDecimalStringN(gStringVar1, itemId - 290 + 1, STR_CONV_MODE_LEADING_ZEROS, 2);
        StringAppend(gStringVar4, gStringVar1);
    }
...
static void List_MoveCursorFunc(s32 itemIndex, bool8 onInit, struct ListMenu *list)
{
    ...
    if (itemIndex == -2)
        ...
        itemId = BagGetItemIdByPocketPosition(4, itemIndex);
...
static void List_ItemPrintFunc(u8 windowId, u32 itemIndex, u8 y)
{
    if (itemIndex != -2)
    {
        if (!(ItemId_GetImportance(BagGetItemIdByPocketPosition(4, itemIndex)) != 0))
        {
            ConvertIntToDecimalStringN(gStringVar1, BagGetQuantityByPocketPosition(4, itemIndex), STR_CONV_MODE_RIGHT_ALIGN, 3);
            StringExpandPlaceholders(gStringVar4, gText_TimesStrVar1);
            TMCase_Print(windowId, FONT_SMALL, gStringVar4, 126, y, 0, 0, 0xFF, COLOR_DARK);
        }
        else
        {
...
static void PrintDescription(s32 itemIndex)
{
    const u8 * str;
    if (itemIndex != -2)
        str = ItemId_GetDescription(BagGetItemIdByPocketPosition(4, itemIndex));
    else
...
{
    if (sTMCaseDynamicResources->scrollArrowsTaskId != 0xFF)
    {
...
static void TMCaseSetup_GetTMCount(void)
{
    ...
    sTMCaseDynamicResources->maxTMsShown = ((sTMCaseDynamicResources->numTMs + 1) < (5) ? (sTMCaseDynamicResources->numTMs + 1) : (5));
}
...
{
    if (sTMCaseDynamicResources != ((void *)0))
        Free(sTMCaseDynamicResources);
    if (sTilemapBuffer != ((void *)0))
        Free(sTilemapBuffer);
    if (sListMenuItemsBuffer != ((void *)0))
        Free(sListMenuItemsBuffer);
    if (sListMenuStringsBuffer != ((void *)0))
        Free(sListMenuStringsBuffer);
    if (sTMSpritePaletteBuffer != ((void *)0))
...
static void Task_FadeOutAndCloseTMCase(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        if (sTMCaseDynamicResources->nextScreenCallback != ((void *)0))
...
static void Task_HandleListInput(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        if (IsActiveOverworldLinkBusy() != 1)
        {
            ...
            if (({(gMain.newKeys) & (0x0004);}) && sTMCaseStaticResources.allowSelectClose == 1)
            {
                PlaySE(5);
            ...
            else
            {
                ...
                default:
                    ...
                    RemoveScrollArrows();
                    PrintListCursor(data[0], COLOR_CURSOR_SELECTED);
                    data[1] = input;
                    data[2] = BagGetQuantityByPocketPosition(4, input);
                    gSpecialVar_ItemId = BagGetItemIdByPocketPosition(4, input);
...
static void Task_SelectedTMHM_Field(u8 taskId)
{
    ...
    if (!MenuHelpers_IsLinkActive() && InUnionRoom() != 1)
    {
        ...
        sTMCaseDynamicResources->numMenuActions = (sizeof(sMenuActionIndices_Field) / sizeof((sMenuActionIndices_Field)[0]));
    }
    else
    {
        ...
        sTMCaseDynamicResources->numMenuActions = (sizeof(sMenuActionIndices_UnionRoom) / sizeof((sMenuActionIndices_UnionRoom)[0]));
    }
    ...
    StringAppend(strbuf, gText_Var1IsSelected + 2);
    TMCase_Print(WIN_SELECTED_MSG, FONT_NORMAL, strbuf, 0, 2, 1, 0, 0, COLOR_DARK);
    Free(strbuf);
    if ((ItemId_GetImportance(gSpecialVar_ItemId) != 0))
    {
...
static void Action_Use(u8 taskId)
{
    ...
    ClearStdWindowAndFrameToTransparent(WIN_SELECTED_MSG, 0);
...
{
    s16 * data = gTasks[taskId].data;
    u16 itemId = BagGetItemIdByPocketPosition(4, data[1]);
    RemoveContextMenu(&sTMCaseDynamicResources->contextMenuWindowId);
    ClearStdWindowAndFrameToTransparent(WIN_SELECTED_MSG, 0);
    ClearWindowTilemap(WIN_SELECTED_MSG);
    ...
    ScheduleBgCopyTilemapToVram(0);
    ScheduleBgCopyTilemapToVram(1);
    if (!(ItemId_GetImportance(itemId) != 0))
    {
        if (CalculatePlayerPartyCount() == 0)
        {
            PrintError_ThereIsNoPokemon(taskId);
...
static void CloseMessageAndReturnToList(u8 taskId)
{
    ...
    PrintListCursor(data[0], COLOR_DARK);
    ClearDialogWindowAndFrameToTransparent(WIN_MESSAGE, 0);
...
static void Task_SelectedTMHM_GiveParty(u8 taskId)
{
    ...
    if (!(ItemId_GetImportance(BagGetItemIdByPocketPosition(4, data[1])) != 0))
    {
...
static void Task_AskConfirmSaleWithAmount(u8 taskId)
{
    ...
    ConvertIntToDecimalStringN(gStringVar3, ItemId_GetPrice(BagGetItemIdByPocketPosition(4, data[1])) / 2 * data[8], STR_CONV_MODE_LEFT_ALIGN, 6);
...
static void Task_SaleOfTMsCanceled(u8 taskId)
{
    ...
    ClearStdWindowAndFrameToTransparent(WIN_MONEY, 0);
    ClearDialogWindowAndFrameToTransparent(WIN_MESSAGE, 0);
    PutWindowTilemap(WIN_LIST);
    PutWindowTilemap(WIN_DESCRIPTION);
...
static void Task_InitQuantitySelectUI(u8 taskId)
{
    ...
    SellTM_PrintQuantityAndSalePrice(1, ItemId_GetPrice(BagGetItemIdByPocketPosition(4, data[1])) / 2 * data[8]);
    PrintPlayersMoney();
...
static void Task_QuantitySelect_HandleInput(u8 taskId)
{
    ...
    {
        SellTM_PrintQuantityAndSalePrice(data[8], ItemId_GetPrice(BagGetItemIdByPocketPosition(4, data[1])) / 2 * data[8]);
    }
    else if (({(gMain.newKeys) & (0x0001);}))
    {
        PlaySE(5);
        ClearStdWindowAndFrameToTransparent(WIN_SELL_QUANTITY, 0);
        ScheduleBgCopyTilemapToVram(0);
        ScheduleBgCopyTilemapToVram(1);
        RemoveScrollArrows();
        Task_AskConfirmSaleWithAmount(taskId);
...
void Pokedude_InitTMCase(void)
{
    ...
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_TMHM, (sizeof(gSaveBlock1Ptr->bagPocket_TMHM) / sizeof((gSaveBlock1Ptr->bagPocket_TMHM)[0])));
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_KeyItems, (sizeof(gSaveBlock1Ptr->bagPocket_KeyItems) / sizeof((gSaveBlock1Ptr->bagPocket_KeyItems)[0])));
...
static void Task_Pokedude_Run(u8 taskId)
{
    ...
    case 8:
        SetDescriptionWindowShade(1);
        PrintMessageWithFollowupTask(taskId, FONT_MALE, gPokedudeText_TMTypes, ((void *)0));
        gTasks[taskId].func = Task_Pokedude_Run;
        data[8]++;
        break;
    case 9:
    ...
    case 18:
        SetDescriptionWindowShade(1);
        PrintMessageWithFollowupTask(taskId, FONT_MALE, gPokedudeText_ReadTMDescription, ((void *)0));
        gTasks[taskId].func = Task_Pokedude_Run;
        data[8]++;
        break;
    case 20:
    ...
    case 21:
        if (!gPaletteFade.active)
        {
            ...
            CpuFastSet(gPlttBufferFaded, gPlttBufferUnfaded, (((0x200 + 0x200))/(32/8) & 0x1FFFFF));
...
static void InitWindowTemplatesAndPals(void)
{
    ...
    LoadUserWindowGfx(0, 0x5B, (0x000 + ((14) * 16)));
    LoadMenuMessageWindowGfx(0, 0x64, (0x000 + ((11) * 16)));
    LoadStdWindowGfx(0, 0x78, (0x000 + ((13) * 16)));
    LoadPalette(gStandardMenuPalette, (0x000 + ((15) * 16)), ((16) * sizeof(u16)));
    LoadPalette(gStandardMenuPalette, (0x000 + ((10) * 16)), ((16) * sizeof(u16)));
    LoadPalette(sPal3Override, (0x000 + ((15) * 16)) + 6, sizeof(sPal3Override));
    LoadPalette(sPal3Override, (0x000 + ((13) * 16)) + 6, sizeof(sPal3Override));
    ListMenuLoadStdPalAt((0x000 + ((12) * 16)), 1);
...
static void TMCase_SetWindowBorder1(u8 windowId)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x5B, 14);
}

static void TMCase_SetWindowBorder2(u8 windowId)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x78, 13);
}
...
static void DrawMoveInfoLabels(void)
{
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, (18 + 1), 0, 0);
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, (18 + 2), 0, 12);
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, (18 + 3), 0, 24);
    BlitMenuInfoIcon(WIN_MOVE_INFO_LABELS, (18 + 4), 0, 36);
...
static void PrintMoveInfo(u16 itemId)
{
    ...
    {
        for (i = 0; i < 4; i++)
            TMCase_Print(WIN_MOVE_INFO, FONT_NORMAL_COPY_2, gText_ThreeHyphens, 7, 12 * i, 0, 0, 0xFF, COLOR_MOVE_INFO);
    ...
    else
    {
        ...
        TMCase_Print(WIN_MOVE_INFO, FONT_NORMAL_COPY_2, str, 7, 12, 0, 0, 0xFF, COLOR_MOVE_INFO);
        ...
        TMCase_Print(WIN_MOVE_INFO, FONT_NORMAL_COPY_2, str, 7, 24, 0, 0, 0xFF, COLOR_MOVE_INFO);


        ConvertIntToDecimalStringN(gStringVar1, gBattleMoves[move].pp, STR_CONV_MODE_RIGHT_ALIGN, 3);
        TMCase_Print(WIN_MOVE_INFO, FONT_NORMAL_COPY_2, gStringVar1, 7, 36, 0, 0, 0xFF, COLOR_MOVE_INFO);
...
static u8 CreateDiscSprite(u16 itemId)
{
    u8 spriteId = CreateSprite(&sSpriteTemplate_Disc, 41, 46, 0);
    u8 tmIdx;
    if (itemId == 0)
    {
        SetDiscSpritePosition(&gSprites[spriteId], 0xFF);
        return spriteId;
    }
    else
    {
...
static void TintDiscpriteByType(u8 type)
{
    u8 palOffset = ((IndexOfSpritePaletteTag(400)) * 16);
    LoadPalette(sTMSpritePaletteBuffer + sTMSpritePaletteOffsetByType[type], 0x100 + palOffset, ((16) * sizeof(u16)));
    if (sTMCaseStaticResources.menuType == TMCASE_POKEDUDE)
        BlendPalettes(1 << (16 + palOffset), 4, ((0) | ((0) << 5) | ((0) << 10)));
}
...
static void SetDiscSpritePosition(struct Sprite *sprite, u8 tmIdx)
{
    ...
    else
    {
        ...
        x = 41 - ((s32)((((s32)((14 * tmIdx) << 8)) / (50 + 8)) >> 8));
        y = 46 + ((s32)((((s32)((8 * tmIdx) << 8)) / (50 + 8)) >> 8));
    }
    sprite->x = x;
    sprite->y = y;
}
...
static void SpriteCB_SwapDisc(struct Sprite *sprite)
{
    ...
    case 0:
        ...
        if (sprite->y2 >= 20)
        {
            ...
            {
                sprite->data[1]++;
                TintDiscpriteByType(gBattleMoves[ItemIdToBattleMoveId(sprite->data[0])].type);
                sprite->data[0] -= 290;
...
static void LoadDiscTypePalettes(void)
{
    ...
    sTMSpritePaletteBuffer = Alloc(((18 - 1) * 16) * sizeof(u16));
    ...
    spritePalette.data = sTMSpritePaletteBuffer + ((18 - 1) * 16);
