# 0 "src/dodrio_berry_picking_comm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/dodrio_berry_picking_comm.c"
...
# 2 "src/dodrio_berry_picking_comm.c" 2
...
# 3 "src/dodrio_berry_picking_comm.c" 2
# 1 "include/link.h" 1
# 110 "include/link.h"
enum {
    BLOCK_REQ_SIZE_NONE,
...
# 4 "src/dodrio_berry_picking_comm.c" 2
...
# 5 "src/dodrio_berry_picking_comm.c" 2
...
{
    u8 id;
    bool8 __attribute__((aligned(4))) ready;
};
...
{
    u8 id;
    u8 __attribute__((aligned(4))) pickState;
};
