# 0 "src/pokedex_area_markers.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/pokedex_area_markers.c"
...
# 2 "src/pokedex_area_markers.c" 2
# 1 "include/gflib.h" 1
...
# 3 "src/pokedex_area_markers.c" 2
...
# 4 "src/pokedex_area_markers.c" 2
# 1 "include/task.h" 1
# 13 "include/task.h"
...
# 5 "src/pokedex_area_markers.c" 2
# 1 "include/wild_pokemon_area.h" 1



s32 GetSpeciesPokedexAreaMarkers(u16 species, struct Subsprite * subsprites);
# 6 "src/pokedex_area_markers.c" 2
...
# 7 "src/pokedex_area_markers.c" 2
...
# 8 "src/pokedex_area_markers.c" 2
# 18 "src/pokedex_area_markers.c"
struct PAM_TaskData
{
...
static void Task_ShowAreaMarkers(u8 taskId)
{
    ...
    gSprites[data->spriteId].invisible = 0;
}
...
u8 CreatePokedexAreaMarkers(u16 species, u16 tilesTag, u8 palIdx, u8 y)
{
    ...
    LoadPalette(sMarkerPal, (0x100 + ((palIdx) * 16)), sizeof(sMarkerPal));
    ...
    SetGpuReg(0x50, (1 << 1) | (1 << 6) | (1 << 8) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 13));
    SetGpuReg(0x52, (((8) << 8) | (12)));
    SetGpuReg(0x54, 0);
    SetGpuReg(0x48, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12));
    SetGpuReg(0x4a, (1 << 0) | (1 << 2) | (1 << 3) | (1 << 4) | (1 << 5) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 13));
...
void DestroyPokedexAreaMarkers(u8 taskId)
{
    ...
    SetGpuReg(0x54, 0);
    SetGpuReg(0x48, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12));
    SetGpuReg(0x4a, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12));
    ClearGpuRegBits(0x0, 0x8000);
    HideBg(1);
