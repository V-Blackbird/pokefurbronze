...
# 8 "src/save.c" 2
# 1 "include/save_failed_screen.h" 1



extern void DoSaveFailedScreen(u8 saveType);
...
struct
{
    u16 offset;
    u16 size;
} static const sSaveSlotLayout[14] =
{
    { 0 * 3968, sizeof(struct SaveBlock2) >= 0 * 3968 ? ((sizeof(struct SaveBlock2) - 0 * 3968) < (3968) ? (sizeof(struct SaveBlock2) - 0 * 3968) : (3968)) : 0 },

    { 0 * 3968, sizeof(struct SaveBlock1) >= 0 * 3968 ? ((sizeof(struct SaveBlock1) - 0 * 3968) < (3968) ? (sizeof(struct SaveBlock1) - 0 * 3968) : (3968)) : 0 },
    { 1 * 3968, sizeof(struct SaveBlock1) >= 1 * 3968 ? ((sizeof(struct SaveBlock1) - 1 * 3968) < (3968) ? (sizeof(struct SaveBlock1) - 1 * 3968) : (3968)) : 0 },
    { 2 * 3968, sizeof(struct SaveBlock1) >= 2 * 3968 ? ((sizeof(struct SaveBlock1) - 2 * 3968) < (3968) ? (sizeof(struct SaveBlock1) - 2 * 3968) : (3968)) : 0 },
    { 3 * 3968, sizeof(struct SaveBlock1) >= 3 * 3968 ? ((sizeof(struct SaveBlock1) - 3 * 3968) < (3968) ? (sizeof(struct SaveBlock1) - 3 * 3968) : (3968)) : 0 },

    { 0 * 3968, sizeof(struct PokemonStorage) >= 0 * 3968 ? ((sizeof(struct PokemonStorage) - 0 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 0 * 3968) : (3968)) : 0 },
    { 1 * 3968, sizeof(struct PokemonStorage) >= 1 * 3968 ? ((sizeof(struct PokemonStorage) - 1 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 1 * 3968) : (3968)) : 0 },
    { 2 * 3968, sizeof(struct PokemonStorage) >= 2 * 3968 ? ((sizeof(struct PokemonStorage) - 2 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 2 * 3968) : (3968)) : 0 },
    { 3 * 3968, sizeof(struct PokemonStorage) >= 3 * 3968 ? ((sizeof(struct PokemonStorage) - 3 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 3 * 3968) : (3968)) : 0 },
    { 4 * 3968, sizeof(struct PokemonStorage) >= 4 * 3968 ? ((sizeof(struct PokemonStorage) - 4 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 4 * 3968) : (3968)) : 0 },
    { 5 * 3968, sizeof(struct PokemonStorage) >= 5 * 3968 ? ((sizeof(struct PokemonStorage) - 5 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 5 * 3968) : (3968)) : 0 },
    { 6 * 3968, sizeof(struct PokemonStorage) >= 6 * 3968 ? ((sizeof(struct PokemonStorage) - 6 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 6 * 3968) : (3968)) : 0 },
    { 7 * 3968, sizeof(struct PokemonStorage) >= 7 * 3968 ? ((sizeof(struct PokemonStorage) - 7 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 7 * 3968) : (3968)) : 0 },
    { 8 * 3968, sizeof(struct PokemonStorage) >= 8 * 3968 ? ((sizeof(struct PokemonStorage) - 8 * 3968) < (3968) ? (sizeof(struct PokemonStorage) - 8 * 3968) : (3968)) : 0 },
};



typedef char SaveBlock2FreeSpace[(sizeof(struct SaveBlock2) <= 3968) ? 1 : -1];;
typedef char SaveBlock1FreeSpace[(sizeof(struct SaveBlock1) <= 3968 * (4 - 1 + 1)) ? 1 : -1];;
typedef char PokemonStorageFreeSpace[(sizeof(struct PokemonStorage) <= 3968 * (13 - 5 + 1)) ? 1 : -1];;
...
struct SaveSectorLocation gRamSaveSectorLocations[14];
u16 gSaveAttemptStatus;

__attribute__((section("ewram_data"))) struct SaveSector gSaveDataBuffer = {0};
__attribute__((section("ewram_data"))) u32 gSaveUnusedVar2 = 0;
...
static u8 HandleWriteSector(u16 sectorId, const struct SaveSectorLocation *locations)
{
    ...
    gSaveDataBufferPtr->signature = 0x08012025;
...
static u8 HandleReplaceSector(u16 sectorId, const struct SaveSectorLocation *locations)
{
    ...
    for (i = 0; i < ((size_t)&((struct SaveSector *)0)->signature); i++)
    {
    ...
    else
    {
        ...
        for (i = 0; i < (3968 + 128) - (((size_t)&((struct SaveSector *)0)->signature) + 1); i++)
        {
            if (ProgramFlashByte(sectorNum, ((size_t)&((struct SaveSector *)0)->signature) + 1 + i, ((u8 *)gSaveDataBufferPtr)[((size_t)&((struct SaveSector *)0)->signature) + 1 + i]))
            {
                status = 0xFF;
                break;
            }
...
static u8 CopySectorSignatureByte(u16 sectorId, const struct SaveSectorLocation *locations)
{
    ...
    if (ProgramFlashByte(sector, ((size_t)&((struct SaveSector *)0)->signature), ((u8 *)gSaveDataBufferPtr)[((size_t)&((struct SaveSector *)0)->signature)]))
    {
...
static u8 WriteSectorSignatureByte(u16 sectorId, const struct SaveSectorLocation *locations)
{
    ...
    if (ProgramFlashByte(sector, ((size_t)&((struct SaveSector *)0)->signature), 0x08012025 & 0xFF))
    {
...
static u8 CopySaveSlotData(u16 sectorId, const struct SaveSectorLocation *locations)
{
    ...
    for (i = 0; i < 14; i++)
    {
        ...
        if (gSaveDataBufferPtr->signature == 0x08012025 && gSaveDataBufferPtr->checksum == checksum)
        {
            u16 j;
...
static u8 GetSaveValidStatus(const struct SaveSectorLocation *locations)
{
    ...
    for (sector = 0; sector < 14; sector++)
    {
        ...
        if (gSaveDataBufferPtr->signature == 0x08012025)
        {
            signatureValid = 1;
    ...
    for (sector = 0; sector < 14; sector++)
    {
        ReadFlashSector(14 + sector, gSaveDataBufferPtr);
        if (gSaveDataBufferPtr->signature == 0x08012025)
        {
            signatureValid = 1;
            checksum = CalculateChecksum(gSaveDataBufferPtr->data, locations[gSaveDataBufferPtr->id].size);
...
static u8 TryLoadSaveSector(u8 sectorId, u8 *data, u16 size)
{
    ...
    if (sector->signature == 0x08012025)
    {
...
u8 HandleSavingData(u8 saveType)
{
    ...
    case SAVE_EREADER:
        ...
        WriteSaveSectorOrSlot(0, gRamSaveSectorLocations);
        break;
...
bool8 LinkFullSave_WriteSector(void)
{
    u8 status = HandleWriteIncrementalSector(14, gRamSaveSectorLocations);
    if (gDamagedSaveSectors)
...
u8 LoadGameSave(u8 saveType)
{
    ...
    case SAVE_NORMAL:
    default:
        result = TryLoadSaveSlot(0xFFFF, gRamSaveSectorLocations);
        LoadSerializedGame();
        gSaveFileStatus = result;
        gGameContinueCallback = ((void *)0);
        break;
    case SAVE_HALL_OF_FAME:
        result = TryLoadSaveSector(28, gDecompressionBuffer, 3968);
        if (result == 1)
            result = TryLoadSaveSector(29, gDecompressionBuffer + 3968, 3968);
        break;
    }
...
u32 TryReadSpecialSaveSector(u8 sectorId, u8 *dst)
{
    ...
    if (sectorId != 30 && sectorId != 31)
        return 0xFF;

    ReadFlash(sectorId, 0, (u8 *)&gSaveDataBuffer, (3968 + 128));
    if (*(u32 *)(&gSaveDataBuffer.data[0]) != 0xB39D)
        return 0xFF;


    i = 0;
    size = ((size_t)&((struct SaveSector *)0)->counter) - 1;
