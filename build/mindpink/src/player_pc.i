...
static void Task_DrawPlayerPcTopMenu(u8 taskId)
{
    ...
    AddItemMenuActionTextPrinters(data[10], FONT_NORMAL, GetMenuCursorDimensionByFont(FONT_NORMAL, 0), 2, GetFontAttribute(FONT_NORMAL, FONTATTR_LETTER_SPACING), 16, sTopMenuItemCount, sMenuActions_TopMenu, sItemOrder);
    Menu_InitCursor(data[10], FONT_NORMAL, 0, 2, 16, sTopMenuItemCount, 0);
...
static void Task_CreateItemStorageSubmenu(u8 taskId, u8 cursorPos)
{
    ...
    SetStdWindowBorderStyle(data[10], 0);
    PrintTextArray(data[10], FONT_NORMAL, GetMenuCursorDimensionByFont(FONT_NORMAL, 0), 2, 16, 3, sMenuActions_ItemPc);
    Menu_InitCursor(data[10], FONT_NORMAL, 0, 2, 16, 3, cursorPos);
    ScheduleBgCopyTilemapToVram(0);
...
static void PrintStringOnWindow0WithDialogueFrame(const u8 *str)
{
    ...
    AddTextPrinterParameterized(0, FONT_NORMAL, str, 0, 1, 0, ((void *)0));
}
...
static void Task_DrawMailboxPcMenu(u8 taskId)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_Mailbox, (80 - width) / 2, 2, 0, ((void *)0));
    ScheduleBgCopyTilemapToVram(0);
