# 0 "src/fame_checker.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/fame_checker.c"
...
# 3 "src/fame_checker.c" 2
# 1 "include/constants/songs.h" 1
# 4 "src/fame_checker.c" 2
...
# 15 "src/fame_checker.c" 2
# 1 "include/task.h" 1
# 16 "src/fame_checker.c" 2
...
# 19 "src/fame_checker.c" 2
# 1 "include/fame_checker.h" 1
# 20 "src/fame_checker.c" 2
...
extern const u8 gText_PokeSum_EggOrigin_Trade[];
# 21 "src/fame_checker.c" 2
# 1 "include/constants/event_objects.h" 1
# 22 "src/fame_checker.c" 2
# 34 "src/fame_checker.c"
...
static __attribute__((section("ewram_data"))) u16 * sBg3TilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u16 * sBg1TilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) u16 * sBg2TilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) struct FameCheckerData * sFameCheckerData = ((void *)0);
static __attribute__((section("ewram_data"))) struct ListMenuItem * sListMenuItems = ((void *)0);
static __attribute__((section("ewram_data"))) s32 sLastMenuIdx = 0;
...
static const u16 sUnkPalette[] = INCBIN_U16("graphics/fame_checker/unk.gbapal");
...
static const u8 *const sFameCheckerNameAndQuotesPointers[2 * 16] =
{
...
static const struct SpriteSheet sUISpriteSheets[] = {
    {sSelectorCursorSpriteGfx, 0x400, 1000},
    {sQuestionMarkSpriteGfx, 0x100, 1001},
    {sSpinningPokeballSpriteGfx, 0x1e0, 1002},
    {sDaisySpriteGfx, 0x800, 1006},
    {sFujiSpriteGfx, 0x800, 1007},
    {sOakSpriteGfx, 0x800, 1008},
    {sBillSpriteGfx, 0x800, 1009},
    {}
};

static const struct SpritePalette sUISpritePalettes[] = {
    {sSelectorCursorSpritePalette, 1000},
    {sSpinningPokeballSpritePalette, 1002},
    {}
};
...
static const struct SpriteTemplate sSpriteTemplate_SelectorCursor = {
    1000, 1000, &sSelectorCursorOamData, sSelectorCursorAnims, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy
};
...
static const struct SpriteTemplate sQuestionMarkTileSpriteTemplate = {
    1001, 0xffff, &sQuestionMarkTileOamData, sQuestionMarkTileAnims, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy
};
...
static const struct SpriteTemplate sSpinningPokeballSpriteTemplate = {
    1002, 1002, &sSpinningPokeballOamData, sSpinningPokeballAnims, ((void *)0), sSpinningPokeballAffineAnims, SpriteCB_FCSpinningPokeball
};
...
static const struct SpriteTemplate sDaisySpriteTemplate = {
    1006, 0xffff, &sDaisyFujiOakBillOamData, sDaisyFujiOakBillAnims, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy
};

static const struct SpriteTemplate sFujiSpriteTemplate = {
    1007, 0xffff, &sDaisyFujiOakBillOamData, sDaisyFujiOakBillAnims, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy
};

static const struct SpriteTemplate sOakSpriteTemplate = {
    1008, 0xffff, &sDaisyFujiOakBillOamData, sDaisyFujiOakBillAnims, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy
};

static const struct SpriteTemplate sBillSpriteTemplate = {
    1009, 0xffff, &sDaisyFujiOakBillOamData, sDaisyFujiOakBillAnims, ((void *)0), gDummySpriteAffineAnimTable, SpriteCallbackDummy
};
...
void UseFameChecker(MainCallback savedCallback)
{
    ...
    sFameCheckerData->viewingFlavorText = 0;
    PlaySE(199);
...
static void MainCB2_LoadFameChecker(void)
{
    switch (gMain.state)
    {
        ...
        case 2:
            ...
            sBg1TilemapBuffer = AllocZeroed(0x800 * 2);
            sBg2TilemapBuffer = AllocZeroed(0x800);
            ResetBgsAndClearDma3BusyFlags(0);
            InitBgsFromTemplates(0, sUIBgTemplates, (sizeof(sUIBgTemplates) / sizeof((sUIBgTemplates)[0])));
        ...
        case 3:
            ...
            LoadPalette(&gFameCheckerBgPals[0], (0x000 + ((0) * 16)), 2 * ((16) * sizeof(u16)));
            LoadPalette(&gFameCheckerBgPals[1], (0x000 + ((1) * 16)), ((16) * sizeof(u16)));
            ...
            LoadPalette(GetTextWindowPalette(2), (0x000 + ((15) * 16)), ((16) * sizeof(u16)));
            gMain.state++;
            break;
        case 4:
...
static void Task_TopMenuHandleInput(u8 taskId)
{
    ...
    {
        RunTextPrinters();
        if ((({(gMain.newKeys) & (0x0004);})) && !sFameCheckerData->inPickMode && sFameCheckerData->savedCallback != CB2_BagMenuFromStartMenu)
            task->func = Task_StartToCloseFameChecker;
        else if (({(gMain.newKeys) & (0x0008);}))
        {
            cursorPos = FameCheckerGetCursorY();
            if (TryExitPickMode(taskId) == 1)
            {
                PlaySE(203);
            }
            else if (cursorPos != sFameCheckerData->numUnlockedPersons - 1)
            {
                PlaySE(203);
                FillWindowPixelRect(FCWINDOWID_ICONDESC, ((0) | ((0) << 4)), 0, 0, 88, 32);
        ...
        else if (({(gMain.newKeys) & (0x0001);}))
        {
            ...
            if (cursorPos == sFameCheckerData->numUnlockedPersons - 1)
                task->func = Task_StartToCloseFameChecker;
            else if (sFameCheckerData->inPickMode)
            {
                if (!IsTextPrinterActive(2) && HasUnlockedAllFlavorTextsForCurrentPerson() == 1)
                    GetPickModeText();
            }
            else if (sFameCheckerData->personHasUnlockedPanels)
            {
                ...
                {
                    if (i != task->data[1])
                        SetMessageSelectorIconObjMode(sFameCheckerData->spriteIds[i], 1);
                }
                gIconDescriptionBoxIsOpen = 0xFF;
                PlaceListMenuCursor(0);
                PrintUIHelp(2);
...
static bool8 TryExitPickMode(u8 taskId)
{
    ...
    if (sFameCheckerData->inPickMode)
    {
        ...
        sFameCheckerData->pickModeOverCancel = 0;
        return 1;
    }
    return 0;
}
...
static void MessageBoxPrintEmptyText(void)
{
    AddTextPrinterParameterized2(FCWINDOWID_MSGBOX, FONT_NORMAL, gFameCheckerText_ClearTextbox, 0, ((void *)0), 0x2, 0x1, 0x3);
}
...
static void Task_FlavorTextDisplayHandleInput(u8 taskId)
{
    ...
    RunTextPrinters();
    if (({(gMain.newKeys) & (0x0001);}) && !IsTextPrinterActive(2))
    {
    ...
    if (({(gMain.newKeys) & (0x0002);}))
    {
        ...
        PlaySE(5);
        for (i = 0; i < 6; i++)
            SetMessageSelectorIconObjMode(sFameCheckerData->spriteIds[i], 0);
        WipeMsgBoxAndTransfer();
        ...
        PlaceListMenuCursor(1);
        PrintUIHelp(0);
        FC_CreateScrollIndicatorArrowPair();
        MessageBoxPrintEmptyText();
        task->func = Task_TopMenuHandleInput;
    }
    else if (({(gMain.newKeys) & (0x0040);}) || ({(gMain.newKeys) & (0x0080);}))
    {
        if (task->data[1] >= 3)
        {
            task->data[1] -= 3;
...
static void FC_MoveSelectorCursor(u8 taskId, s8 dx, s8 dy)
{
    ...
    for (i = 0; i < 6; i++)
        SetMessageSelectorIconObjMode(sFameCheckerData->spriteIds[i], 1);
    FillWindowPixelRect(FCWINDOWID_MSGBOX, ((1) | ((1) << 4)), 0, 0, 0xd0, 0x20);
    MessageBoxPrintEmptyText();
    if (SetMessageSelectorIconObjMode(sFameCheckerData->spriteIds[data[1]], 0) == 1)
    {
        PrintSelectedNameInBrightGreen(taskId);
        UpdateIconDescriptionBox(data[1]);
    }
...
static void GetPickModeText(void)
{
    ...
    if (gSaveBlock1Ptr->fameChecker[sFameCheckerData->unlockedPersons[who]].pickState != 2)
    {
        WipeMsgBoxAndTransfer();
        MessageBoxPrintEmptyText();
    }
    ...
    {
        FillWindowPixelRect(FCWINDOWID_MSGBOX, ((1) | ((1) << 4)), 0, 0, 0xd0, 0x20);
        if (HasUnlockedAllFlavorTextsForCurrentPerson() == 1)
            whichText = 16;
        StringExpandPlaceholders(gStringVar4, sFameCheckerNameAndQuotesPointers[sFameCheckerData->unlockedPersons[who] + whichText]);
        AddTextPrinterParameterized2(FCWINDOWID_MSGBOX, FONT_NORMAL, gStringVar4, GetTextSpeedSetting(), ((void *)0), 0x2, 0x1, 0x3);
...
static void Setup_DrawMsgAndListBoxes(void)
{
    ...
    DrawDialogueFrame(FCWINDOWID_MSGBOX, 1);
    FC_PutWindowTilemapAndCopyWindowToVramMode3(FCWINDOWID_MSGBOX);
...
static void Task_DestroyAssetsAndCloseFameChecker(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        DestroyListMenuTask(sFameCheckerData->listMenuTaskId, ((void *)0), ((void *)0));
...
static void PrintUIHelp(u8 state)
{
    ...
    FillWindowPixelRect(FCWINDOWID_UIHELP, ((0) | ((0) << 4)), 0, 0, 0xc0, 0x10);
...
static bool8 CreateAllFlavorTextIcons(u8 who)
{
    ...
    if (result == 1)
    {
        sFameCheckerData->personHasUnlockedPanels = 1;
        if (sFameCheckerData->inPickMode)
            PrintUIHelp(1);
        else
            PrintUIHelp(0);
    ...
    {
        sFameCheckerData->personHasUnlockedPanels = 0;
        PrintUIHelp(1);
    }
    return result;
}
...
void ResetFameChecker(void)
{
    ...
    gSaveBlock1Ptr->fameChecker[0].pickState = 2;
}
...
void FullyUnlockFameChecker(void)
{
    ...
    for (i = 0; i < 16; i++)
    {
        gSaveBlock1Ptr->fameChecker[i].pickState = 2;
        for (j = 0; j < 6; j++)
        {
...
static void FCSetup_ClearVideoRegisters(void)
{
    ...
    { vu16 *_dest = (vu16 *)(0x5000000); u32 _size = (0x200 + 0x200); { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; }; };
    SetGpuReg(0x0, 0);
    SetGpuReg(0x8, 0);
    SetGpuReg(0x10, 0);
    SetGpuReg(0x12, 0);
...
void SetFlavorTextFlagFromSpecialVars(void)
{
    if (gSpecialVar_0x8004 < 16 && gSpecialVar_0x8005 < 6)
    {
...
void UpdatePickStateFromSpecialVar8005(void)
{
    if (gSpecialVar_0x8004 < 16 && gSpecialVar_0x8005 < 3)
    {
        if (gSpecialVar_0x8005 == 0)
            return;
        if ( gSpecialVar_0x8005 == 1
            && gSaveBlock1Ptr->fameChecker[gSpecialVar_0x8004].pickState == 2
           )
            return;
...
static void FreeSpinningPokeballSpriteResources(void)
{
    FreeSpriteTilesByTag(1002);
    FreeSpritePaletteByTag(1002);
}
...
static void FreeNonTrainerPicTiles(void)
{
    FreeSpriteTilesByTag(1006);
    FreeSpriteTilesByTag(1007);
    FreeSpriteTilesByTag(1008);
    FreeSpriteTilesByTag(1009);
}
...
static u8 CreatePersonPicSprite(u8 fcPersonIdx)
{
    ...
    if (fcPersonIdx == 1)
    {
        spriteId = CreateSprite(&sDaisySpriteTemplate, 148, 66, 0);
        LoadPalette(sDaisySpritePalette, (0x100 + ((6) * 16)), sizeof(sDaisySpritePalette));
        gSprites[spriteId].oam.paletteNum = 6;
    }
    else if (fcPersonIdx == 14)
    {
        spriteId = CreateSprite(&sFujiSpriteTemplate, 148, 66, 0);
        LoadPalette(sFujiSpritePalette, (0x100 + ((6) * 16)), sizeof(sFujiSpritePalette));
        gSprites[spriteId].oam.paletteNum = 6;
    }
    else if (fcPersonIdx == 0)
    {
        spriteId = CreateSprite(&sOakSpriteTemplate, 148, 66, 0);
        LoadPalette(sOakSpritePalette, (0x100 + ((6) * 16)), sizeof(sOakSpritePalette));
        gSprites[spriteId].oam.paletteNum = 6;
    }
    else if (fcPersonIdx == 13)
    {
        spriteId = CreateSprite(&sBillSpriteTemplate, 148, 66, 0);
        LoadPalette(sBillSpritePalette, (0x100 + ((6) * 16)), sizeof(sBillSpritePalette));
        gSprites[spriteId].oam.paletteNum = 6;
    }
    else
    {
        spriteId = CreateTrainerPicSprite(sFameCheckerTrainerPicIdxs[fcPersonIdx], 1, 148, 66, 6, 0xFFFF);
    }
    gSprites[spriteId].callback = SpriteCB_FCSpinningPokeball;
    if (gSaveBlock1Ptr->fameChecker[fcPersonIdx].pickState == 1)
        LoadPalette(sSilhouettePalette, (0x100 + ((6) * 16)), sizeof(sSilhouettePalette));
    return spriteId;
}
...
static void DestroyPersonPicSprite(u8 taskId, u16 who)
{
    ...
    if (who == sFameCheckerData->numUnlockedPersons - 1)
        who_copy = who - 1;
    if ( sFameCheckerData->unlockedPersons[who_copy] == 1
        || sFameCheckerData->unlockedPersons[who_copy] == 14
        || sFameCheckerData->unlockedPersons[who_copy] == 0
        || sFameCheckerData->unlockedPersons[who_copy] == 13
    )
...
static void UpdateIconDescriptionBox(u8 whichText)
{
    ...
    HandleFlavorTextModeSwitch(1);
    gIconDescriptionBoxIsOpen = 1;
    FillWindowPixelRect(FCWINDOWID_ICONDESC, ((0) | ((0) << 4)), 0, 0, 0x58, 0x20);
...
static void InitListMenuTemplate(void)
{
    ...
    gFameChecker_ListMenuTemplate.itemPrintFunc = ((void *)0);
...
static void FC_MoveCursorFunc(s32 itemIndex, bool8 onInit, struct ListMenu *list)
{
    ...
    if (taskId != 0xFF)
    {
        ...
        PlaySE(5);
        task->data[1] = 0;
        ListMenuGetScrollAndRow(sFameCheckerData->listMenuTaskId, &listMenuTopIdx, ((void *)0));
        ...
        if (itemIndex != sFameCheckerData->numUnlockedPersons - 1)
        {
            ...
            if (sFameCheckerData->inPickMode)
            {
                ...
                {
                    gSprites[task->data[2]].invisible = 0;
                    sFameCheckerData->pickModeOverCancel = 0;
        ...
        else
        {
            ...
            if (sFameCheckerData->inPickMode)
            {
                gSprites[task->data[2]].invisible = 1;
                sFameCheckerData->pickModeOverCancel = 1;
            }
            else
            {
                u8 i;
                for (i = 0; i < 6; i++)
                {
                    gSprites[sFameCheckerData->spriteIds[i]].invisible = 1;
                }
            }
        }
    }
...
{
    FillWindowPixelRect(FCWINDOWID_MSGBOX, ((1) | ((1) << 4)), 0, 0, 0xd0, 0x20);
    AddTextPrinterParameterized2(FCWINDOWID_MSGBOX, FONT_NORMAL, gFameCheckerText_FameCheckerWillBeClosed, 0, ((void *)0), 0x2, 0x1, 0x3);
    FC_PutWindowTilemapAndCopyWindowToVramMode3(FCWINDOWID_MSGBOX);
}
...
static u8 FC_PopulateListMenu(void)
{
    ...
    for (i = 0; i < 16; i++)
    {
        ...
        if (gSaveBlock1Ptr->fameChecker[fameCheckerIdx].pickState != 0)
        {
            if (sTrainerIdxs[fameCheckerIdx] < 0xFE00)
            {
            ...
            {
                sListMenuItems[nitems].label = sNonTrainerNamePointers[sTrainerIdxs[fameCheckerIdx] - 0xFE00];
                sListMenuItems[nitems].index = nitems;
            }
...
static void HandleFlavorTextModeSwitch(bool8 state)
{
    if (sFameCheckerData->viewingFlavorText != state)
    {
        ...
        if (state == 1)
        {
            ...
            sFameCheckerData->viewingFlavorText = 1;
        }
        else
        {
