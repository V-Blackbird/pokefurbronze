...
static __attribute__((section("ewram_data"))) struct OptionMenu *sOptionMenuPtr = ((void *)0);
...
static const u8 sOptionMenuPickSwitchCancelTextColor[] = {0xF, 0x1, 0x2};
static const u8 sOptionMenuTextColor[] = {0x0, 0x5, 0x4};
...
static void InitOptionMenuBg(void)
{
    ...
    InitBgsFromTemplates(0, sOptionMenuBgTemplates, (sizeof(sOptionMenuBgTemplates) / sizeof((sOptionMenuBgTemplates)[0])));
    ChangeBgX(0, 0, 0);
    ChangeBgY(0, 0, 0);
    ChangeBgX(1, 0, 0);
    ChangeBgY(1, 0, 0);
    ...
    SetGpuReg(0x50, (1 << 0) | (1 << 6) | (2 << 6));
    SetGpuReg(0x54, (1 << 1));
    SetGpuReg(0x48, (1 << 0));
    SetGpuReg(0x4a, (1 << 0) | (1 << 1) | (1 << 2) | (1 << 5));
...
static bool8 LoadOptionMenuPalette(void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        LoadPalette(GetUserWindowGraphics(sOptionMenuPtr->option[MENUITEM_FRAMETYPE])->palette, (0x000 + ((2) * 16)), ((16) * sizeof(u16)));
        break;
    case 2:
        LoadPalette(sOptionMenuPalette, (0x000 + ((1) * 16)), sizeof(sOptionMenuPalette));
        LoadPalette(GetTextWindowPalette(2), (0x000 + ((15) * 16)), ((16) * sizeof(u16)));
        break;
    case 3:
        LoadStdWindowGfxOnBg(1, 0x1B3, (0x000 + ((3) * 16)));
        break;
    default:
        return 1;
    }
...
static void Task_OptionMenu(u8 taskId)
{
    ...
    case 1:
        ...
        break;
    case 2:
        if (((bool32)IsActiveOverworldLinkBusy()) == 1)
            break;
...
static u8 OptionMenu_ProcessInput(void)
{
    ...
    else if (({(gMain.newKeys) & (0x0002);}) || ({(gMain.newKeys) & (0x0001);}))
    {
        return 1;
    }
    else
...
static void CloseAndSaveOptionMenu(u8 taskId)
{
    ...
    { Free(sOptionMenuPtr); sOptionMenuPtr = ((void *)0); };
    DestroyTask(taskId);
}
...
static void PrintOptionMenuHeader(void)
{
    ...
    AddTextPrinterParameterized(WIN_TEXT_OPTION, FONT_NORMAL, gText_Option, 8, 1, 0xFF, ((void *)0));
    PutWindowTilemap(0);
...
static void LoadOptionMenuItemNames(void)
{
    ...
    for (i = 0; i < MENUITEM_COUNT; i++)
    {
        AddTextPrinterParameterized(WIN_OPTIONS, FONT_NORMAL, sOptionMenuItemsNames[i], 8, (u8)((i * (GetFontAttribute(FONT_NORMAL, FONTATTR_MAX_LETTER_HEIGHT))) + 2) - i, 0xFF, ((void *)0));
    }
}
...
static void UpdateSettingSelectionDisplay(u16 selection)
{
    ...
    SetGpuReg(0x44, (((y) << 8) | (y + maxLetterHeight)));
    SetGpuReg(0x40, (((0x10) << 8) | (0xE0)));
}
