...
{
    AppendTilesetAnimToBuffer(sTilesetAnims_General_Flower[timer % (sizeof(sTilesetAnims_General_Flower) / sizeof((sTilesetAnims_General_Flower)[0]))], (u16 *)(0x6000000 + ((508) * 32)), 4 * 32);
}

static void QueueAnimTiles_General_Water_Current_LandWatersEdge(u16 timer)
{
    AppendTilesetAnimToBuffer(sTilesetAnims_General_Water_Current_LandWatersEdge[timer % (sizeof(sTilesetAnims_General_Water_Current_LandWatersEdge) / sizeof((sTilesetAnims_General_Water_Current_LandWatersEdge)[0]))], (u16 *)(0x6000000 + ((416) * 32)), 48 * 32);
}

static void QueueAnimTiles_General_SandWatersEdge(u16 timer)
{
    AppendTilesetAnimToBuffer(sTilesetAnims_General_SandWatersEdge[timer % (sizeof(sTilesetAnims_General_SandWatersEdge) / sizeof((sTilesetAnims_General_SandWatersEdge)[0]))], (u16 *)(0x6000000 + ((464) * 32)), 18 * 32);
}
...
{
    AppendTilesetAnimToBuffer(sTilesetAnims_CeladonCity_Fountain[timer % (sizeof(sTilesetAnims_CeladonCity_Fountain) / sizeof((sTilesetAnims_CeladonCity_Fountain)[0]))], (u16 *)(0x6000000 + ((744) * 32)), 8 * 32);
}
...
{
    AppendTilesetAnimToBuffer(sTilesetAnims_SilphCo_Fountain[timer % (sizeof(sTilesetAnims_SilphCo_Fountain) / sizeof((sTilesetAnims_SilphCo_Fountain)[0]))], (u16 *)(0x6000000 + ((976) * 32)), 8 * 32);
}
...
{
    AppendTilesetAnimToBuffer(sTilesetAnims_MtEmber_Steam[timer % (sizeof(sTilesetAnims_MtEmber_Steam) / sizeof((sTilesetAnims_MtEmber_Steam)[0]))], (u16 *)(0x6000000 + ((896) * 32)), 8 * 32);
}
...
{
    u16 i = timer % (sizeof(sTilesetAnims_VermilionGym_MotorizedDoor) / sizeof((sTilesetAnims_VermilionGym_MotorizedDoor)[0]));

    AppendTilesetAnimToBuffer(sTilesetAnims_VermilionGym_MotorizedDoor[i], (u16 *)(0x6000000 + ((880) * 32)), 7 * 32);
}
...
{
    u16 i = timer % (sizeof(sTilesetAnims_CeladonGym_Flowers) / sizeof((sTilesetAnims_CeladonGym_Flowers)[0]));

    AppendTilesetAnimToBuffer(sTilesetAnims_CeladonGym_Flowers[i], (u16 *)(0x6000000 + ((739) * 32)), 4 * 32);
}
