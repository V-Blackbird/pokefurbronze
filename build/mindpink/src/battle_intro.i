...
static void BattleIntroSlide1(u8 taskId)
{
    ...
    case 3:
        ...
        if (!gTasks[taskId].data[2])
        {
            ...
            ++gTasks[taskId].data[0];
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(void *)(0x6000000 + (0x800 * (28))), 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
...
static void BattleIntroSlideLink(u8 taskId)
{
    ...
    if (gTasks[taskId].data[0] > 1 && !gTasks[taskId].data[4])
    {
        ...
        {
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(void *)(0x6000000 + (0x800 * (28))), 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(void *)(0x6000000 + (0x800 * (30))), 0x04000000 | 0x01000000 | ((0x800)/(32/8) & 0x1FFFFF)); };
...
void CopyBattlerSpriteToBg(s32 bgId, u8 x, u8 y, u8 battlerPosition, u8 palno, u8 *tilesDest, u16 *tilemapDest, u16 tilesOffset)
{
    ...
    CpuSet(gMonSpritesGfxPtr->sprites[battlerPosition] + 0x800 * gBattleMonForms[battler], tilesDest, 0x00000000 | ((0x800)/(16/8) & 0x1FFFFF));
    LoadBgTiles(bgId, tilesDest, 0x1000, tilesOffset);
    for (i = y; i < y + 8; ++i)
        for (j = x; j < x + 8; ++j)
            tilemapDest[i * 32 + j] = offset++ | (palno << 12);
    LoadBgTilemap(bgId, tilemapDest, 0x800, 0);
}
...
static void DrawBattlerOnBgDMA(u8 arg0, u8 arg1, u8 battlerPosition, u8 arg3, u8 arg4, u16 arg5, u8 arg6, u8 arg7)
{
    ...
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(gMonSpritesGfxPtr->sprites[battlerPosition] + 0x800 * arg3); dmaRegs[1] = (vu32)((void *)(void *)(0x6000000 + (0x800 * (0))) + arg5); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x800)/(16/8))); dmaRegs[2]; };
