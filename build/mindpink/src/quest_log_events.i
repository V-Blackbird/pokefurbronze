...
__attribute__((section("ewram_data"))) struct UnkStruct_203B044 gUnknown_203B044 = {0};
static __attribute__((section("ewram_data"))) u8 sEventShouldNotRecordSteps = 0;
static __attribute__((section("ewram_data"))) bool8 sNewlyEnteredMap = 0;
static __attribute__((section("ewram_data"))) u8 sLastDepartedMap = 0;
...
static u16 *(*const sQuestLogStorageCBs[])(u16 *, const u16 *) = {
    ...
    [1] = ((void *)0),
    [2] = ((void *)0),
    [3] = BufferQuestLogData_SwitchedPartyOrder,
    [4] = BufferQuestLogData_UsedItem,
    [5] = BufferQuestLogData_GaveHeldItemFromPartyMenu,
    [6] = BufferQuestLogData_GaveHeldItemFromBagMenu,
    [7] = BufferQuestLogData_GaveHeldItemFromPC,
    [8] = BufferQuestLogData_TookHeldItem,
    [9] = BufferQuestLogData_SwappedHeldItem,
    [10] = BufferQuestLogData_SwappedHeldItemFromPC,
    [11] = BufferQuestLogData_UsedPkmnCenter,
    [12] = BufferQuestLogData_LinkTraded,
    [13] = BufferQuestLogData_LinkBattledSingle,
    [14] = BufferQuestLogData_LinkBattledDouble,
    [15] = BufferQuestLogData_LinkBattledMulti,
    [16] = BufferQuestLogData_UsedUnionRoom,
    [17] = BufferQuestLogData_UsedUnionRoomChat,
    [18] = BufferQuestLogData_LinkTradedUnionRoom,
    [19] = BufferQuestLogData_LinkBattledUnionRoom,
    [20] = BufferQuestLogData_SwitchedMonsBetweenBoxes,
    [21] = BufferQuestLogData_SwitchedMonsWithinBox,
    [22] = BufferQuestLogData_SwitchedPartyMonForPCMon,
    [23] = BufferQuestLogData_MovedMonBetweenBoxes,
    [24] = BufferQuestLogData_MovedMonWithinBox,
    [25] = BufferQuestLogData_WithdrewMonFromPC,
    [26] = BufferQuestLogData_DepositedMonInPC,
    [27] = BufferQuestLogData_SwitchedMultipleMons,
    [28] = BufferQuestLogData_DepositedItemInPC,
    [29] = BufferQuestLogData_WithdrewItemFromPC,
    [30] = BufferQuestLogData_DefeatedGymLeader,
    [31] = BufferQuestLogData_DefeatedWildMon,
    [32] = BufferQuestLogData_DefeatedEliteFourMember,
    [33] = BufferQuestLogData_DefeatedChampion,
    [34] = BufferQuestLogData_DefeatedTrainer,
    [35] = BufferQuestLogData_DepartedLocation,
    [36] = BufferQuestLogData_UsedFieldMove,
    [37] = BufferQuestLogData_BoughtItem,
    [38] = BufferQuestLogData_SoldItem,
    [39] = ((void *)0),
    [40] = BufferQuestLogData_ObtainedItem,
    [41] = ((void *)0),
    [42] = BufferQuestLogData_ArrivedInLocation
};
...
void SetQuestLogEvent(u16 eventId, const u16 *eventData)
{
    ...
    if (eventId == 35 && sEventShouldNotRecordSteps == 2)
    {
    ...
    if (TrySetLinkQuestLogEvent(eventId, eventData) == 1)
        return;
    ...
    if (TrySetTrainerBattleQuestLogEvent(eventId, eventData) == 1)
        return;

    if (IsQuestLogEventWithSpecialEncounterSpecies(eventId, eventData) == 1)
        return;

    if (ShouldRegisterEvent_HandleGameCorner(eventId, eventData) == 0)
        return;

    if (gQuestLogPlaybackState == 0)
    {
        if (ShouldRegisterEvent_HandlePartyActions(eventId, eventData) == 1)
            return;

        if (eventId != 31 || gUnknown_203AE04 == ((void *)0))
        {
            if (ShouldRegisterEvent_HandleDeparted(eventId, eventData) == 0)
                return;
...
static bool8 InQuestLogDisabledLocation(void)
{
    ...
    if (gSaveBlock1Ptr->location.mapGroup == ((9 | (15 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((9 | (15 << 8)) & 0xFF))
        return 1;


    if (gSaveBlock1Ptr->location.mapGroup == ((0 | (32 << 8)) >> 8) &&
        (gSaveBlock1Ptr->location.mapNum == ((0 | (32 << 8)) & 0xFF)
         || gSaveBlock1Ptr->location.mapNum == ((1 | (32 << 8)) & 0xFF)))
        return 1;
    ...
    if ((gSaveBlock1Ptr->location.mapGroup == ((46 | (1 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((46 | (1 << 8)) & 0xFF))
        ...
        || (gSaveBlock1Ptr->location.mapGroup == ((6 | (11 << 8)) >> 8) && gSaveBlock1Ptr->location.mapNum == ((6 | (11 << 8)) & 0xFF)))
        return 1;
...
static bool8 ShouldRegisterEvent_HandlePartyActions(u16 eventId, const u16 *eventData)
{
    ...
    {
        if (eventId == 3 || eventId == 31 || ShouldRegisterEvent_HandleBeatStoryTrainer(eventId, eventData) == 1)
            return 1;
    }

    if (!FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x44)))
    {
        if (eventId == 4
            || eventId == 5
            || eventId == 6
...
static bool8 TrySetTrainerBattleQuestLogEvent(u16 eventId, const u16 *eventData)
{
    ...
    ResetDeferredLinkEvent();
    if (gQuestLogPlaybackState != 0 || FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x2C)) || ShouldRegisterEvent_HandleBeatStoryTrainer(eventId, eventData) != 1)
    {
        sDeferredEvent.id = eventId;
...
static bool8 IsQuestLogEventWithSpecialEncounterSpecies(u16 eventId, const u16 *eventData)
{
    ...
    if (IsSpeciesFromSpecialEncounter(eventData[0]) == 1)
        return 1;

    if (IsSpeciesFromSpecialEncounter(eventData[1]) == 1)
        return 1;
...
static const u16 *(*const sQuestLogEventTextBufferCBs[])(const u16 *) = {
    ...
    [1] = ((void *)0),
    [2] = ((void *)0),
    [3] = BufferQuestLogText_SwitchedPartyOrder,
    [4] = BufferQuestLogText_UsedItem,
    [5] = BufferQuestLogText_GaveHeldItemFromPartyMenu,
    [6] = BufferQuestLogText_GaveHeldItemFromBagMenu,
    [7] = BufferQuestLogText_GaveHeldItemFromPC,
    [8] = BufferQuestLogText_TookHeldItem,
    [9] = BufferQuestLogText_SwappedHeldItem,
    [10] = BufferQuestLogText_SwappedHeldItemFromPC,
    [11] = BufferQuestLogText_UsedPkmnCenter,
    [12] = BufferQuestLogText_LinkTraded,
    [13] = BufferQuestLogText_LinkBattledSingle,
    [14] = BufferQuestLogText_LinkBattledDouble,
    [15] = BufferQuestLogText_LinkBattledMulti,
    [16] = BufferQuestLogText_UsedUnionRoom,
    [17] = BufferQuestLogText_UsedUnionRoomChat,
    [18] = BufferQuestLogText_LinkTradedUnionRoom,
    [19] = BufferQuestLogText_LinkBattledUnionRoom,
    [20] = BufferQuestLogText_SwitchedMonsBetweenBoxes,
    [21] = BufferQuestLogText_SwitchedMonsWithinBox,
    [22] = BufferQuestLogText_SwitchedPartyMonForPCMon,
    [23] = BufferQuestLogText_MovedMonBetweenBoxes,
    [24] = BufferQuestLogText_MovedMonWithinBox,
    [25] = BufferQuestLogText_WithdrewMonFromPC,
    [26] = BufferQuestLogText_DepositedMonInPC,
    [27] = BufferQuestLogText_SwitchedMultipleMons,
    [28] = BufferQuestLogText_DepositedItemInPC,
    [29] = BufferQuestLogText_WithdrewItemFromPC,
    [30] = BufferQuestLogText_DefeatedGymLeader,
    [31] = BufferQuestLogText_DefeatedWildMon,
    [32] = BufferQuestLogText_DefeatedEliteFourMember,
    [33] = BufferQuestLogText_DefeatedChampion,
    [34] = BufferQuestLogText_DefeatedTrainer,
    [35] = BufferQuestLogText_DepartedLocation,
    [36] = BufferQuestLogText_UsedFieldMove,
    [37] = BufferQuestLogText_BoughtItem,
    [38] = BufferQuestLogText_SoldItem,
    [39] = ((void *)0),
    [40] = BufferQuestLogText_ObtainedItem,
    [41] = ((void *)0),
    [42] = BufferQuestLogText_ArrivedInLocation
};
...
{
    if (!WillCommandOfSizeFitInSav1Record(a0, sQuestLogEventCmdSizes[39]))
        return ((void *)0);
    a0[0] = 39;
    return a0 + 1;
}
...
{
    if (!WillCommandOfSizeFitInSav1Record(a0, sQuestLogEventCmdSizes[41]))
        return ((void *)0);
    a0[0] = 41;
    a0[1] = a1;
    return a0 + 2;
...
u16 *sub_8113CC8(u16 *a0, struct QuestLogEntry * a1)
{
    ...
    if (!WillCommandOfSizeFitInSav1Record(a0, sQuestLogEventCmdSizes[0]))
        return ((void *)0);
    a0[0] = 0;
    a0[1] = a1->duration;
    r6[0] = a1->localId;
...
u16 *sub_8113D48(u16 *a0, struct QuestLogEntry * a1)
{
    ...
    if (!WillCommandOfSizeFitInSav1Record(r4, sQuestLogEventCmdSizes[2]))
        return ((void *)0);
    if (a1->command == 0)
        r4[0] = 2;
    else
...
u16 *sub_8113D94(u16 *a0, struct QuestLogEntry * a1)
{
    ...
    if (!WillCommandOfSizeFitInSav1Record(r5, sQuestLogEventCmdSizes[2]))
        return ((void *)0);
    if (r5[0] == 2)
        a1->command = 0;
    else
...
{
    const u16 *r4 = sub_8113E88(3, eventData);
...
{
    const u16 *r5 = sub_8113E88(4, eventData);
...
{
    return BufferQuestLogData_GiveTakeHeldItem(5, a0, eventData);
}

static const u16 *BufferQuestLogText_GaveHeldItemFromPartyMenu(const u16 *eventData)
{
    const u16 *r4 = sub_8113E88(5, eventData);
...
{
    return BufferQuestLogData_GiveTakeHeldItem(6, a0, eventData);
}

static const u16 *BufferQuestLogText_GaveHeldItemFromBagMenu(const u16 *eventData)
{
    const u16 *r4 = sub_8113E88(6, eventData);
    QuestLog_GetSpeciesName(r4[1], gStringVar1, 0);
    StringCopy(gStringVar2, ItemId_GetName(r4[0]));
...
{
    return BufferQuestLogData_GiveTakeHeldItem(7, a0, eventData);
}

static const u16 *BufferQuestLogText_GaveHeldItemFromPC(const u16 *eventData)
{
    const u16 *r4 = sub_8113E88(7, eventData);
...
{
    return BufferQuestLogData_GiveTakeHeldItem(8, a0, eventData);
}

static const u16 *BufferQuestLogText_TookHeldItem(const u16 *eventData)
{
    const u16 *r4 = sub_8113E88(8, eventData);
...
{
    return BufferQuestLogData_SwappedHeldItem_(9, a0, eventData);
}

static const u16 *BufferQuestLogText_SwappedHeldItem(const u16 *eventData)
{
    const u16 *r4 = sub_8113E88(9, eventData);
...
{
    return BufferQuestLogData_SwappedHeldItem_(10, a0, eventData);
}

static const u16 *BufferQuestLogText_SwappedHeldItemFromPC(const u16 *eventData)
{
    const u16 *r4 = sub_8113E88(10, eventData);
...
{
    u16 *r4 = a0;
    if (gUnknown_203B044.id == 11 && gUnknown_203B044.unk_1 != 0)
        return r4;
...
static u16 *BufferQuestLogData_LinkBattledSingle(u16 *a0, const u16 *eventData)
{
    ...
    *((u8 *)a0 + 4) = *((const u8 *)eventData + 0);
    memcpy((u8 *)a0 + 5, (const u8 *)eventData + 1, 7);
    a0 += 6;
    return a0;
}
...
static u16 *BufferQuestLogData_LinkBattledMulti(u16 *a0, const u16 *eventData)
{
    ...
    *((u8 *)a0 + 4) = *((const u8 *)eventData + 0);
    memcpy((u8 *)a0 + 5, (const u8 *)eventData + 1, 7);
    memcpy((u8 *)a0 + 12, (const u8 *)eventData + 8, 7);
    memcpy((u8 *)a0 + 19, (const u8 *)eventData + 15, 7);
    a0 += 13;
    return a0;
}
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(20, eventData);
    ...
    QuestLog_GetSpeciesName(eventData[1], ((void *)0), 3);
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(21, eventData);
    boxIdxs = (const u8 *)eventData + 4;
    DynamicPlaceholderTextUtil_Reset();
    DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, GetBoxNamePtr(boxIdxs[0]));
    QuestLog_GetSpeciesName(eventData[0], ((void *)0), 1);
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(22, eventData);
    boxIdxs = (const u8 *)eventData + 4;
    DynamicPlaceholderTextUtil_Reset();
    DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, GetBoxNamePtr(boxIdxs[0]));
    QuestLog_GetSpeciesName(eventData[0], ((void *)0), 1);
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(23, eventData);
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(24, eventData);
    boxIdxs = (const u8 *)eventData + 2;
    DynamicPlaceholderTextUtil_Reset();
    DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, GetBoxNamePtr(boxIdxs[0]));
    QuestLog_GetSpeciesName(eventData[0], ((void *)0), 1);
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(25, eventData);
    boxIdxs = (const u8 *)eventData + 2;
    DynamicPlaceholderTextUtil_Reset();
    DynamicPlaceholderTextUtil_SetPlaceholderPtr(0, GetBoxNamePtr(boxIdxs[0]));
    QuestLog_GetSpeciesName(eventData[0], ((void *)0), 1);
...
{
    const u8 *boxIdxs;
    eventData = sub_8113E88(26, eventData);
    boxIdxs = (const u8 *)eventData + 2;
    DynamicPlaceholderTextUtil_Reset();
...
{
    const u16 *r4 = sub_8113E88(27, eventData);
    DynamicPlaceholderTextUtil_Reset();
...
{
    const u16 *r4 = sub_8113E88(28, eventData);
...
{
    const u16 *r4 = sub_8113E88(29, eventData);
    CopyItemName(r4[0], gStringVar1);
...
static u16 *BufferQuestLogData_DefeatedGymLeader(u16 *a0, const u16 *eventData)
{
    ...
    return BufferQuestLogData_DefeatedTrainer_(30, a0, eventData);
}

static const u16 *BufferQuestLogText_DefeatedGymLeader(const u16 *eventData)
{
    const u8 *r6;
    eventData = sub_8113E88(30, eventData);
...
{
    sEventShouldNotRecordSteps = 1;
    return BufferQuestLogData_DefeatedTrainer_(32, a0, eventData);
}

static const u16 *BufferQuestLogText_DefeatedEliteFourMember(const u16 *eventData)
{
    const u8 *r5;
    eventData = sub_8113E88(32, eventData);
...
{
    sEventShouldNotRecordSteps = 1;
    return BufferQuestLogData_DefeatedTrainer_(34, a0, eventData);
}

static const u16 *BufferQuestLogText_DefeatedTrainer(const u16 *eventData)
{
    const u16 *r5 = sub_8113E88(34, eventData);
...
static u16 *BufferQuestLogData_DepartedLocation(u16 *a0, const u16 *eventData)
{
    ...
    *((u8 *)r2 + 0) = *((const u8 *)eventData + 0);
    if ((*((u8 *)r2 + 1) = *((const u8 *)eventData + 1)) == 36)
        sEventShouldNotRecordSteps = 1;
    return r2 + 1;
}
...
{
    u8 r4, locationId;
    const u16 *r5 = sub_8113E88(35, eventData);
    ...
    {
        for (r4 = 0; r4 < (sizeof(sGymCityMapSecs) / sizeof((sGymCityMapSecs)[0])); r4++)
        {
            if (r5_2[0] != sGymCityMapSecs[r4])
                continue;
            if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x20) + r4) == 1)
...
static bool8 ShouldRegisterEvent_HandleGameCorner(u16 eventId, const u16 *eventData)
{
    ...
    if (*((u8 *)eventData + 1) == 32 && !sPlayedTheSlots)
        return 0;
...
{
    const u16 *r4 = sub_8113E88(36, eventData);
...
{
    const u16 *r4 = sub_8113E88(37, eventData);
...
{
    const u16 *r5 = sub_8113E88(38, eventData);
...
{
    const u16 *r4 = sub_8113E88(40, eventData);
    const u8 *r5 = (const u8 *)r4 + 2;
...
static const u16 sQuestLogWorldMapFlags[] =
    {
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x91),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x92),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x93),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x94),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x95),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x96),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x97),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x98),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x99),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x9A),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x9B),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x9C),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x9D),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x9E),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0x9F),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0xA0),
        ((((0x4FF + 1) + 768 - 1) + 1) + 0xA1)
    };
...
void QuestLog_RecordEnteredMap(u16 worldMapFlag)
{
    ...
    for (i = 0; i < (int)(sizeof(sQuestLogWorldMapFlags) / sizeof((sQuestLogWorldMapFlags)[0])); i++)
    {
...
{
    const u16 *r4 = sub_8113E88(42, eventData);
