# 0 "src/mystery_gift_client.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mystery_gift_client.c"
...
# 5 "include/mystery_gift_client.h" 2
...
# 10 "src/mystery_gift_client.c" 2
# 1 "include/mystery_gift_server.h" 1
# 9 "include/mystery_gift_server.h"
enum {
    SVR_RET_INIT,
    SVR_RET_ACTIVE,
    SVR_RET_UNUSED,
...
# 11 "src/mystery_gift_client.c" 2
...
static __attribute__((section("ewram_data"))) struct MysteryGiftClient * sClient = ((void *)0);
...
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, client->sendBuffer, 0x04000000 | 0x01000000 | ((0x400)/(32/8) & 0x1FFFFF)); };
...
static u32 Client_Run(struct MysteryGiftClient * client)
{
    ...
    case CLI_SAVE_NEWS:
        if (!IsWonderNewsSameAsSaved(client->recvBuffer))
        {
            ...
            MysteryGiftClient_InitSendWord(client, MG_LINKID_RESPONSE, 0);
        }
        else
        {


            MysteryGiftClient_InitSendWord(client, MG_LINKID_RESPONSE, 1);
        }
        break;
