...
{
    u16 *sizeRecord = GetVarPointer(0x403D);

    GetMonSizeRecordInfo(214, sizeRecord);
}
...
void CompareHeracrossSize(void)
{
    ...
    gSpecialVar_Result = CompareMonSize(214, sizeRecord);
}
...
{
    u16 *sizeRecord = GetVarPointer(0x4040);

    GetMonSizeRecordInfo(129, sizeRecord);
}
...
void CompareMagikarpSize(void)
{
    ...
    gSpecialVar_Result = CompareMonSize(129, sizeRecord);
}
...
void GiveGiftRibbonToParty(u8 index, u8 ribbonId)
{
    ...
    if (index < 11 && ribbonId < 65)
    {
        ...
        for (i = 0; i < 6; i++)
        {
            ...
            if (GetMonData(mon, 11) != 0 && !GetMonData(mon, 6))
            {
