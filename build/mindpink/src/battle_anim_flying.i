...
static const union AffineAnimCmd sAffineAnim_FlyBallUp[] =
{
    ...
    {.frame = {.xScale = 0x0, .yScale = -0x20, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = -0x10, .yScale = 0x20, .rotation = 0, .duration = 10}},
    {.type = 0x7FFF},
};
...
static const union AffineAnimCmd sAffineAnim_BounceBallShrink[] =
{
    ...
    {.frame = {.xScale = 0x28, .yScale = 0x0, .rotation = 0, .duration = 6}},
    {.frame = {.xScale = 0x0, .yScale = -0x20, .rotation = 0, .duration = 5}},
    {.frame = {.xScale = -0x14, .yScale = 0x0, .rotation = 0, .duration = 7}},
    {.frame = {.xScale = -0x14, .yScale = -0x14, .rotation = 0, .duration = 5}},
    {.type = 0x7FFF},
};
...
static const union AffineAnimCmd sAnim_Unused[] =
{
    ...
    {.frame = {.xScale = 0x0, .yScale = -0x20, .rotation = 0, .duration = 11}},
    {.type = 0x7FFF},
};
...
static void AnimTask_AnimateGustTornadoPalette_Step(u8 taskId)
{
    ...
    if (gTasks[taskId].data[10]++ == gTasks[taskId].data[1])
    {
        ...
        temp = gPlttBufferFaded[(0x100 + ((data2) * 16)) + 8];
        i = 7;
        base = ((data2) * 16);
        do
        {
...
static void AnimUnusedFlashingLight_Step(struct Sprite *sprite)
{
    ...
    case 0:
        if (++sprite->data[1] > 8)
        {
            sprite->data[1] = 0;
            sprite->invisible ^= 1;
            if (++sprite->data[2] > 5 && sprite->invisible != 0)
                ++sprite->data[0];
        }
        break;
    case 1:
...
static void AnimSkyAttackBird_Step(struct Sprite *sprite)
{
    ...
    if (sprite->x > 240 + 45 || sprite->x < -45
