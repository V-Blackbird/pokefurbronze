...
# 6 "include/battle_controllers.h" 2
...
__attribute__((section("ewram_data"))) struct BagStruct gBagMenuState = {};
static __attribute__((section("ewram_data"))) struct BagMenuAlloc * sBagMenuDisplay = ((void *)0);
static __attribute__((section("ewram_data"))) void *sBagBgTilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) struct ListMenuItem * sListMenuItems = ((void *)0);
static __attribute__((section("ewram_data"))) u8 (*sListMenuItemStrings)[19] = ((void *)0);
static __attribute__((section("ewram_data"))) u8 sContextMenuItemsBuffer[4] = {};
static __attribute__((section("ewram_data"))) const u8 *sContextMenuItemsPtr = ((void *)0);
static __attribute__((section("ewram_data"))) u8 sContextMenuNumItems = 0;
static __attribute__((section("ewram_data"))) struct BagSlots * sBackupPlayerBag = ((void *)0);
...
static const u16 sItemListTilemap[18 * 12] = INCBIN_U16("graphics/item_menu/list.bin");

static const struct MenuAction sItemMenuContextActions[] = {
    [0] = {gOtherText_Use, {.void_u8 = Task_ItemMenuAction_Use}},
    [1] = {gOtherText_Toss, {.void_u8 = Task_ItemMenuAction_Toss}},
    [2] = {gOtherText_Register, {.void_u8 = Task_ItemMenuAction_ToggleSelect}},
    [3] = {gOtherText_Give, {.void_u8 = Task_ItemMenuAction_Give}},
    [4] = {gFameCheckerText_Cancel, {.void_u8 = Task_ItemMenuAction_Cancel}},
    [5] = {gOtherText_Use, {.void_u8 = Task_ItemMenuAction_BattleUse}},
    [6] = {gOtherText_Check, {.void_u8 = Task_ItemMenuAction_Use}},
    [7] = {gOtherText_Open, {.void_u8 = Task_ItemMenuAction_Use}},
    [8] = {gOtherText_Open, {.void_u8 = Task_ItemMenuAction_BattleUse}},
    [9] = {gOtherText_Walk, {.void_u8 = Task_ItemMenuAction_Use}},
    [10] = {gOtherText_Deselect, {.void_u8 = Task_ItemMenuAction_ToggleSelect}},
    [11] = {gString_Dummy, {.void_u8 = ((void *)0)}}
};
...
static const TaskFunc sItemContextTaskFuncs[] = {
    ...
    [1] = Task_ItemContext_FieldGive,
    [2] = Task_ItemContext_Sell,
    [3] = Task_ItemContext_Deposit,
    [4] = Task_ItemContext_PcBoxGive,
...
static void NullBagMenuBufferPtrs(void)
{
    sBagMenuDisplay = ((void *)0);
    sBagBgTilemapBuffer = ((void *)0);
    sListMenuItems = ((void *)0);
    sListMenuItemStrings = ((void *)0);
}
...
static bool8 DoLoadBagGraphics(void)
{
    ...
    case 1:
        ...
        break;
    case 2:
        LoadCompressedPalette(gBagBgPalette, (0x000 + ((0) * 16)), 3 * ((16) * sizeof(u16)));
        if (!BagIsTutorial() && gSaveBlock2Ptr->playerGender != 0)
            LoadCompressedPalette(gBagBgPalette_FemaleOverride, (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
        sBagMenuDisplay->data[0]++;
        break;
    case 3:
        if (BagIsTutorial() == 1 || gSaveBlock2Ptr->playerGender == 0)
...
static bool8 TryAllocListMenuBuffers(void)
{
    ...
    sListMenuItems = Alloc((42 + 1) * sizeof(struct ListMenuItem));
    if (sListMenuItems == ((void *)0))
        return 0;
    sListMenuItemStrings = Alloc((42 + 1) * sizeof(*sListMenuItemStrings));
    if (sListMenuItemStrings == ((void *)0))
        return 0;
    return 1;
}
...
static void BagListMenuMoveCursorFunc(s32 itemIndex, bool8 onInit, struct ListMenu *list)
{
    ...
    if (sBagMenuDisplay->itemOriginalLocation == 0xFF)
    {
        ...
        if (sBagMenuDisplay->nItems[gBagMenuState.pocket] != itemIndex)
            ...
            CreateItemMenuIcon(376, sBagMenuDisplay->itemMenuIcon);
...
static void BagListMenuItemPrintFunc(u8 windowId, u32 itemId, u8 y)
{
    ...
    if (itemId != -2 && sBagMenuDisplay->nItems[gBagMenuState.pocket] != itemId)
    {
        ...
        if (gBagMenuState.pocket != 2 - 1 && ItemId_GetImportance(bagItemId) == 0)
        {
        ...
        else if (gSaveBlock1Ptr->registeredItem != 0 && gSaveBlock1Ptr->registeredItem == bagItemId)
        {
...
static void bag_menu_print_cursor(u8 y, u8 colorIdx)
{
    if (colorIdx == 0xFF)
    {
        FillWindowPixelRect(0, ((0) | ((0) << 4)), 1, y, GetMenuCursorDimensionByFont(FONT_NORMAL, 0), GetMenuCursorDimensionByFont(FONT_NORMAL, 1));
    }
    else
    {
...
static void DestroyBagMenuResources(void)
{
    ({ if (sBagMenuDisplay) Free(sBagMenuDisplay); });
    ({ if (sBagBgTilemapBuffer) Free(sBagBgTilemapBuffer); });
    ({ if (sListMenuItems) Free(sListMenuItems); });
    ({ if (sListMenuItemStrings) Free(sListMenuItemStrings); });
...
void Pocket_CalculateNItemsAndMaxShowed(u8 pocketId)
{
    ...
    {
        if (pocket->itemSlots[i].itemId == 0)
            break;
...
static void Task_BagMenu_HandleInput(u8 taskId)
{
    ...
    if (gPaletteFade.active)
        return;
    if (FuncIsActiveTask(Task_AnimateWin0v) == 1)
        return;
    if (IsActiveOverworldLinkBusy() == 1)
        return;
    ...
    case 2:
        ...
        return;
    default:
        if (({(gMain.newKeys) & (0x0004);}) && gBagMenuState.location == 0)
        {
...
static u8 ProcessPocketSwitchInput(u8 taskId, u8 pocketId)
{
    ...
    if (({(gMain.newKeys) & (0x0020);}) || lrState == 1)
    {
        if (pocketId == 1 - 1)
            return 0;
        PlaySE(246);
    ...
    if (({(gMain.newKeys) & (0x0010);}) || lrState == 2)
    {
        if (pocketId >= 3 - 1)
            return 0;
        PlaySE(246);
...
static void UpdateQuantityToTossOrDeposit(s16 value, u8 ndigits)
{
    ...
    FillWindowPixelBuffer(r6, ((1) | ((1) << 4)));
...
static void DrawItemListRow(u8 row)
{
    CopyToBgTilemapBufferRect(1, &sItemListTilemap[(12 - row) * 18], 11, 1 + 12 - row, 18, 1);
    ScheduleBgCopyTilemapToVram(1);
}
...
static void OpenContextMenu(u8 taskId)
{
    ...
    case 5:
    case 7:
        if (gSpecialVar_ItemId == 366)
        {
            sContextMenuItemsBuffer[0] = 8;
            sContextMenuItemsBuffer[1] = 4;
    ...
    default:
        ...
        {
            if (gSpecialVar_ItemId == 365 || gSpecialVar_ItemId == 366)
            {
        ...
        else
        {
            ...
            case 1:
                ...
                sContextMenuItemsBuffer[2] = 4;
                if (gSaveBlock1Ptr->registeredItem == gSpecialVar_ItemId)
                    sContextMenuItemsBuffer[1] = 10;
                else
                    sContextMenuItemsBuffer[1] = 2;
                if (gSpecialVar_ItemId == 365 || gSpecialVar_ItemId == 366)
                    sContextMenuItemsBuffer[0] = 7;
                else if (gSpecialVar_ItemId == 361 && TestPlayerAvatarFlags((1 << PLAYER_AVATAR_STATE_ACRO_BIKE) | (1 << PLAYER_AVATAR_STATE_MACH_BIKE)))
                    sContextMenuItemsBuffer[0] = 9;
                else
                    sContextMenuItemsBuffer[0] = 0;
                break;
            case 2:
                sContextMenuItemsPtr = sContextMenuItems_Field[gBagMenuState.pocket];
                sContextMenuNumItems = 3;
...
static void Task_FieldItemContextMenuHandleInput(u8 taskId)
{
    ...
    if (IsActiveOverworldLinkBusy() != 1)
    {
        ...
        case -1:
            PlaySE(5);
            sItemMenuContextActions[4].func.void_u8(taskId);
            break;
        case -2:
            break;
        default:
...
static void Task_ItemMenuAction_Use(u8 taskId)
{
    if (ItemId_GetFieldFunc(gSpecialVar_ItemId) != ((void *)0))
    {
        HideBagWindow(10);
        HideBagWindow(6);
        PutWindowTilemap(0);
...
static void Task_ItemContext_FieldGive(u8 taskId)
{
    ...
    else if (gBagMenuState.pocket != 2 - 1 && ItemId_GetImportance(itemId) == 0)
    {
        Bag_BeginCloseWin0Animation();
        gTasks[taskId].func = ItemMenu_StartFadeToExitCallback;
    }
...
static void GoToTMCase_Give(void)
{
    InitTMCase(TMCASE_GIVE_PARTY, ReturnToBagMenuFromSubmenu_Give, 0);
}

static void GoToBerryPouch_Give(void)
{
    InitBerryPouch(BERRYPOUCH_FROMPARTYGIVE, ReturnToBagMenuFromSubmenu_Give, 0);
}
...
static void GoToTMCase_PCBox(void)
{
    InitTMCase(TMCASE_GIVE_PC, ReturnToBagMenuFromSubmenu_PCBox, 0);
}

static void GoToBerryPouch_PCBox(void)
{
    InitBerryPouch(BERRYPOUCH_FROMPOKEMONSTORAGEPC, ReturnToBagMenuFromSubmenu_PCBox, 0);
}

static void ReturnToBagMenuFromSubmenu_PCBox(void)
{
    GoToBagMenu(4, 3, CB2_ReturnToPokeStorage);
}

static void Task_ItemContext_Sell(u8 taskId)
{
    s16 *data = gTasks[taskId].data;
    if (gSpecialVar_ItemId == 365)
    {
        ItemMenu_SetExitCallback(GoToTMCase_Sell);
        ItemMenu_StartFadeToExitCallback(taskId);
    }
    else if (gSpecialVar_ItemId == 366)
    {
...
static void GoToTMCase_Sell(void)
{
    InitTMCase(TMCASE_SELL, ReturnToBagMenuFromSubmenu_Sell, 0);
}

static void GoToBerryPouch_Sell(void)
{
    InitBerryPouch(BERRYPOUCH_FROMMARTSELL, ReturnToBagMenuFromSubmenu_Sell, 0);
}
...
static void Task_FinalizeSaleToShop(u8 taskId)
{
    ...
    Pocket_CalculateNItemsAndMaxShowed(gBagMenuState.pocket);
    PocketCalculateInitialCursorPosAndItemsAbove(gBagMenuState.pocket);
    sBagMenuDisplay->inhibitItemDescriptionPrint = 1;
    Bag_BuildListMenuTemplate(gBagMenuState.pocket);
    data[0] = ListMenuInit(&gMultiuseListMenuTemplate, gBagMenuState.cursorPos[gBagMenuState.pocket], gBagMenuState.itemsAbove[gBagMenuState.pocket]);
    bag_menu_print_cursor_(data[0], 2);
...
{
    s16 *data = gTasks[taskId].data;
    if (AddPCItem(gSpecialVar_ItemId, data[8]) == 1)
    {
...
bool8 UseRegisteredKeyItemOnField(void)
{
    ...
    DismissMapNamePopup();
    ChangeBgY(0, 0, 0);
    if (gSaveBlock1Ptr->registeredItem != 0)
    {
...
{
    if (
        gBagMenuState.location == 6
     || gBagMenuState.location == 8
     || gBagMenuState.location == 7
     || gBagMenuState.location == 9
     || gBagMenuState.location == 10
    )
        return 1;
    return 0;
}
...
static void BackUpPlayerBag(void)
{
    ...
    memcpy(sBackupPlayerBag->bagPocket_Items, gSaveBlock1Ptr->bagPocket_Items, 42 * sizeof(struct ItemSlot));
    memcpy(sBackupPlayerBag->bagPocket_KeyItems, gSaveBlock1Ptr->bagPocket_KeyItems, 30 * sizeof(struct ItemSlot));
    memcpy(sBackupPlayerBag->bagPocket_PokeBalls, gSaveBlock1Ptr->bagPocket_PokeBalls, 13 * sizeof(struct ItemSlot));
    ...
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_Items, 42);
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_KeyItems, 30);
    ClearItemSlots(gSaveBlock1Ptr->bagPocket_PokeBalls, 13);
    gSaveBlock1Ptr->registeredItem = 0;
...
{
    u32 i;
    memcpy(gSaveBlock1Ptr->bagPocket_Items, sBackupPlayerBag->bagPocket_Items, 42 * sizeof(struct ItemSlot));
    memcpy(gSaveBlock1Ptr->bagPocket_KeyItems, sBackupPlayerBag->bagPocket_KeyItems, 30 * sizeof(struct ItemSlot));
    memcpy(gSaveBlock1Ptr->bagPocket_PokeBalls, sBackupPlayerBag->bagPocket_PokeBalls, 13 * sizeof(struct ItemSlot));
...
static void Task_Bag_OldManTutorial(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        ...
        case 408:
            ...
            PutWindowTilemap(1);
            CopyWindowToVram(0, COPYWIN_MAP);
            DestroyListMenuTask(data[0], ((void *)0), ((void *)0));
            RestorePlayerBag();
            Bag_BeginCloseWin0Animation();
...
{
    s16 *data = gTasks[taskId].data;
    if (!gPaletteFade.active && Task_BButtonInterruptTeachyTv(taskId) != 1)
    {
        switch (data[8])
        {
        case 102:
        ...
        case 612:
            gMain.newKeys = 0;
            gMain.newAndRepeatedKeys = 0x0080;
...
static void Task_Bag_TeachyTvCatching(u8 taskId)
{
    ...
    if (!gPaletteFade.active)
    {
        if (Task_BButtonInterruptTeachyTv(taskId) == 1)
        {
        ...
        case 612:
            gMain.newKeys = 0;
            gMain.newAndRepeatedKeys = 0x0040;
            ListMenu_ProcessInput(data[0]);
            break;
        case 714:
            PlaySE(5);
