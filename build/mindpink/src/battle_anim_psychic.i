...
static const union AffineAnimCmd sAffineAnim_PsychUpSpiral[] =
{
    ...
    {.frame = {.xScale = -0x2, .yScale = -0x2, .rotation = -10, .duration = 120}},
    {.type = 0x7FFF},
};
...
static const union AffineAnimCmd sAffineAnim_SkillSwapOrb_1[] =
{
    ...
    {.frame = {.xScale = -0x8, .yScale = -0x8, .rotation = 0, .duration = 6}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = -0x8, .yScale = -0x8, .rotation = 0, .duration = 2}},
...
static const union AffineAnimCmd sAffineAnim_SkillSwapOrb_2[] =
{
    ...
    {.frame = {.xScale = -0x8, .yScale = -0x8, .rotation = 0, .duration = 4}},
    {.frame = {.xScale = 0x8, .yScale = 0x8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = -0x8, .yScale = -0x8, .rotation = 0, .duration = 4}},
    {.jump = {.type = 0x7FFE, .target = 1}},
};
...
{
    {.frame = {.xScale = -0x14, .yScale = 0x18, .rotation = 0, .duration = 15}},
    {.type = 0x7FFF},
};
...
static void AnimDefensiveWall(struct Sprite *sprite)
{
    ...
    if (IsContest())
        sprite->y += 9;
    sprite->data[0] = (0x100 + ((IndexOfSpritePaletteTag(gBattleAnimArgs[2])) * 16));
...
static void AnimPsychoBoost(struct Sprite *sprite)
{
    ...
    case 1:
        if (sprite->affineAnimEnded)
        {
            PlaySE12WithPanning(196, BattleAnimAdjustPanning(-64));
