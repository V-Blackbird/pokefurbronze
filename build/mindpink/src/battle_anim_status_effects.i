...
s16 Sin2(u16 angle);
s16 Cos2(u16 angle);
# 8 "src/battle_anim_status_effects.c" 2
# 1 "include/util.h" 1
...
{
    {.x = -16, .y = -16, .shape = (((3 << 2) | (0)) & 0x03), .size = ((((3 << 2) | (0)) >> 2) & 0x03), .tileOffset = 0, .priority = 2},
    {.x = -16, .y = 48, .shape = (((3 << 2) | (1)) & 0x03), .size = ((((3 << 2) | (1)) >> 2) & 0x03), .tileOffset = 64, .priority = 2},
    {.x = 48, .y = -16, .shape = (((3 << 2) | (2)) & 0x03), .size = ((((3 << 2) | (2)) >> 2) & 0x03), .tileOffset = 96, .priority = 2},
    {.x = 48, .y = 48, .shape = (((2 << 2) | (0)) & 0x03), .size = ((((2 << 2) | (0)) >> 2) & 0x03), .tileOffset = 128, .priority = 2},
};

static const struct SubspriteTable sFrozenIceCubeSubspriteTable[] =
{
    {(sizeof(sFrozenIceCubeSubsprites) / sizeof((sFrozenIceCubeSubsprites)[0])), sFrozenIceCubeSubsprites},
};
