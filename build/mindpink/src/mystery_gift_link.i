# 0 "src/mystery_gift_link.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mystery_gift_link.c"
...
# 5 "src/mystery_gift_link.c" 2
# 1 "include/mystery_gift_server.h" 1
# 6 "src/mystery_gift_link.c" 2
...
void MysteryGiftLink_Init(struct MysteryGiftLink * link, u32 sendPlayerId, u32 recvPlayerId)
{
    ...
    link->recvSize = 0;
    link->recvCounter = 0;
    link->sendBuffer = ((void *)0);
    link->recvBuffer = ((void *)0);
