...
__attribute__((section("ewram_data"))) u16 gSpecialVar_TextColor = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_PrevTextColor = 0;
__attribute__((section("ewram_data"))) u16 gSpecialVar_0x8014 = 0;
__attribute__((section("ewram_data"))) u8 sSpecialFlags[(((0x4000 + 0x7F) - 0x4000 + 1) / 8)] = {};
...
void ClearTempFieldEventData(void)
{
    ...
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x5));
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x7));
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x42));
}
...
static void DisableNationalPokedex_RSE(void)
{
    ...
    *ptr = 0;
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x38));
}
...
void DisableNationalPokedex(void)
{
    ...
    *nationalDexVar = 0;
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x40));
}
...
void DisableMysteryGift(void)
{
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x39));
}

void EnableMysteryGift(void)
{
    FlagSet(((((0x4FF + 1) + 768 - 1) + 1) + 0x39));
}

bool32 IsMysteryGiftEnabled(void)
{
    return FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x39));
}
...
{
    VarSet(0x4032, 0);
    FlagClear(((((0x4FF + 1) + 768 - 1) + 1) + 0x37));
}

void EnableResetRTC(void)
{
    VarSet(0x4032, 0x0920);
    FlagSet(((((0x4FF + 1) + 768 - 1) + 1) + 0x37));
}

bool32 CanResetRTC(void)
{
    if (!FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x37)))
        return 0;
...
u16 *GetVarPointer(u16 idx)
{
    ...
    if (idx < 0x8000)
    {
        ...
        case 1:
            ...
            if (ptr != ((void *)0))
                gSaveBlock1Ptr->vars[idx - 0x4000] = *ptr;
            break;
        case 2:
            if (IsFlagOrVarStoredInQuestLog(idx - 0x4000, 1) == 1)
            {
                gLastQuestLogStoredFlagOrVarIdx = idx - 0x4000;
                QuestLogSetFlagOrVar(0, idx, gSaveBlock1Ptr->vars[idx - 0x4000]);
            }
            break;
        }
        return &gSaveBlock1Ptr->vars[idx - 0x4000];
    }
    return gSpecialVars[idx - 0x8000];
}
...
static bool8 IsFlagOrVarStoredInQuestLog(u16 idx, bool8 isVar)
{
    if (!isVar)
    {
        if (idx < 0x230)
            return 0;
        if (idx >= (((0x4FF + 1) + 768 - 1) + 1) && idx < (((((0x4FF + 1) + 768 - 1) + 1) + 0x1F) + 1))
            return 0;
    }
    else
    {
        if (idx < 0x4030 - 0x4000)
            return 0;
        if (idx >= 0x4050 - 0x4000 && idx < 0x40B4 - 0x4000)
            return 0;
    }
    return 1;
}
...
u8 *GetFlagAddr(u16 idx)
{
    ...
    if (idx < 0x4000)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            if (IsFlagOrVarStoredInQuestLog(idx, 0) == 1)
            {
    ...
    return &sSpecialFlags[(idx - 0x4000) / 8];
}
