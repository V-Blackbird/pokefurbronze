...
static __attribute__((section("ewram_data"))) u16 gUnknown_203ADFC = 0;
static __attribute__((section("ewram_data"))) u8 sQuestLogHeaderWindowIds[3] = {0};
__attribute__((section("ewram_data"))) u16 *gUnknown_203AE04 = ((void *)0);
__attribute__((section("ewram_data"))) u16 *sEventRecordingPointer = ((void *)0);
static __attribute__((section("ewram_data"))) u16 *gUnknown_203AE0C[32] = {((void *)0)};
...
static __attribute__((section("ewram_data"))) struct UnkStruct_203AE94 sQuestLogCurrentScene = {0};
static __attribute__((section("ewram_data"))) struct QuestLogEntry sQuestLogSceneRecordBuffer[32] = {0};
__attribute__((section("ewram_data"))) u16 sQuestLogCursor = 0;
static __attribute__((section("ewram_data"))) u8 sMovementScripts[64][2] = {{0}};
static __attribute__((section("ewram_data"))) u16 sNextStepDelay = 0;
...
void SetQuestLogRecordAndPlaybackPointers(void *oldPointer)
{
    ...
    if (gQuestLogState != 0)
    {
        ...
        {
            int r3;
            for (r3 = 0; r3 < (int)(sizeof(gUnknown_203AE0C) / sizeof((gUnknown_203AE0C)[0])); r3++)
...
static void QLogCB_Playback(void)
{
    ...
    if (sQuestLogCurrentScene.sceneEndMode == 0)
    {
        if (gQuestLogPlaybackState != 0
         ...
         || (sQuestLogCurrentScene.cursor < (sizeof(gUnknown_203AE0C) / sizeof((gUnknown_203AE0C)[0]))
          && gUnknown_203AE0C[sQuestLogCurrentScene.cursor] != ((void *)0)))
...
static void SetGameStateAtScene(u8 sceneNum)
{
    ...
    CpuSet(gSaveBlock1Ptr->flags, questLog->flags, 0x00000000 | ((((((((((0x4FF + 1) + 768 - 1) + 1) + 0xFF) + 1)) / (8)) + ((((((((0x4FF + 1) + 768 - 1) + 1) + 0xFF) + 1)) % (8)) ? 1 : 0)) * sizeof(u8))/(16/8) & 0x1FFFFF));
    CpuSet(gSaveBlock1Ptr->vars, questLog->vars, 0x00000000 | (((0x40FF - 0x4000 + 1) * sizeof(u16))/(16/8) & 0x1FFFFF));
}
...
static bool8 TryRecordQuestLogEntrySequence(struct QuestLogEntry * entry)
{
    ...
    {
        if (sEventRecordingPointer == ((void *)0))
            return 0;
...
void DrawPreviouslyOnQuestHeader(u8 sceneNum)
{
    ...
    for (i = 0; i < (sizeof(sQuestLogHeaderWindowTemplates) / sizeof((sQuestLogHeaderWindowTemplates)[0])); i++)
    {
...
void sub_81113E4(void)
{
    ...
    CpuSet(questLog->flags, gSaveBlock1Ptr->flags, 0x00000000 | ((((((((((0x4FF + 1) + 768 - 1) + 1) + 0xFF) + 1)) / (8)) + ((((((((0x4FF + 1) + 768 - 1) + 1) + 0xFF) + 1)) % (8)) ? 1 : 0)) * sizeof(u8))/(16/8) & 0x1FFFFF));
    CpuSet(questLog->vars, gSaveBlock1Ptr->vars, 0x00000000 | (((0x40FF - 0x4000 + 1) * sizeof(u16))/(16/8) & 0x1FFFFF));
    sub_8111688();
}
...
void sub_8111438(void)
{
    ...
    CreateMon(&r9->mon, 19, 1, 0x20, 0, 0, 0, 0);
    r0 = VarGet(0x4027);
...
static void ReadQuestLogScriptFromSav1(u8 sceneNum, struct QuestLogEntry * a1)
{
    ...
    for (i = 0; i < (sizeof(gUnknown_203AE0C) / sizeof((gUnknown_203AE0C)[0])); i++)
    {
        gUnknown_203AE0C[i] = ((void *)0);
    }
...
static void QuestLog_PlayCurrentEvent(void)
{
    ...
    if (sQuestLogCurrentScene.cursor < (sizeof(gUnknown_203AE0C) / sizeof((gUnknown_203AE0C)[0])))
    {
...
static void Task_WaitAtEndOfQuestLog(u8 taskId)
{
    ...
    if (({(gMain.newKeys) & (0x0001 | 0x0002);}) || task->data[0] >= 127 || sQuestLogCurrentScene.sceneEndMode == 1)
    {
        QuestLog_CloseTextWindow();
        task->data[0] = 0;
...
static bool8 sub_81121D8(u8 taskId)
{
    ...
    CopyPaletteInvertedTint(&gPlttBufferUnfaded[(0x000 + ((0) * 16)) + 1], &gPlttBufferFaded[(0x000 + ((0) * 16)) + 1], 0xDF, 0x0F - data[1]);
    CopyPaletteInvertedTint(&gPlttBufferUnfaded[(0x100 + ((0) * 16))], &gPlttBufferFaded[(0x100 + ((0) * 16))], 0x100, 0x0F - data[1]);
...
static void SortQuestLogInSav1(void)
{
    ...
    CpuSet(buffer, gSaveBlock1Ptr->questLog, 0x00000000 | ((4 * sizeof(struct QuestLog))/(16/8) & 0x1FFFFF));
    Free(buffer);
}
...
void QuestLogRecordPlayerStep(u8 movementActionId)
{
    if (!RecordHeadAtEndOfEntryOrScriptContext2Enabled())
    {
        if (movementActionId != sCurQuestLogEntry[sLastQuestLogCursor].animId || movementActionId > 0x3)
        {
            sCurQuestLogEntry[sQuestLogCursor].duration = sNextStepDelay;
            sCurQuestLogEntry[sQuestLogCursor].command = 0;
...
static void SetUpQuestLogEntry(u8 kind, struct QuestLogEntry *entry, u16 size)
{
    ...
    case 2:
        ...
        case 0:
        case 1:
            sCurQuestLogEntry[sQuestLogCursor].animId = 0x0;
            break;
        case 4:
            sCurQuestLogEntry[sQuestLogCursor].animId = 0x3;
            break;
        case 2:
            sCurQuestLogEntry[sQuestLogCursor].animId = 0x1;
            break;
        case 3:
            sCurQuestLogEntry[sQuestLogCursor].animId = 0x2;
            break;
        }
        sLastQuestLogCursor = 0;
        sQuestLogCursor++;
...
static bool8 RecordHeadAtEndOfEntryOrScriptContext2Enabled(void)
{
    if (sQuestLogCursor >= sNumEventsInLogEntry || ArePlayerFieldControlsLocked() == 1)
        return 1;
    return 0;
}
