# 0 "src/tilemap_util.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/tilemap_util.c"
...
# 5 "src/tilemap_util.c" 2
# 14 "src/tilemap_util.c"
...
static __attribute__((section("ewram_data"))) struct TilemapUtil *sTilemapUtil = ((void *)0);
static __attribute__((section("ewram_data"))) u16 sNumTilemapUtilIds = 0;
...
void TilemapUtil_Init(u8 numTilemapIds)
{
    ...
    sNumTilemapUtilIds = sTilemapUtil == ((void *)0) ? 0 : numTilemapIds;
    for (i = 0; i < sNumTilemapUtilIds; i++)
    {
        sTilemapUtil[i].savedTilemap = ((void *)0);
        sTilemapUtil[i].active = 0;
    }
}
...
void TilemapUtil_SetTilemap(u8 tilemapId, u8 bg, const void *tilemap, u16 width, u16 height)
{
    ...
    {
        sTilemapUtil[tilemapId].savedTilemap = ((void *)0);
        ...
        sTilemapUtil[tilemapId].active = 1;
    }
}
...
void TilemapUtil_Update(u8 tilemapId)
{
    if (tilemapId < sNumTilemapUtilIds)
    {
        if (sTilemapUtil[tilemapId].savedTilemap != ((void *)0))
