# 0 "src/mystery_gift_server.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mystery_gift_server.c"
...
# 6 "src/mystery_gift_server.c" 2
# 25 "src/mystery_gift_server.c"
enum {
    FUNC_INIT,
    FUNC_DONE,
    FUNC_RECV,
...
static __attribute__((section("ewram_data"))) struct MysteryGiftServer * sServer = ((void *)0);
...
{
    (size <= 0x400) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (257), "size <= ME_SEND_BUF_SIZE", 1);;;
...
static u32 Server_Run(struct MysteryGiftServer * svr)
{
    ...
    {
    case SVR_RETURN:
        (cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (354), "cmd->parameter == NULL", 1);;;
    ...
    case SVR_SEND:
        ...
        break;
    case SVR_RECV:
        (cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (364), "cmd->parameter == NULL", 1);;;
        MysteryGiftLink_InitRecv(&svr->manager, cmd->param, svr->recvBuffer);
        svr->funcId = FUNC_RECV;
        break;
    case SVR_GOTO:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (370), "cmd->flag == FALSE", 1);;;
        svr->cmdidx = 0;
        svr->script = cmd->ptr;
        break;
    case SVR_COPY_GAME_DATA:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (376), "cmd->flag == FALSE", 1);;;
        (cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (377), "cmd->parameter == NULL", 1);;;
        memcpy(svr->linkGameData, svr->recvBuffer, sizeof(*svr->linkGameData));
        break;
    case SVR_CHECK_GAME_DATA:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (382), "cmd->flag == FALSE", 1);;;
        (cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (383), "cmd->parameter == NULL", 1);;;
    ...
    case SVR_CHECK_EXISTING_CARD:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (396), "cmd->flag == FALSE", 1);;;
    ...
    case SVR_READ_RESPONSE:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (402), "cmd->flag == FALSE", 1);;;
        (cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (403), "cmd->parameter == NULL", 1);;;
        svr->param = *(u32 *)svr->recvBuffer;
        break;
    case SVR_CHECK_EXISTING_STAMPS:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (408), "cmd->flag == FALSE", 1);;;
    ...
    case SVR_GET_CARD_STAT:
        (cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (415), "cmd->parameter == NULL", 1);;;
        svr->param = MysteryGift_GetCardStatFromLinkData(svr->linkGameData, cmd->param);
        break;
    case SVR_CHECK_QUESTIONNAIRE:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (420), "cmd->flag == FALSE", 1);;;
        svr->param = MysteryGift_DoesQuestionnaireMatch(svr->linkGameData, cmd->ptr);
        break;
    case SVR_COMPARE:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (426), "cmd->flag == FALSE", 1);;;
        svr->param = MysteryGiftServer_Compare(cmd->ptr, *(void **)svr->recvBuffer);
        break;
    case SVR_LOAD_NEWS:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (432), "cmd->flag == FALSE", 1);;;
        MysteryGiftServer_InitSend(svr, MG_LINKID_NEWS, MysteryGiftServer_GetSendData(cmd->ptr, svr->news), sizeof(struct WonderNews));
        break;
    case SVR_LOAD_CARD:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (438), "cmd->flag == FALSE", 1);;;
        MysteryGiftServer_InitSend(svr, MG_LINKID_CARD, MysteryGiftServer_GetSendData(cmd->ptr, svr->card), sizeof(struct WonderCard));
        break;
    case SVR_LOAD_STAMP:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (444), "cmd->flag == FALSE", 1);;;
    ...
    case SVR_LOAD_EREADER_TRAINER:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (466), "cmd->flag == FALSE", 1);;;
    ...
    case SVR_LOAD_UNK_2:
        ...
        break;
    case SVR_COPY_CARD:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (481), "cmd->flag == FALSE", 1);;;
        memcpy(svr->card, cmd->ptr, sizeof(*svr->card));
        break;
    case SVR_COPY_NEWS:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (486), "cmd->flag == FALSE", 1);;;
        memcpy(svr->news, cmd->ptr, sizeof(*svr->news));
        break;
    case SVR_COPY_STAMP:
        (cmd->param == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (491), "cmd->flag == FALSE", 1);;;
    ...
    case SVR_COPY_SAVED_CARD:
        (cmd->param == 0 && cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (506), "cmd->flag == FALSE && cmd->parameter == NULL", 1);;;
        memcpy(svr->card, GetSavedWonderCard(), sizeof(*svr->card));
        DisableWonderCardSending(svr->card);
        break;
    case SVR_COPY_SAVED_NEWS:
        (cmd->param == 0 && cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (512), "cmd->flag == FALSE && cmd->parameter == NULL", 1);;;
        memcpy(svr->news, GetSavedWonderNews(), sizeof(*svr->news));
        break;
    case SVR_COPY_SAVED_RAM_SCRIPT:
        (cmd->param == 0 && cmd->ptr == ((void *)0)) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (517), "cmd->flag == FALSE && cmd->parameter == NULL", 1);;;
...
{
    u32 response;
    (svr->funcId < (sizeof(sFuncTable) / sizeof((sFuncTable)[0]))) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (546), "svr->mainseqno < NELEMS(func_tbl)", 1);;
    response = sFuncTable[svr->funcId](svr);
    (svr->funcId < (sizeof(sFuncTable) / sizeof((sFuncTable)[0]))) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "mevent_server.c"), (548), "svr->mainseqno < NELEMS(func_tbl)", 1);;
    return response;
}
