...
static void AnimConfuseRayBallBounce_Step1(struct Sprite *sprite)
{
    ...
    if (r0 <= 0)
        return;
    PlaySE12WithPanning(189, gAnimCustomPanning);
}
...
static void AnimTask_SpiteTargetShadow_Step1(u8 taskId)
{
    ...
    case 1:
        ...
        CpuSet(&gPlttBufferUnfaded[task->data[4]], &gPlttBufferFaded[task->data[14]], 0x04000000 | ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
...
static void AnimTask_GhostGetOut_Step1(u8 taskId)
{
    ...
    case 0:
        ...
        task->data[6] = ((((gSprites[task->data[4]].oam.paletteNum) + 16) * 16));
        gSprites[task->data[4]].oam.objMode = 1;
        gSprites[task->data[4]].oam.priority = 3;
        task->data[7] = (0x000 + ((8) * 16));
        break;
    case 1:
        ++task->data[1];
        if (task->data[1] & 1)
            return;
        BlendPalette(task->data[6], 0x10, task->data[2], ((0) | ((23) << 5) | ((25) << 10)));
        BlendPalette(task->data[7], 0x10, task->data[2], ((0) | ((23) << 5) | ((25) << 10)));
        if (task->data[2] <= 11)
        {
            ++task->data[2];
            return;
    ...
    case 2:
        ...
        LoadCompressedPalette(gBattleAnim_ScaryFacePal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 3:
        GetBattleAnimBgData(&animBgData, 2);
    ...
    case 6:
        ...
        break;
    case 7:
        BlendPalette(task->data[7], 0x10, 0xC, ((31) | ((31) << 5) | ((29) << 10)));
        if (rank == 1)
            SetGpuRegBits(0x0, 0x0200);
        else
            SetGpuRegBits(0x0, 0x0400);
...
static void AnimTask_GhostGetOut_Step3(u8 taskId)
{
    ...
    case 0:
        gScanlineEffect.state = 3;
        BlendPalette(task->data[7], 0x10, 0xC, ((0) | ((23) << 5) | ((25) << 10)));
        break;
    case 1:
        SetGpuReg(0x50, (1 << 2) | (1 << 6) | (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)));
        SetGpuReg(0x52, (((0) << 8) | (0x10)));
        task->data[2] = 16;
        task->data[3] = 0;
        break;
    case 2:
    ...
    case 3:
        InitBattleAnimBg(2);
        FillPalette(((0) | ((0) << 5) | ((0) << 10)), (0x000 + ((9) * 16)), ((16) * sizeof(u16)));
        SetAnimBgAttribute(2, BG_ANIM_CHAR_BASE_BLOCK, 0);
        task->data[1] = 12;
        break;
    case 4:
        BlendPalette(task->data[6], 0x10, task->data[1], ((0) | ((23) << 5) | ((25) << 10)));
        BlendPalette(task->data[7], 0x10, task->data[1], ((0) | ((23) << 5) | ((25) << 10)));
        if ( task->data[1] )
        {
            --task->data[1];
            return;
    ...
    case 5:
        ...
        gSprites[task->data[4]].oam.objMode = 0;
        SetAnimBgAttribute(1, BG_ANIM_PRIORITY, 1);
        SetAnimBgAttribute(2, BG_ANIM_PRIORITY, 1);
        SetGpuReg(0x50, (0 << 6));
        SetGpuReg(0x52, 0);
