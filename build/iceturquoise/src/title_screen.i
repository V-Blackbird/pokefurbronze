...
# 1 "include/clear_save_data_screen.h" 1
...
static __attribute__((section("ewram_data"))) u8 sTitleScreenTimerTaskId = 0;
...
void CB2_InitTitleScreen(void)
{
    ...
    case 0:
        ...
        { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)0x5000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((0x200 + 0x200))/(16/8))); dmaRegs[2]; }; };
        ...
        break;
    case 1:
        LoadPalette(gGraphics_TitleScreen_GameTitleLogoPals, (0x000 + ((0) * 16)), 13 * ((16) * sizeof(u16)));
        ...
        LoadPalette(gGraphics_TitleScreen_BoxArtMonPals, (0x000 + ((13) * 16)), ((16) * sizeof(u16)));
        ...
        LoadPalette(gGraphics_TitleScreen_BackgroundPals, (0x000 + ((15) * 16)), ((16) * sizeof(u16)));
        ...
        LoadPalette(gGraphics_TitleScreen_BackgroundPals, (0x000 + ((14) * 16)), ((16) * sizeof(u16)));
...
static void Task_TitleScreenMain(u8 taskId)
{
    ...
    if (({(gMain.newKeys) & (0x0001 | 0x0002 | 0x0008);})
...
static void SetTitleScreenScene_Init(s16 *data)
{
    ...
    params.dmaDest = (volatile void *)(0x4000000 + 0x54);
...
static void SetTitleScreenScene_FadeIn(s16 *data)
{
    ...
    case 1:
        ...
        if (data[2] > 10)
        {
            TintPalette_GrayScale2(&gPlttBufferUnfaded[(0x000 + ((13) * 16))], 16);
            BeginNormalPaletteFade(1 << 13, 9, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
            data[1]++;
        }
        break;
    case 2:
    ...
    case 3:
        ...
        if (data[2] > 36)
        {
            ...
            BlendPalettesGradually(1 << 13, -4, 1, 16, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[2] = 0;
            data[1]++;
        }
        break;
    case 4:
        ...
        {
            BlendPalettesGradually(1 << 13, -4, 15, 0, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[1]++;
        }
        break;
    case 5:
    ...
    case 7:
        ...
        {
            data[2] = 0;
            BlendPalettesGradually(1 << 13, -3, 0, 16, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[1]++;
        }
        break;
    case 8:
        if (!IsBlendPalettesGraduallyTaskActive(0))
        {
            u32 palettes;
            data[5] = 1;
            palettes = (0x0000FFFF & ~(1 << 13) & ~(1 << 14) & ~(1 << 15)) | (0x10000 << CreateBlankSprite());
            BlendPalettes(palettes, 16, ((30) | ((30) << 5) | ((31) << 10)));
            BeginNormalPaletteFade(palettes, 1, 16, 0, ((30) | ((30) << 5) | ((31) << 10)));
            ShowBg(0);
            CpuSet(gGraphics_TitleScreen_BoxArtMonPals, &gPlttBufferUnfaded[(0x000 + ((13) * 16))], 0x00000000 | ((((16) * sizeof(u16)))/(16/8) & 0x1FFFFF));
            BlendPalettesGradually(1 << 13, 1, 15, 0, ((30) | ((30) << 5) | ((31) << 10)), 0, 0);
            data[1]++;
        }
        break;
    case 9:
...
static void SetTitleScreenScene_Run(s16 *data)
{
    ...
    case 1:
        if (({(gMain.heldKeys) & ((0x0002 | 0x0004 | 0x0040));}) == (0x0002 | 0x0004 | 0x0040))
        {
            DeactivateSlashSprite(data[6]);
        ...
        else if (({(gMain.newKeys) & (0x0001 | 0x0008);}))
        {
...
static void SetGpuRegsForTitleScreenRun(void)
{
    ...
    SetGpuReg(0x4a, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4) | (((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 12) | (1 << 13)));
    SetGpuReg(0x50, (1 << 0) | (2 << 6));
    SetGpuReg(0x54, 13);
}
...
static void SetTitleScreenScene_Restart(s16 *data)
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (!gPaletteFade.active && !IsSlashSpriteDeactivated(data[6]))
        {
            FadeOutMapMusic(10);
            BeginNormalPaletteFade((0x0000FFFF | 0xFFFF0000), 3, 0, 0x10, ((0) | ((0) << 5) | ((0) << 10)));
...
static void SetTitleScreenScene_Cry(s16 *data)
{
    ...
    case 1:
        if (data[2] < 90)
            data[2]++;
        else if (!IsSlashSpriteDeactivated(data[6]))
        {
            BeginNormalPaletteFade(((0x0000FFFF | 0xFFFF0000) & ~(1 << 0x1C) & ~(1 << 0x1D) & ~(1 << 0x1E) & ~(1 << 0x1F)), 0, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
            SignalEndTitleScreenPaletteSomethingTask();
            FadeOutBGM(4);
            data[1]++;
        }
...
static void Task_TitleScreen_SlideWin0(u8 taskId)
{
    ...
    case 0:
        ...
        BlendPalettes(1 << 0xE, 0, ((0) | ((0) << 5) | ((0) << 10)));
        data[0]++;
        break;
    case 1:
        data[1] += 24 << 4;
    ...
    case 2:
        ...
        break;
    case 3:
        SetGpuReg(0x4a, (1 << 0) | (1 << 1) | (1 << 3) | (1 << 4) | (1 << 5));
        SetGpuReg(0x40, (((240) << 8) | (240)));
        ChangeBgX(2, -0xF000, 0);
        BlendPalettes(1 << 0xF, 0, ((0) | ((0) << 5) | ((0) << 10)));
        data[1] = 10 * 24 << 4;
        data[0]++;
        break;
    case 4:
    ...
    else
    {
        ...
        if (data[0] >= data[2])
        {
            ...
            if (data[1])
            {
                for (i = 0; i < 5; i++)
                {
                    gPlttBufferUnfaded[(0x000 + ((15) * 16)) + 1 + i] = gGraphics_TitleScreen_BackgroundPals[6];
                    gPlttBufferFaded[(0x000 + ((15) * 16)) + 1 + i] = gGraphics_TitleScreen_BackgroundPals[6];
                }
            }
            else
            {
                for (i = 0; i < 5; i++)
                {
                    gPlttBufferUnfaded[(0x000 + ((15) * 16)) + 1 + i] = gGraphics_TitleScreen_BackgroundPals[1 + i];
                    gPlttBufferFaded[(0x000 + ((15) * 16)) + 1 + i] = gGraphics_TitleScreen_BackgroundPals[1 + i];
                }
            }
            if (data[14])
            {
...
{
    u8 spriteId = CreateSprite(&sSpriteTemplate_FlameOrLeaf, 240, y, 0);
    if (spriteId != 64)
    {
        gSprites[spriteId].data[0] = 240 * 16;
        gSprites[spriteId].data[1] = xspeed;
        gSprites[spriteId].data[2] = y * 16;
...
static void SpriteCallback_Streak(struct Sprite *sprite)
{
    ...
    if (sprite->x < -16)
    {
        sprite->x = 240 + 20;
        sprite->data[7]++;
        if (sprite->data[7] >= (sizeof(sStreakYPositions) / sizeof((sStreakYPositions)[0])))
            sprite->data[7] = 0;
...
static void CreateStreakSprites(void)
{
    ...
    for (i = 0; i < 12; i++)
    {
        spriteId = CreateSprite(&sSpriteTemplate_Streak, 240 + 16 + 40 * i, sStreakYPositions[i], 0xFF);
        if (spriteId != 64)
        {
...
static u16 TitleScreen_rand(u8 taskId, u8 field)
{
    ...
    rngval = (1103515245 * (rngval) + 24691);
...
static void SetPalOnOrCreateBlankSprite(bool32 hasCreatedBlankSprite)
{
    ...
    if (hasCreatedBlankSprite)
    {
        ...
        LoadPalette(gTitleScreen_Slash_Pal, (0x100 + ((palIdx) * 16)), ((16) * sizeof(u16)));
    }
    else
        CreateBlankSprite();
}
...
{
    if (spriteId != 64)
        return gSprites[spriteId].data[0] ^ 2 ? 1 : 0;
    else
        return 0;
}
