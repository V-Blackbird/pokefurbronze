...
__attribute__((section("ewram_data"))) static u8 sCoinsWindowId = 0;
...
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, tileStart, palette);
...
void PrintCoinsString(u32 coinAmount)
{
    ...
    AddTextPrinterParameterized(windowId, FONT_SMALL, gStringVar4, 64 - width, 0xC, 0, ((void *)0));
}
...
void ShowCoinsWindow(u32 coinAmount, u8 x, u8 y)
{
    ...
    LoadStdWindowGfx(sCoinsWindowId, 0x21D, (0x000 + ((13) * 16)));
    DrawStdFrameWithCustomTileAndPalette(sCoinsWindowId, 0, 0x21D, 13);
...
void HideCoinsWindow(void)
{
    ...
    ClearStdWindowAndFrameToTransparent(sCoinsWindowId, 1);
