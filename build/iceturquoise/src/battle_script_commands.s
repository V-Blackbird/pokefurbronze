...
.L4145:
	...
	ldrb	r0, [r1]
	cmp	r0, #0xfe
	bhi	.L4144	@cond_branch
	add	r0, r0, #0x1
	strb	r0, [r1]
.L4144:
	cmp	r6, #0xfe
	bls	.L4148	@cond_branch
	mov	r0, #0x0
	mov	r1, #0x4
	bl	BtlController_EmitBallThrowAnim
	ldr	r0, .L4192+0x4
...
.L4152:
	cmp	r4, #0x3
	bhi	.L4153	@cond_branch
	bl	Random
	lsl	r0, r0, #0x10
	lsr	r0, r0, #0x10
	cmp	r0, r6
	bcc	.L4154	@cond_branch
.L4153:
	ldr	r5, .L4196
	ldrh	r0, [r5]
	cmp	r0, #0x1
