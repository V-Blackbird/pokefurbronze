...
static __attribute__((section("ewram_data"))) struct CreditsResources * sCreditsMgr = ((void *)0);
...
static const struct CreditsScrcmd sCreditsScript[] = {
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_ROUTE23, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_DIRECTOR, 300 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_ART_DIRECTOR_BATTLE_DIRECTOR, 300 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_PROGRAM_LEADER_PLANNING_LEADER_GRAPHIC_DESIGN_LEADER, 300 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_DUMMY, 60 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_VIRIDIAN_CITY, 0 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_PROGRAMMERS, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SYSTEM_PROGRAMMERS, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_GRAPHIC_DESIGNERS, 211 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_PEWTER_CITY, 0 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_GRAPHIC_DESIGNERS_2, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_MUSIC_COMPOSITION, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SOUND_EFFECTS, 210 },
    { CREDITSSCRCMD_MON, CREDITSMON_CHARIZARD },
    { CREDITSSCRCMD_MAP, CREDITS_MAP_CERULEAN_CITY, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_GAME_DESIGNERS, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_GAME_DESIGNERS_2, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_GAME_SCENARIO, 210 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_ROUTE25, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SCRIPT_DESIGNER_MAP_DESIGNER, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_PARAMETRIC_DESIGNERS, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_POKEDEX_TEXT, 210 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_VERMILION_CITY, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_POKEMON_DESIGNERS, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_POKEMON_DESIGNERS_2, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_POKEMON_DESIGNERS_3, 210 },
    { CREDITSSCRCMD_MON, CREDITSMON_VENUSAUR },
    { CREDITSSCRCMD_MAP, CREDITS_MAP_ROUTE10, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SUPPORTING_PROGRAMMERS, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_NCL_PRODUCT_TESTING, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SPECIAL_THANKS, 210 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_CELADON_CITY, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SPECIAL_THANKS_2, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SPECIAL_THANKS_3, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_BRAILLE_CODE_CHECK, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_INFORMATION_SUPERVISORS, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_DUMMY, 51 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_SAFFRON_CITY, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_COORDINATORS, 211 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_TASK_MANAGERS, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_PRODUCERS, 210 },
    { CREDITSSCRCMD_MON, CREDITSMON_BLASTOISE },
    { CREDITSSCRCMD_MAP, CREDITS_MAP_ROUTE17, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_EXECUTIVE_DIRECTOR, 331 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_EXECUTIVE_PRODUCER, 331 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_EXECUTIVE_PRODUCER_2, 331 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_FUCHSIA_CITY, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_ENGLISH_VERSION_COORDINATORS, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_TRANSLATOR_TEXT_EDITOR, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_PROGRAMMERS_2, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_ENVIRONMENT_TOOL_PROGRAMMERS, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_DUMMY, 52 },
    { CREDITSSCRCMD_MAPNEXT, CREDITS_MAP_CINNABAR_ISLAND, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_GRAPHIC_DESIGNER, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_NOA_PRODUCT_TESTING, 210 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_BRAILLE_CODE_CHECK_2, 211 },
    { CREDITSSCRCMD_MON, CREDITSMON_PIKACHU },
    { CREDITSSCRCMD_MAP, CREDITS_MAP_ROUTE21_NORTH, 16 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_BRAILLE_CODE_CHECK_3, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_BRAILLE_CODE_CHECK_4, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SPECIAL_THANKS_4, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_SPECIAL_THANKS_5, 221 },
    { CREDITSSCRCMD_PRINT, CREDITS_STRING_DUMMY, 52 },
    { CREDITSSCRCMD_THEENDGFX, CREDITSCLOSING_ALLRIGHTSRESERVED, 224 },
    { CREDITSSCRCMD_THEENDGFX, CREDITSCLOSING_THEEND, 240 },
    { CREDITSSCRCMD_WAITBUTTON, .duration = 600 }
};

static const __attribute__((aligned(4))) u8 sTextColor_Unused[3] = {0, 1, 2};
static const __attribute__((aligned(4))) u8 sTextColor_Header[3] = {0, 5, 2};
static const __attribute__((aligned(4))) u8 sTextColor_Regular[3] = {0, 1, 2};
...
static const struct CreditsTextHeader sCreditsTexts[] = {
    { gCreditsString_Director, gCreditsString_Junichi_Masuda, 0 },
    { gCreditsString_Art_Director_Battle_Director, gCreditsString_Ken_Sugimori_Shigeki_Morimoto, 0 },
    { gCreditsString_Program_Leader_Planning_Leader_Graphic_Design_Leader, gCreditsString_Tetsuya_Watanabe_Koji_Nishino_Takao_Unno, 0 },
    { gCreditsString_Programmers, gCreditsString_Hiroyuki_Nakamura_Masao_Taya_Satoshi_Nohara_Miyuki_Iwasawa_Daisuke_Goto, 0 },
    { gCreditsString_System_Programmers, gCreditsString_Tetsuya_Watanabe_Akito_Mori_Hisashi_Sogabe_Sousuke_Tamada, 1 },
    { gCreditsString_Graphic_Designers, gCreditsString_Takao_Unno_Asuka_Iwashita_Kanako_Eo_Hiroki_Fuchino, 1 },
    { gCreditsString_Graphic_Designers_2, gCreditsString_Ken_Sugimori_Hironobu_Yoshida, 1 },
    { gCreditsString_Music_Composition, gCreditsString_Go_Ichinose_Junichi_Masuda, 1 },
    { gCreditsString_Sound_Effects, gCreditsString_Go_Ichinose, 0 },
    { gCreditsString_Game_Designers, gCreditsString_Junichi_Masuda_Koji_Nishino_Tetsuji_Ohta, 0 },
    { gCreditsString_Game_Designers_2, gCreditsString_Hitomi_Sato_Shigeru_Ohmori_Tadashi_Takahashi, 0 },
    { gCreditsString_Game_Scenario, gCreditsString_Hitomi_Sato_Satoshi_Tajiri, 1 },
    { gCreditsString_Script_Designer_Map_Designer, gCreditsString_Satoshi_Nohara_Shigeru_Ohmori, 0 },
    { gCreditsString_Parametric_Designers, gCreditsString_Koji_Nishino_Tetsuji_Ohta_Shigeki_Morimoto, 0 },
    { gCreditsString_POKeDEX_Text, gCreditsString_Kenji_Matsushima, 0 },
    { gCreditsString_POKeMON_Designers, gCreditsString_Ken_Sugimori_Motofumi_Fujiwara_Shigeki_Morimoto_Hironobu_Yoshida, 1 },
    { gCreditsString_POKeMON_Designers_2, gCreditsString_Satoshi_Ohta_Asuka_Iwashita_Takao_Unno_Kanako_Eo_Aimi_Tomita, 0 },
    { gCreditsString_POKeMON_Designers_3, gCreditsString_Atsuko_Nishida_Muneo_Saito_Rena_Yoshikawa_Jun_Okutani, 1 },
    { gCreditsString_Supporting_Programmers, gCreditsString_Teruyuki_Yoshioka_Takao_Nakano_Satoshi_Mitsuhara_Daisuke_Hoshino, 0 },
    { gCreditsString_NCL_Product_Testing, gCreditsString_NCL_Super_Mario_Club, 0 },
    { gCreditsString_Special_Thanks, gCreditsString_Hiro_Nakamura_Hiroyuki_Uesugi_Teruki_Murakawa_Kazuya_Suyama, 0 },
    { gCreditsString_Special_Thanks_2, gCreditsString_Kenji_Tominaga_Kenjiro_Ito_Tomotaka_Komura_Michiko_Takizawa, 0 },
    { gCreditsString_Special_Thanks_3, gCreditsString_Makiko_Takada_Mikiko_Ohashi_Shusaku_Egami_Takanao_Kondo_Rui_Kawaguchi, 0 },
    { gCreditsString_Braille_Code_Check, gCreditsString_Japan_Braille_Library, 0 },
    { gCreditsString_Information_Supervisors, gCreditsString_Hiroki_Enomoto_Kazuyuki_Terada_Yuri_Sakurai_Yumi_Funasaka_Naoko_Yanase, 0 },
    { gCreditsString_Coordinators, gCreditsString_Azusa_Tajima_Akira_Kinashi_Kazuki_Yoshihara_Retsuji_Nomoto, 0 },
    { gCreditsString_Task_Managers, gCreditsString_Hitoshi_Yamagami_Gakuji_Nomoto, 1 },
    { gCreditsString_Producers, gCreditsString_Hiroyuki_Jinnai_Takehiro_Izushi_Hiroaki_Tsuru, 0 },
    { gCreditsString_Executive_Director, gCreditsString_Satoshi_Tajiri, 0 },
    { gCreditsString_Executive_Producer, gCreditsString_Satoru_Iwata, 0 },
    { gCreditsString_Executive_Producer_2, gCreditsString_Tsunekaz_Ishihara, 0 },
    { gCreditsString_English_Version_Coordinators, gCreditsString_Hiro_Nakamura_Seth_McMahill, 0 },
    { gCreditsString_Translator_Text_Editor, gCreditsString_Nob_Ogasawara_Teresa_Lillygren, 0 },
    { gCreditsString_Programmers_2, gCreditsString_Teruki_Murakawa_Souichi_Yamamoto_Yuichiro_Ito_Akira_Kinashi, 0 },
    { gCreditsString_Environment_Tool_Programmers, gCreditsString_Teruki_Murakawa_Souichi_Yamamoto_Kimiko_Nakamichi, 1 },
    { gCreditsString_NOA_Product_Testing, gCreditsString_Thomas_Hertzog_Kathy_Huguenard_Mika_Kurosawa, 1 },
    { gCreditsString_Braille_Code_Check_2, gCreditsString_National_Federation_of_the_Blind_Patricia_A_Maurer_Japan_Braille_Library_European_Blind_Union, 1 },
    { gCreditsString_Braille_Code_Check_3, gCreditsString_National_Information_Library_Service_Margaret_Campion, 1 },
    { gCreditsString_Special_Thanks_4, gCreditsString_Takehiro_Izushi_Motoyasu_Tojima_Hitoshi_Yamagami_Hiroyuki_Uesugi, 0 },
    { gCreditsString_Special_Thanks_5, gCreditsString_Nicola_Pratt_Barlow_Shellie_Dow_Anthony_Howitt_Naoko_Saeki_Kyoko_Onishi, 0 },
    { gCreditsString_Braille_Code_Check_4, gCreditsString_The_Royal_New_Zealand_Foundation_of_the_Blind_Greg_Moran, 0 },
    { gCreditsString_Graphic_Designer, gCreditsString_Akira_Kinashi, 0 },
    { gString_Dummy, gString_Dummy, 0 }
};
...
static void SwitchWin1OffWin0On(void)
{
    ...
    SetGpuReg(0x4a, 0x000E);
}

static void InitBgDarkenEffect(void)
{
    SetGpuReg(0x50, (1 << 1) | (1 << 2) | (1 << 3) | (3 << 6));
    SetGpuReg(0x52, (((4) << 8) | (16)));
    SetGpuReg(0x54, 10);
}
...
static bool32 DoOverworldMapScrollScene(u8 whichMon)
{
    ...
    case 1:
        ...
        SetGpuReg(0x44, (((36) << 8) | (160 - 36)));
        SwitchWin1OffWin0On();
        InitBgDarkenEffect();
        Menu_LoadStdPalAt((0x000 + ((15) * 16)));
        gPlttBufferUnfaded[(0x000 + ((15) * 16)) + 15] = ((0) | ((0) << 5) | ((0) << 10));
        gPlttBufferFaded[(0x000 + ((15) * 16)) + 15] = ((0) | ((0) << 5) | ((0) << 10));
        return 1;
    default:
        return 0;
    }
...
static s32 RollCredits(void)
{
    ...
    case CREDITSSCENE_INIT_WIN0:
        SwitchWin1OffWin0On();
        SetGpuReg(0x40, (((0) << 8) | (240)));
        SetGpuReg(0x44, (((160 / 2 - 1) << 8) | (160 / 2 + 1)));
    ...
    case CREDITSSCENE_OPEN_WIN0:
        win0v[0] = GetGpuReg(0x44) >> 8;
        win0v[1] = GetGpuReg(0x44) & 0xFF;
        if (win0v[0] == 0x24)
        {
            sCreditsMgr->timer = 0;
        ...
        else
        {
            win0v[0]--;
            win0v[1]++;
            SetGpuReg(0x44, (win0v[0] << 8) + win0v[1]);
        }
        return 0;
    ...
    case CREDITSSCENE_EXEC_CMD:
        ...
        case CREDITSSCRCMD_PRINT:
            BeginNormalPaletteFade(0x00008000, 0, 0, 16, ((0) | ((0) << 5) | ((0) << 10)));
    ...
    case CREDITSSCENE_PRINT_DELAY:
        ...
        sCreditsMgr->timer = sCreditsScript[sCreditsMgr->scrcmdidx].duration;
        sCreditsMgr->scrcmdidx++;
        BeginNormalPaletteFade(0x00008000, 0, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
        sCreditsMgr->mainseqno = CREDITSSCENE_EXEC_CMD;
        return sCreditsMgr->canSpeedThrough;
...
static void LoadCreditsMonPic(u8 whichMon)
{
    ...
    case CREDITSMON_CHARIZARD:
        ...
        LoadMonPicInWindow(6, 8, 0, 1, 10, 0);
    ...
    case CREDITSMON_VENUSAUR:
        ...
        FillWindowPixelBuffer(0, ((0) | ((0) << 4)));
        LoadMonPicInWindow(3, 8, 0, 1, 10, 0);
    ...
    case CREDITSMON_BLASTOISE:
        ...
        FillWindowPixelBuffer(0, ((0) | ((0) << 4)));
        LoadMonPicInWindow(9, 8, 0, 1, 10, 0);
    ...
    case CREDITSMON_PIKACHU:
        ...
        FillWindowPixelBuffer(0, ((0) | ((0) << 4)));
        LoadMonPicInWindow(25, 8, 0, 1, 10, 0);
...
static bool32 DoCreditsMonScene(void)
{
    ...
    case 0:
        ...
        InitBgsFromTemplates(1, sBgTemplates_MonSceneOrTheEnd, (sizeof(sBgTemplates_MonSceneOrTheEnd) / sizeof((sBgTemplates_MonSceneOrTheEnd)[0])));
        ...
        LoadPalette(gCreditsMonPokeball_Pals[sCreditsMgr->whichMon], (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
        LoadPalette(sCreditsMonCircle_Pal, (0x000 + ((15) * 16)), sizeof(sCreditsMonCircle_Pal));
...
static bool32 DoCopyrightOrTheEndGfxScene(void)
{
    ...
    case 0:
        ...
        LoadPalette(sCopyrightOrTheEndGfxHeaders[sCreditsMgr->whichMon].palette, (0x000 + ((0) * 16)), 16 * ((16) * sizeof(u16)));
        SetVBlankCallback(VBlankCB);
        EnableInterrupts((1 << 0));
        sCreditsMgr->subseqno++;
        break;
    ...
    case 2:
        ...
        if (sCreditsMgr->whichMon != 0)
            BeginNormalPaletteFade((0x0000FFFF | 0xFFFF0000), 0, 0, 0, ((0) | ((0) << 5) | ((0) << 10)));
        else
            BeginNormalPaletteFade((0x0000FFFF | 0xFFFF0000), 0, 16, 0, ((0) | ((0) << 5) | ((0) << 10)));
        sCreditsMgr->subseqno++;
        break;
    ...
    if (sCreditsMgr->taskId == 0xFF)
    {
        ...
        case 0:
            ...
            if (gSaveBlock2Ptr->playerGender == 0)
            {
                ...
                LoadPalette(sPlayerMale_Pal, (0x100 + ((15) * 16)), sizeof(sPlayerMale_Pal));
            }
            else
            {
                ...
                sprSheet.tag = data->characterTilesTag;
                LoadCompressedSpriteSheet(&sprSheet);
                LoadPalette(sPlayerFemale_Pal, (0x100 + ((15) * 16)), sizeof(sPlayerFemale_Pal));
            }
            break;
        case 1:
            ...
            sprSheet.tag = data->characterTilesTag;
            LoadCompressedSpriteSheet(&sprSheet);
            LoadPalette(sRival_Pal, (0x100 + ((15) * 16)), sizeof(sRival_Pal));
            break;
        }
        ...
        case 0:
            ...
            LoadCompressedSpriteSheet(&sprSheet);
            LoadPalette(sGround_Grass_Pal, (0x100 + ((14) * 16)), sizeof(sGround_Grass_Pal));
        ...
        case 2:
            ...
            sprSheet.tag = data->groundTilesTag;
            LoadCompressedSpriteSheet(&sprSheet);
            LoadPalette(sGround_Dirt_Pal, (0x100 + ((14) * 16)), sizeof(sGround_Dirt_Pal));
            sprTemplate = sGroundSpriteTemplate_Running;
            break;
        case 3:
            ...
            sprSheet.tag = data->groundTilesTag;
            LoadCompressedSpriteSheet(&sprSheet);
            LoadPalette(sGround_City_Pal, (0x100 + ((14) * 16)), sizeof(sGround_City_Pal));
            sprTemplate = sGroundSpriteTemplate_Running;
            break;
        }
