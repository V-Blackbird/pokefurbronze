...
void FreeBattleResources(void)
{
    ...
    if (gBattleTypeFlags & (1 << 16))
    {
        ...
        for (i = 0; i < 4; i++)
        {
            { Free(gPokedudeBattlerStates[i]); gPokedudeBattlerStates[i] = ((void *)0); };
        }
    }
    if (gBattleResources != ((void *)0))
    {
        ...
        { Free(gBattleAnimBgTileBuffer); gBattleAnimBgTileBuffer = ((void *)0); };
        { Free(gBattleAnimBgTilemapBuffer); gBattleAnimBgTilemapBuffer = ((void *)0); };
    }
}
