...
__attribute__((section("ewram_data"))) static s8 sAnimFramesToWait = 0;
...
__attribute__((section("ewram_data"))) static u16 sAnimMoveIndex = 0;
...
const struct CompressedSpriteSheet gBattleAnimPicTable[] =
{
    ...
    {gBattleAnimSpriteGfx_Sword, 0x0400, (10000 + 5)},
    {gBattleAnimSpriteGfx_Seed, 0x0180, (10000 + 6)},
    ...
    {gBattleAnimSpriteGfx_SmallEmber, 0x0A00, (10000 + 29)},
    ...
    {gBattleAnimSpriteGfx_Leaf, 0x0480, (10000 + 63)},
    ...
    {gBattleAnimSpriteGfx_SharpTeeth, 0x0800, (10000 + 139)},
    ...
    {gBattleAnimSpriteGfx_HandsAndFeet, 0x0800, (10000 + 143)},
    ...
    {gBattleAnimSpriteGfx_Spikes, 0x0080, (10000 + 152)},
    ...
    {gBattleAnimSpriteGfx_RoundShadow, 0x0800, (10000 + 156)},
    ...
    {gBattleAnimSpriteGfx_Eye, 0x0800, (10000 + 187)},
    ...
    {gBattleAnimSpriteGfx_Nail, 0x0400, (10000 + 199)},
    ...
    {gBattleAnimSpriteGfx_Pokeball, 0x0080, (10000 + 226)},
    ...
    {gBattleAnimSpriteGfx_GreenStar, 0x0200, (10000 + 241)},
    ...
    {gBattleAnimSpriteGfx_SafariBait, 0x0080, (10000 + 269)},
...
const struct CompressedSpritePalette gBattleAnimPaletteTable[] =
{
    ...
    {gBattleAnimSpritePal_Sword, (10000 + 5)},
    {gBattleAnimSpritePal_Seed, (10000 + 6)},
    ...
    {gBattleAnimSpritePal_HornHit, (10000 + 20)},
    ...
    {gBattleAnimSpritePal_SmallEmber, (10000 + 29)},
    ...
    {gBattleAnimSpritePal_Leaf, (10000 + 63)},
    ...
    {gBattleAnimSpritePal_HandsAndFeet, (10000 + 143)},
    ...
    {gBattleAnimSpritePal_Spikes, (10000 + 152)},
    ...
    {gBattleAnimSpritePal_RoundShadow, (10000 + 156)},
    ...
    {gBattleAnimSpritePal_Eye, (10000 + 187)},
    ...
    {gBattleAnimSpritePal_Pokeball, (10000 + 226)},
    ...
    {gBattleAnimSpritePal_GreenStar, (10000 + 241)},
    ...
    {gBattleAnimSpritePal_SafariBait, (10000 + 269)},
...
void MoveBattlerSpriteToBG(u8 battlerId, bool8 toBG_2)
{
    ...
    if (!toBG_2)
    {
        ...
        RequestDma3Fill(0, (void *)((void *)(0x6000000 + (0x800 * (8)))), 0x2000, 1);
        RequestDma3Fill(0, (void *)((void *)(0x6000000 + (0x800 * (28)))), 0x1000, 1);
        GetBattleAnimBg1Data(&animBg);
        { vu16 tmp = (vu16)(toBG_2); CpuSet((void *)&tmp, animBg.bgTiles, 0x00000000 | 0x01000000 | ((0x1000)/(16/8) & 0x1FFFFF)); };
        { vu16 tmp = (vu16)(toBG_2); CpuSet((void *)&tmp, animBg.bgTilemap, 0x00000000 | 0x01000000 | ((0x800)/(16/8) & 0x1FFFFF)); };
        ...
        LoadPalette(&gPlttBufferUnfaded[(0x100 + ((battlerId) * 16))], (0x000 + ((animBg.paletteId) * 16)), ((16) * sizeof(u16)));
        CpuSet(&gPlttBufferUnfaded[(0x100 + ((battlerId) * 16))], (void *)(0x5000000 + animBg.paletteId * ((16) * sizeof(u16))), 0x04000000 | ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
    ...
    {
        RequestDma3Fill(0, (void *)((void *)(0x6000000 + (0x800 * (12)))), 0x2000, 1);
        RequestDma3Fill(0, (void *)((void *)(0x6000000 + (0x800 * (30)))), 0x1000, 1);
        ...
        LoadPalette(&gPlttBufferUnfaded[(0x100 + ((battlerId) * 16))], (0x000 + ((9) * 16)), ((16) * sizeof(u16)));
        CpuSet(&gPlttBufferUnfaded[(0x100 + ((battlerId) * 16))], (void *)(0x5000000 + 9 * ((16) * sizeof(u16))), 0x04000000 | ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
...
static void Task_InitUpdateMonBg(u8 taskId)
{
    ...
    if (gTasks[taskId].data[5] == 0)
    {
        ...
        CpuSet(&gPlttBufferFaded[(0x100 + ((palIndex) * 16))], &gPlttBufferFaded[(0x000 + ((animBg.paletteId) * 16))], 0x04000000 | ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
    }
    else
    {
        gBattle_BG2_X = x + gTasks[taskId].data[3];
        gBattle_BG2_Y = y + gTasks[taskId].data[4];
        CpuSet(&gPlttBufferFaded[(0x100 + ((palIndex) * 16))], &gPlttBufferFaded[(0x000 + ((9) * 16))], 0x04000000 | ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
    }
}
...
static void LoadMoveBg(u16 bgId)
{
    LZDecompressVram(gBattleAnimBackgroundTable[bgId].tilemap, (void *)((void *)(0x6000000 + (0x800 * (26)))));
    LZDecompressVram(gBattleAnimBackgroundTable[bgId].image, (void *)((void *)(0x6000000 + (0x4000 * (2)))));
    LoadCompressedPalette(gBattleAnimBackgroundTable[bgId].palette, (0x000 + ((2) * 16)), ((16) * sizeof(u16)));
}
...
static void Cmd_splitbgprio(void)
{
    ...
    if (battlerPosition == 0 || battlerPosition == 3)
    {
