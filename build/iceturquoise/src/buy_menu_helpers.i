# 0 "src/buy_menu_helpers.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/buy_menu_helpers.c"
...
void BuyMenuInitWindows(bool32 isSellingTM)
{
    ...
    LoadUserWindowGfx(0, 0x1, (0x000 + ((13) * 16)));
    LoadMenuMessageWindowGfx(0, 0x13, (0x000 + ((14) * 16)));
    LoadStdWindowGfx(0, 0xA, (0x000 + ((15) * 16)));
    PutWindowTilemap(0);
    PutWindowTilemap(4);
    PutWindowTilemap(5);
    if (isSellingTM == 1)
