...
const struct SpritePalette sDefaulSpritePalette = {gDefaultWeatherSpritePalette, 0x1201};
...
# 337 "src/field_weather_effects.c"
...
# 521 "src/field_weather_effects.c"
...
# 731 "src/field_weather_effects.c"
...
# 862 "src/field_weather_effects.c"
static bool8 CreateSnowflakeSprite(void)
{
...
# 978 "src/field_weather_effects.c"
enum {
...
static void CreateAshSprites(void)
{
    ...
    if (!gWeatherPtr->ashSpritesCreated)
    {
        LoadCustomWeatherSpritePalette(&sDefaulSpritePalette);
        for (i = 0; i < 20; i++)
        {
...
# 1669 "src/field_weather_effects.c"
...
# 1873 "src/field_weather_effects.c"
...
# 2062 "src/field_weather_effects.c"
static void CreateSandstormSprites(void)
{
    u16 i;
    u8 spriteId;
...
# 2176 "src/field_weather_effects.c"
void Shade_InitVars(void)
{
    gWeatherPtr->initStep = 0;
    gWeatherPtr->gammaTargetIndex = 3;
