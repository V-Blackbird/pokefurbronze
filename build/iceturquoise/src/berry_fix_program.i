...
static void SetScene(int scene)
{
    ...
    LZ77UnCompVram(sBerryFixGraphics[scene][0], (void *)(void *)(0x6000000 + (0x4000 * (0))));
    LZ77UnCompVram(sBerryFixGraphics[scene][1], (void *)(void *)(0x6000000 + (0x800 * (31))));
    CpuSet(sBerryFixGraphics[scene][2], (void *)0x5000000, 0x00000000 | ((0x200)/(16/8) & 0x1FFFFF));
    (*(vu16 *)(0x4000000 + 0x8)) = (0) | ((0) << 2) | 0x0000 | ((31) << 8) | 0x0000;
...
void CB2_InitBerryFixProgram(void)
{
    ...
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)0x6000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x18000)/(32/8))); dmaRegs[2]; }; };
    { vu32 tmp = (vu32)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)((void *)0x5000000); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | (((0x200 + 0x200))/(32/8))); dmaRegs[2]; }; };
    ResetSpriteData();
    ResetTasks();
    ScanlineEffect_Stop();
    gHelpSystemEnabled = 0;
    taskId = CreateTask(Task_BerryFixMain, 0);
    gTasks[taskId].data[0] = STATE_BEGIN;
    ...
    case STATE_MULTIBOOT:
        if (gMultibootParam.probe_count == 0 && gMultibootParam.response_bit & 0x2 && gMultibootParam.client_bit & 0x2)
        {
            if (++data[1] > 180)
            {
                ...
                MultiBootStartMaster(&gMultibootParam, gMultibootStart + 0xc0, gMultibootSize - 0xc0, 4, 1);
                data[1] = 0;
