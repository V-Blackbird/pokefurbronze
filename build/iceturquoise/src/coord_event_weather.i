...
static struct {
    ...
    {1, WeatherCoordEvent_SunnyClouds },
    {2, WeatherCoordEvent_Sunny },
    {3, WeatherCoordEvent_Rain },
    {4, WeatherCoordEvent_Snow },
    {5, WeatherCoordEvent_RainThunderstorm},
    {6, WeatherCoordEvent_FogHorizontal },
    {7, WeatherCoordEvent_VolcanicAsh },
    {8, WeatherCoordEvent_Sandstorm },
    {9, WeatherCoordEvent_FogDiagonal },
    {10, WeatherCoordEvent_Underwater },
    {11, WeatherCoordEvent_Shade },
    {20, WeatherCoordEvent_Route119Cycle },
    {21, WeatherCoordEvent_Route123Cycle }
};

void DoCoordEventWeather(u8 weatherId)
{
    u8 i;
    for (i = 0; i < (sizeof(sWeatherCoordEventFuncs) / sizeof((sWeatherCoordEventFuncs)[0])); i++)
    {
