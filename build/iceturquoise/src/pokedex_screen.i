...
const u8 *const gMonFootprintTable[] =
{
    ...
    [472] = gMonFootprint_Glaceon,
    [473] = gMonFootprint_Eevee,
    [474] = gMonFootprint_Flareon,
    [475] = gMonFootprint_Eevee,
    [476] = gMonFootprint_Glaceon,
    [477] = gMonFootprint_Eevee,
    [478] = gMonFootprint_Leafeon,
    [470] = gMonFootprint_Leafeon,
    [471] = gMonFootprint_Glaceon,
    [479] = gMonFootprint_Bulbasaur,
};
...
# 1 "src/data/pokemon/pokedex_text_lg.h" 1
...
# 5 "src/data/pokemon/pokedex_text.h" 2
...
void DexScreen_LoadResources(void)
{
    ...
    *sPokedexScreenData = sDexScreenDataInitialState;
    ...
    sPokedexScreenData->listItems = Alloc(NATIONAL_DEX_EVERESTL * sizeof(struct ListMenuItem));
...
static u16 DexScreen_CountMonsInOrderedList(u8 orderIdx)
{
    s32 max_n = IsNationalPokedexEnabled() ? NATIONAL_DEX_EVERESTL : NATIONAL_DEX_MEW;
    u16 ndex_num;
    ...
    case 2:
        ...
        break;
    case 3:
        for (i = 0; i < NATIONAL_DEX_EVERESTL; i++)
        {
