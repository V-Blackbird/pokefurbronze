...
static void LinkPartnerBufferRunCommand(void)
{
    ...
    {
        if (gBattleBufferA[gActiveBattler][0] < (sizeof(sLinkPartnerBufferCommands) / sizeof((sLinkPartnerBufferCommands)[0])))
...
static void LinkPartnerHandleIntroTrainerBallThrow(void)
{
    ...
    LoadCompressedPalette(gTrainerBackPicPaletteTable[trainerPicId].data, (0x100 + ((paletteNum) * 16)), ((16) * sizeof(u16)));
