...
static __attribute__((section("ewram_data"))) struct AnimStatsChangeData *sAnimStatsChangeData = ((void *)0);

static const u16 sRgbWhite[] = { ((31) | ((31) << 5) | ((31) << 10)) };
const u8 gBattleAnimRegOffsBgCnt[] = { 0x8, 0xa, 0xc, 0xe };
const u8 gBattleIntroRegOffsBgCnt[] = { 0x8, 0xa, 0xc, 0xe };
# 53 "src/battle_anim_utility_funcs.c"
...
# 75 "src/battle_anim_utility_funcs.c"
...
void AnimTask_DrawFallingWhiteLinesOnAttacker(u8 taskId)
{
    ...
    LoadPalette(sRgbWhite, (0x000 + ((animBgData.paletteId) * 16)) + 1, ((1) * sizeof(u16)));
...
static void StatsChangeAnimation_Step2(u8 taskId)
{
    ...
    {
    case 0:
        LoadCompressedPalette(gBattleStatMask2_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 1:
        LoadCompressedPalette(gBattleStatMask1_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 2:
        LoadCompressedPalette(gBattleStatMask3_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 3:
        LoadCompressedPalette(gBattleStatMask4_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 4:
        LoadCompressedPalette(gBattleStatMask6_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 5:
        LoadCompressedPalette(gBattleStatMask7_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    case 6:
        LoadCompressedPalette(gBattleStatMask8_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    default:
        LoadCompressedPalette(gBattleStatMask5_Pal, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
        break;
    }
    gBattle_BG1_X = 0;
    gBattle_BG1_Y = 0;
    ...
    if (sAnimStatsChangeData->data[0] == 0)
        PlaySE12WithPanning(232, BattleAnimAdjustPanning2(-64));
    else
        PlaySE12WithPanning(238, BattleAnimAdjustPanning2(-64));
}
    ...
    case 1:
        if (++task->data[1] > 1)
        {
            ...
            for (i = 0; i < 16; ++i)
            {
                if ((task->data[15] >> i) & 1)
                {
                    u16 paletteOffset = (0x000 + ((i) * 16));
                    BlendPalette(paletteOffset, 16, task->data[2], 0xFFFF);
                }

                if ((task->data[14] >> i) & 1)
                {
                    u16 paletteOffset = (0x100 + ((i) * 16));
...
void StartMonScrollingBgMask(u8 taskId, s32 unused, u16 scrollSpeed, u8 battler1, bool8 includePartner, u8 numFadeSteps, u8 fadeStepDelay, u8 duration, const u32 *gfx, const u32 *tilemap, const u32 *palette)
{
    ...
    LoadCompressedPalette(palette, (0x000 + ((animBgData.paletteId) * 16)), ((16) * sizeof(u16)));
    gBattle_BG1_X = 0;
    gBattle_BG1_Y = 0;
...
void AnimTask_CopyPalUnfadedToBackup(u8 taskId)
{
    ...
    memcpy(&gMonSpritesGfxPtr->multiUseBuffer[gBattleAnimArgs[1] * 16], &gPlttBufferUnfaded[((paletteIndex) * 16)], ((16) * sizeof(u16)));
    DestroyAnimVisualTask(taskId);
}
...
void AnimTask_CopyPalUnfadedFromBackup(u8 taskId)
{
    ...
    if (gBattleAnimArgs[0] == 0)
        ...
        paletteIndex = gBattleAnimTarget + 16;
    memcpy(&gPlttBufferUnfaded[((paletteIndex) * 16)], &gMonSpritesGfxPtr->multiUseBuffer[gBattleAnimArgs[1] * 16], ((16) * sizeof(u16)));
    DestroyAnimVisualTask(taskId);
}
...
void AnimTask_CopyPalFadedToUnfaded(u8 taskId)
{
    ...
    if (gBattleAnimArgs[0] == 0)
        ...
        paletteIndex = gBattleAnimTarget + 16;
    memcpy(&gPlttBufferUnfaded[((paletteIndex) * 16)], &gPlttBufferFaded[((paletteIndex) * 16)], ((16) * sizeof(u16)));
    DestroyAnimVisualTask(taskId);
}
