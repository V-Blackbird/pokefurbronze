...
static __attribute__((section("ewram_data"))) u8 *sPlttBufferBak = ((void *)0);
...
bool8 FldEff_SweetScent(void)
{
    ...
    gTasks[taskId].data[8] = (u32)StartSweetScentFieldEffect >> 16; gTasks[taskId].data[9] = (u32)StartSweetScentFieldEffect;;
    return 0;
}
...
static void StartSweetScentFieldEffect(void)
{
    ...
    PlaySE(229);
    sPlttBufferBak = (u8 *)Alloc((0x200 + 0x200));
    CpuFastSet(gPlttBufferUnfaded, sPlttBufferBak, (((0x200 + 0x200))/(32/8) & 0x1FFFFF));
...
static void FailSweetScentEncounter(u8 taskId)
{
    if (!gPaletteFade.active)
    {
        CpuFastSet(sPlttBufferBak, gPlttBufferUnfaded, (((0x200 + 0x200))/(32/8) & 0x1FFFFF));
