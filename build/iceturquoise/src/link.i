...
__attribute__((aligned(8))) static struct BlockTransfer sBlockRecv[4];
...
__attribute__((aligned(8))) static u8 sLinkTestLastBlockRecvPos[4];
...
static __attribute__((section("ewram_data"))) bool8 sLinkTestDebugValuesEnabled = 0;
static __attribute__((section("ewram_data"))) bool8 sDummyFlag = 0;
...
static __attribute__((section("ewram_data"))) bool8 sLinkOpen = 0;
__attribute__((section("ewram_data"))) u16 gLinkType = 0;
static __attribute__((section("ewram_data"))) u16 sTimeOutCounter = 0;
...
{
    LoadPalette(sLinkTestFontPal, (0x000 + ((paletteNum) * 16)), ((16) * sizeof(u16)));
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(sLinkTestFontGfx); dmaRegs[1] = (vu32)((u16 *)(void *)(0x6000000 + (0x4000 * (charBaseBlock))) + (16 * baseChar)); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof sLinkTestFontGfx)/(16/8))); dmaRegs[2]; };
...
{
    LoadPalette(sLinkTestFontPal, (0x000 + ((paletteNum) * 16)), ((16) * sizeof(u16)));
    { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(sLinkTestFontGfx); dmaRegs[1] = (vu32)((u16 *)(void *)(0x6000000 + (0x4000 * (charBaseBlock)))); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((sizeof sLinkTestFontGfx)/(16/8))); dmaRegs[2]; };
    gLinkTestBGInfo.screenBaseBlock = screenBaseBlock;
    gLinkTestBGInfo.paletteNum = paletteNum;
    gLinkTestBGInfo.baseChar = 0;
    SetGpuReg(gBGControlRegOffsets[bgNum], ((screenBaseBlock) << 8) | ((charBaseBlock) << 2));
}
...
static void LinkTestProcessKeyInput(void)
{
    ...
    if (({(gMain.newKeys) & (0x0200);}))
        BeginNormalPaletteFade((0x0000FFFF | 0xFFFF0000), 0, 16, 0, ((2) | ((0) << 5) | ((0) << 10)));
...
static void LinkTest_PrintNumChar(char val, u8 x, u8 y)
{
    ...
    vAddr = (u16 *)(void *)(0x6000000 + (0x800 * (gLinkTestBGInfo.screenBaseBlock)));
...
static void CheckErrorStatus(void)
{
    ...
    if (sLinkOpen && (((gLinkStatus) & 0x0007F000) >> 12))
    {
...
void CB2_LinkError(void)
{
    ...
    SetBackdropFromColor(((0) | ((0) << 5) | ((0) << 10)));
    ResetTasks();
    ScanlineEffect_Stop();
    if (gWirelessCommType)
    {
    ...
    InitBgsFromTemplates(0, sLinkErrorBgTemplates, (sizeof(sLinkErrorBgTemplates) / sizeof((sLinkErrorBgTemplates)[0])));
...
static void ErrorMsg_MoveCloserToPartner(void)
{
    ...
    LoadPalette(sWirelessLinkDisplayPal, (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
    ...
    PutWindowTilemap(0);
    PutWindowTilemap(2);
    CopyWindowToVram(0, COPYWIN_NONE);
...
static void ErrorMsg_CheckConnections(void)
{
    ...
    PutWindowTilemap(1);
    PutWindowTilemap(2);
    CopyWindowToVram(1, COPYWIN_NONE);
    CopyWindowToVram(2, COPYWIN_FULL);
    ShowBg(0);
}
...
{
    return ((*(vu16 *)(0x4000000 + 0x128)) & 0x0004) != 0;
}

static bool8 IsSioMultiMaster(void)
{
    return ((*(vu16 *)(0x4000000 + 0x128)) & 0x0008) && !((*(vu16 *)(0x4000000 + 0x128)) & 0x0004);
}
...
bool8 HandleLinkConnection(void)
{
    ...
    if (gWirelessCommType == 0)
    {
        ...
        if ((gLinkStatus & 0x00000100) && IsSendingKeysOverCable() == 1)
            return 1;
    }
    else
    {
        ...
        if (IsSendingKeysOverCable() == 1)
        {


            if (main1Failed == 1 || IsRfuRecvQueueEmpty() || main2Failed)
                return 1;
        }
    }
    return 0;
