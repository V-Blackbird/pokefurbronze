# 0 "src/pokemon_storage_system_misc.c"
# 0 "<built-in>"
# 0 "<command-line>"
...
static bool8 MultiMove_Function_Start(void)
{
    ...
    case 0:
        HideBg(0);
        LoadMonIconPalettesAt((0x000 + ((8) * 16)));
        sMultiMove->state++;
        break;
    case 1:
...
void CreateItemIconSprites(void)
{
    ...
    if (gStorage->boxOption == OPTION_MOVE_ITEMS)
    {
        ...
        for (i = 0; i < 3; i++)
        {
            ...
            gStorage->itemIcons[i].palIndex = (0x100 + ((gStorage->itemIcons[i].palIndex) * 16));
...
static void LoadItemIconGfx(u8 id, const u32 *itemTiles, const u32 *itemPal)
{
    ...
    LoadPalette(gStorage->itemIconBuffer, gStorage->itemIcons[id].palIndex, ((16) * sizeof(u16)));
}
...
void PrintItemDescription(void)
{
    ...
    AddTextPrinterParameterized5(2, FONT_NORMAL, description, 2, 0, 0, ((void *)0), 0, 0);
}
...
# 1346 "src/pokemon_storage_system_misc.c"
