...
{
    {.frame = {.xScale = 80, .yScale = 80, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 9, .yScale = 9, .rotation = 0, .duration = 18}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 16, .yScale = 256, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 20, .yScale = 0, .rotation = 0, .duration = 12}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 0, .duration = 32}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 32, .yScale = 32, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 7, .yScale = 7, .rotation = 0, .duration = -56}},
    {.type = 0x7FFF},
};

static const union AffineAnimCmd sWaterPulseRingAffineAnimCmds[] =
{
    {.frame = {.xScale = 5, .yScale = 5, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = -10, .yScale = -10, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 10, .yScale = 10, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = -10, .yScale = -10, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = 10, .yScale = 10, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = -10, .yScale = -10, .rotation = 0, .duration = 10}},
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 20, .duration = 1}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};
...
{
    {.frame = {.xScale = 16, .yScale = 256, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 4, .yScale = 0, .rotation = 0, .duration = 40}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 11, .yScale = 11, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = -11, .yScale = -11, .rotation = 0, .duration = 8}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 0, .yScale = 0, .rotation = -8, .duration = 2}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = 8, .duration = 4}},
    {.frame = {.xScale = 0, .yScale = 0, .rotation = -8, .duration = 2}},
    {.jump = {.type = 0x7FFE, .target = 0}},
};
...
{
    {.frame = {.xScale = -8, .yScale = 4, .rotation = 0, .duration = 8}},
    {.loop = {.type = 0x7FFD, .count = 0}},
    {.frame = {.xScale = 16, .yScale = -8, .rotation = 0, .duration = 8}},
    {.frame = {.xScale = -16, .yScale = 8, .rotation = 0, .duration = 8}},
...
static const union AffineAnimCmd sThinRingExpandingAffineAnimCmds1[] =
{
    ...
    {.frame = {.xScale = 16, .yScale = 16, .rotation = 0, .duration = 30}},
...
{
    {.frame = {.xScale = 16, .yScale = 16, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 32, .yScale = 32, .rotation = 0, .duration = 15}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
{
    {.frame = {.xScale = 16, .yScale = 16, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 11, .yScale = 11, .rotation = 0, .duration = 45}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
{
    {.frame = {.xScale = 512, .yScale = 512, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = -16, .yScale = -16, .rotation = 0, .duration = 30}},
    {.end = {.type = 0x7FFF, .val = 1}},
};
...
const u16 gMusicNotePaletteTagsTable[3] =
{
    (10000 + 206),
    10000 - 1,
    10000 - 2,
...
{
    {.frame = {.xScale = 10, .yScale = -13, .rotation = 0, .duration = 10}},
    {.frame = {.xScale = -10, .yScale = 13, .rotation = 0, .duration = 10}},
    {.type = 0x7FFF},
};
...
{
    {.frame = {.xScale = 512, .yScale = 256, .rotation = 0, .duration = 0}},
    {.type = 0x7FFF},
};
...
# 1484 "src/battle_anim_effects_2.c"
...
static void AirCutterProjectile_Step1(u8 taskId)
{
    if (gTasks[taskId].data[0]-- <= 0)
    {
        ...
        gTasks[taskId].data[1]++;
        PlaySE12WithPanning(147, BattleAnimAdjustPanning(-63));
        if (gTasks[taskId].data[1] > 2)
...
{
    InitSpritePosToAnimAttacker(sprite, 0);
    sprite->data[0] = (0x100 + ((IndexOfSpritePaletteTag(sVoidLinesSpriteTemplate.paletteTag)) * 16));
...
static void AnimBulletSeed_Step1(struct Sprite *sprite)
{
    ...
    PlaySE12WithPanning(159, BattleAnimAdjustPanning(63));
    sprite->x += sprite->x2;
    sprite->y += sprite->y2;
    sprite->y2 = 0;
    sprite->x2 = 0;
...
# 1879 "src/battle_anim_effects_2.c"
    ...
    case 1:
        if (++sprite->data[1] > 3 && sprite->data[2] < sprite->data[5])
        {
            ...
            if (sprite->data[2] % 10 == 0)
                PlaySE12WithPanning(198, sprite->data[6]);
        }
...
static void AnimUproarRing(struct Sprite *sprite)
{
    ...
    if (index != 0xFF)
        BlendPalette((0x100 + ((index) * 16)) + 1, 15, gBattleAnimArgs[5], gBattleAnimArgs[4]);
...
void AnimTask_LoadMusicNotesPals(u8 taskId)
{
    ...
    for (i = 0; i < 3; i++)
        LoadPalette(&gMonSpritesGfxPtr->multiUseBuffer[i * 32], (0x100 + ((paletteNums[i]) * 16)), ((16) * sizeof(u16)));

    { Free(gMonSpritesGfxPtr->multiUseBuffer); gMonSpritesGfxPtr->multiUseBuffer = ((void *)0); };
    DestroyAnimVisualTask(taskId);
}
...
void AnimTask_FakeOut(u8 taskId)
{
    ...
    SetGpuReg(0x48, (1 << 13) | (1 << 12) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 4) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)));
    SetGpuReg(0x4a, (1 << 13) | (1 << 12) | ((1 << 8) | (1 << 9) | (1 << 10) | (1 << 11)) | (1 << 5) | (1 << 4) | ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)));
...
static void AnimTask_FakeOut_Step2(u8 taskId)
{
    if (++gTasks[taskId].data[10] == 5)
    {
        ...
        BlendPalettes(GetBattlePalettesMask(1, 0, 0, 0, 0, 0, 0), 16, ((31) | ((31) << 5) | ((31) << 10)));
    }
...
void AnimTask_HeartsBackground(u8 taskId)
{
    ...
    LoadCompressedPalette(gBattleAnimBg_AttractPal, (0x000 + ((animBg.paletteId) * 16)), ((16) * sizeof(u16)));
    if (IsContest())
...
void AnimTask_ScaryFace(u8 taskId)
{
    ...
    LoadCompressedPalette(gBattleAnim_ScaryFacePal, (0x000 + ((animBg.paletteId) * 16)), ((16) * sizeof(u16)));
    if (IsContest())
        RelocateBattleBgPal(animBg.paletteId, animBg.bgTilemap, 0, 0);
...
static void AnimOrbitScatter_Step(struct Sprite *sprite)
{
    ...
    if (sprite->x + sprite->x2 + 16 > ((u32)240 + 32)
     || sprite->y + sprite->y2 > 160 || sprite->y + sprite->y2 < -16)
        DestroyAnimSprite(sprite);
}
