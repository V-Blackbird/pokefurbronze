...
static const union AffineAnimCmd sVsLetterAffineAnimCmds1[] = {
    {.frame = {.xScale = 0x80, .yScale = 0x80, .rotation = 0, .duration = 0}},
    {.frame = {.xScale = 0x18, .yScale = 0x18, .rotation = 0x0, .duration = 0x80}},
    {.frame = {.xScale = 0x18, .yScale = 0x18, .rotation = 0x0, .duration = 0x80}},
    {.type = 0x7FFF}
};
...
{
    int i;
    for (i = 0; i < (sizeof(sMapBattleSceneMapping) / sizeof((sMapBattleSceneMapping)[0])); i++)
    {
...
{
    if (terrain >= (sizeof(sBattleTerrainTable) / sizeof((sBattleTerrainTable)[0])))
        terrain = 9;

    LZDecompressVram(sBattleTerrainTable[terrain].tileset, (void *)(void *)(0x6000000 + (0x4000 * (2))));
    LZDecompressVram(sBattleTerrainTable[terrain].tilemap, (void *)(void *)(0x6000000 + (0x800 * (26))));
    LoadCompressedPalette(sBattleTerrainTable[terrain].palette, (0x000 + ((2) * 16)), 3 * ((16) * sizeof(u16)));
}
...
static void LoadBattleTerrainEntryGfx(u16 terrain)
{
    ...
    LZDecompressVram(sBattleTerrainTable[terrain].entryTileset, (void *)(void *)(0x6000000 + (0x4000 * (1))));
    LZDecompressVram(sBattleTerrainTable[terrain].entryTilemap, (void *)(void *)(0x6000000 + (0x800 * (28))));
}
...
void BattleInitBgsAndWindows(void)
{
    ...
    InitBgsFromTemplates(0, gBattleBgTemplates, (sizeof(gBattleBgTemplates) / sizeof((gBattleBgTemplates)[0])));
...
void InitBattleBgsVideo(void)
{
    ...
    SetGpuReg(0x52, 0);
    SetGpuReg(0x54, 0);
    SetGpuReg(0x0, 0x0000 | 0x0040 | 0x1000 | 0x2000 | 0x8000);
}

void LoadBattleMenuWindowGfx(void)
{
    LoadUserWindowGfx(2, 0x012, (0x000 + ((1) * 16)));
    LoadUserWindowGfx(2, 0x022, (0x000 + ((1) * 16)));

    gPlttBufferUnfaded[(0x000 + ((5) * 16)) + 12] = ((9) | ((9) << 5) | ((9) << 10));
    gPlttBufferUnfaded[(0x000 + ((5) * 16)) + 13] = ((9) | ((9) << 5) | ((9) << 10));
    gPlttBufferUnfaded[(0x000 + ((5) * 16)) + 14] = ((31) | ((31) << 5) | ((31) << 10));
    gPlttBufferUnfaded[(0x000 + ((5) * 16)) + 15] = ((26) | ((26) << 5) | ((25) << 10));
    CpuSet(&gPlttBufferUnfaded[(0x000 + ((5) * 16)) + 12], &gPlttBufferFaded[(0x000 + ((5) * 16)) + 12], 0x00000000 | ((((4) * sizeof(u16)))/(16/8) & 0x1FFFFF));

    if (gBattleTypeFlags & ((1 << 4) | (1 << 16)))
    {
        Menu_LoadStdPalAt((0x000 + ((7) * 16)));
        LoadMenuMessageWindowGfx(0, 0x030, (0x000 + ((7) * 16)));

        gPlttBufferUnfaded[(0x000 + ((7) * 16)) + 6] = ((0) | ((0) << 5) | ((0) << 10));
        CpuSet(&gPlttBufferUnfaded[(0x000 + ((7) * 16)) + 6], &gPlttBufferFaded[(0x000 + ((7) * 16)) + 6], 0x00000000 | ((((1) * sizeof(u16)))/(16/8) & 0x1FFFFF));
    }
}
...
void LoadBattleTextboxAndBackground(void)
{
    LZDecompressVram(gBattleInterface_Textbox_Gfx, (void *)(void *)(0x6000000 + (0x4000 * (0))));
...
void InitLinkBattleVsScreen(u8 taskId)
{
    ...
    case 1:
        ...
        gPlttBufferUnfaded[(0x100 + ((palId) * 16)) + 15] = gPlttBufferFaded[(0x100 + ((palId) * 16)) + 15] = ((31) | ((31) << 5) | ((31) << 10));
...
void DrawBattleEntryBackground(void)
{
    ...
    {
        LZDecompressVram(gFile_graphics_battle_transitions_vs_frame_sheet, (void *)((void *)(0x6000000 + (0x4000 * (1)))));
        LZDecompressVram(gVsLettersGfx, (void *)(0x6000000 + 0x10000));
        LoadCompressedPalette(gFile_graphics_battle_transitions_vs_frame_palette, (0x000 + ((6) * 16)), ((16) * sizeof(u16)));
        SetBgAttribute(1, BG_ATTR_SCREENSIZE, 1);
        SetGpuReg(0xa, (0) | ((1) << 2) | 0x0000 | ((28) << 8) | 0x4000);
        ...
        SetGpuReg(0x48, (1 << 1) | (1 << 2) | (1 << 4) | (1 << 5));
        SetGpuReg(0x4a, (1 << 1) | (1 << 2) | (1 << 4) | (1 << 5));
        gBattle_BG1_Y = -164;
        gBattle_BG2_Y = -164;
        LoadCompressedSpriteSheetUsingHeap(&sVsLettersSpriteSheet);
    }
    else if (gBattleTypeFlags & (1 << 16))
    {
        LoadBattleTerrainEntryGfx(0);
    }
    else if (gBattleTypeFlags & ((1 << 19) | (1 << 1) | (1 << 8) | (1 << 11)))
    {
        LoadBattleTerrainEntryGfx(8);
    }
    else if (gBattleTypeFlags & (1 << 12))
    {
        if (gGameVersion == 4)
        {
            LoadBattleTerrainEntryGfx(7);
        }
        else
        {
            LoadBattleTerrainEntryGfx(4);
        }
    }
    else
    {
...
{
    u8 battleScene;
    if (gBattleTypeFlags & ((1 << 19) | (1 << 1) | (1 << 8) | (1 << 11)))
    {
        return 10;
    }
    else if (gBattleTypeFlags & (1 << 16))
    ...
    {
        if (gTrainers[gTrainerBattleOpponent_A].trainerClass == 84)
            return 12;
        else if (gTrainers[gTrainerBattleOpponent_A].trainerClass == 90)
            return 19;
    }
...
bool8 LoadChosenBattleElement(u8 caseId)
{
    ...
    case 3:
        ...
        LZDecompressVram(sBattleTerrainTable[battleScene].tileset, (void *)(void *)(0x6000000 + (0x4000 * (2))));

    case 4:
        battleScene = GetBattleTerrainOverride();
        LZDecompressVram(sBattleTerrainTable[battleScene].tilemap, (void *)(void *)(0x6000000 + (0x800 * (26))));
        break;
    case 5:
        battleScene = GetBattleTerrainOverride();
        LoadCompressedPalette(sBattleTerrainTable[battleScene].palette, (0x000 + ((2) * 16)), 3 * ((16) * sizeof(u16)));
        break;
    case 6:
        LoadBattleMenuWindowGfx();
        break;
