...
static __attribute__((section("ewram_data"))) struct Diploma *sDiploma = ((void *)0);
...
static const __attribute__((aligned(4))) u8 sTextColors[3] = {0, 2, 3};
...
static bool8 DiplomaLoadGfx(void)
{
    ...
    case 2:
        ...
        break;
    case 3:
        LoadPalette(sDiplomaPal, (0x000 + ((0) * 16)), sizeof(sDiplomaPal));
...
static void DiplomaPrintText(void)
{
    ...
    FillWindowPixelBuffer(WIN_TEXT, ((0) | ((0) << 4)));
    DynamicPlaceholderTextUtil_ExpandPlaceholders(str, gText_Diploma_Player);
    width = GetStringWidth(FONT_NORMAL, str, -1);
    AddTextPrinterParameterized3(WIN_TEXT, FONT_NORMAL, 120 - (width / 2), 4, sTextColors, 0xFF, str);
    DynamicPlaceholderTextUtil_ExpandPlaceholders(str, gText_Diploma_ThisDocument);
    width = GetStringWidth(FONT_NORMAL, str, -1);
    AddTextPrinterParameterized3(WIN_TEXT, FONT_NORMAL, 120 - (width / 2), 30, sTextColors, 0xFF, str);
