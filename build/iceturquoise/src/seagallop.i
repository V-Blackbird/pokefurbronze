...
# 12 "src/seagallop.c" 2
# 1 "include/constants/songs.h" 1
# 13 "src/seagallop.c" 2
...
# 14 "src/seagallop.c" 2
# 1 "include/constants/seagallop.h" 1
# 15 "src/seagallop.c" 2
...
static __attribute__((section("ewram_data"))) void *sBg3TilemapBuffer = ((void *)0);
...
static const s8 sSeag[][4] = {
    ...
    [0] = {((5 | (3 << 8)) >> 8), ((5 | (3 << 8)) & 0xFF), 0x17, 0x20},
    [1] = {((4 | (33 << 8)) >> 8), ((4 | (33 << 8)) & 0xFF), 0x08, 0x05},
    [2] = {((4 | (34 << 8)) >> 8), ((4 | (34 << 8)) & 0xFF), 0x08, 0x05},
    [3] = {((0 | (39 << 8)) >> 8), ((0 | (39 << 8)) & 0xFF), 0x08, 0x05},
    [4] = {((5 | (36 << 8)) >> 8), ((5 | (36 << 8)) & 0xFF), 0x08, 0x05},
    [5] = {((2 | (37 << 8)) >> 8), ((2 | (37 << 8)) & 0xFF), 0x08, 0x05},
    [6] = {((2 | (38 << 8)) >> 8), ((2 | (38 << 8)) & 0xFF), 0x08, 0x05},
    [7] = {((6 | (32 << 8)) >> 8), ((6 | (32 << 8)) & 0xFF), 0x08, 0x05},
    [8] = {((8 | (3 << 8)) >> 8), ((8 | (3 << 8)) & 0xFF), 0x15, 0x07},
    [9] = {((59 | (2 << 8)) >> 8), ((59 | (2 << 8)) & 0xFF), 0x08, 0x05},
    [10] = {((58 | (2 << 8)) >> 8), ((58 | (2 << 8)) & 0xFF), 0x08, 0x05}
};
...
static const struct SpriteSheet sFerryAndWakeSpriteSheets[] = {
    {(const void *)sWakeSpriteTiles, sizeof(sWakeSpriteTiles), 4000},
    {(const void *)sFerrySpriteTiles, sizeof(sFerrySpriteTiles), 3000},
    {}
};

static const struct SpritePalette sFerryAndWakeSpritePalettes[] = {
    {sFerryAndWakePal, 3000},
    {}
};
...
static const union AnimCmd sSpriteAnims_Wake_EB[] = {
    {.frame = {0x00, 0x14, .hFlip = 1}},
    {.frame = {0x10, 0x14, .hFlip = 1}},
    {.frame = {0x20, 0x0f, .hFlip = 1}},
    {.type = -1},
};
...
static void CB2_SetUpSeagallopScene(void)
{
    ...
    case 3:
        ...
        LoadPalette(sWaterPal, (0x000 + ((4) * 16)), sizeof(sWaterPal));
    ...
    case 7:
        ...
        SetGpuReg(0x48, 0x3F);
        SetGpuReg(0x4a, 0x00);
        SetGpuReg(0x40, 0x00F0);
        SetGpuReg(0x44, 0x1888);
...
static void Task_Seagallop_3(void)
{
    ...
    if (gSpecialVar_0x8006 >= (sizeof(sSeag) / sizeof((sSeag)[0])))
...
static void ResetGPU(void)
{
    void *dest = (void *) 0x6000000;
    { void *_dest = dest; u32 _size = 0x18000; while (1) { { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | (((0x1000))/(16/8))); dmaRegs[2]; }; }; _dest += (0x1000); _size -= (0x1000); if (_size <= (0x1000)) { { vu16 tmp = (vu16)(0); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; }; break; } } };
...
static void SetDispcnt(void)
{
    SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0100 | 0x0800 | 0x1000);
}
...
static bool8 GetDirectionOfTravel(void)
{
    if (gSpecialVar_0x8004 >= (sizeof(sTravelDirectionMatrix) / sizeof((sTravelDirectionMatrix)[0])))
    {
...
u8 GetSeagallopNumber(void)
{
    ...
    if (originId == 8 || destId == 8)
        return 1;

    if (originId == 0 || destId == 0)
        return 7;

    if (originId == 9 || destId == 9)
        return 10;

    if (originId == 10 || destId == 10)
        return 12;
...
{
    if (gSaveBlock1Ptr->location.mapGroup == ((5 | (3 << 8)) >> 8)
       && gSaveBlock1Ptr->location.mapNum == ((5 | (3 << 8)) & 0xFF)
