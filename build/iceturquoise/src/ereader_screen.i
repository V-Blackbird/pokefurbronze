...
# 17 "src/ereader_screen.c" 2
# 1 "include/constants/songs.h" 1
# 18 "src/ereader_screen.c" 2
...
static u8 EReader_Transfer(struct EReaderData *eReader)
{
    ...
    eReader->status = EReaderHandleTransfer(1, eReader->size, eReader->data, ((void *)0));

    if ((eReader->status & ((1 | 2) << 0)) == 0 && eReader->status & (1 << 4))
