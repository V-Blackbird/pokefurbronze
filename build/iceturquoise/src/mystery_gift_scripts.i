# 0 "src/mystery_gift_scripts.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mystery_gift_scripts.c"
...
# 2 "src/mystery_gift_scripts.c" 2
...
# 3 "src/mystery_gift_scripts.c" 2
...
# 4 "src/mystery_gift_scripts.c" 2
# 1 "include/constants/mystery_gift.h" 1
# 5 "src/mystery_gift_scripts.c" 2
...
static const struct MysteryGiftServerCmd sServerScript_CantSend[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_CantAccept), .ptr = sClientScript_CantAccept},
    {SVR_SEND},
...
static const struct MysteryGiftServerCmd sServerScript_CommError[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_CommError), .ptr = sClientScript_CommError},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_READY_END},
...
static const struct MysteryGiftServerCmd sServerScript_ClientCanceledNews[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_Canceled), .ptr = sClientScript_Canceled},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_READY_END},
...
static const struct MysteryGiftServerCmd sServerScript_HasNews[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_HadNews), .ptr = sClientScript_HadNews},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_READY_END},
...
static const struct MysteryGiftServerCmd sServerScript_SendNews[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_SaveNews), .ptr = sClientScript_SaveNews},
    {SVR_SEND},
    {SVR_LOAD_NEWS},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_RESPONSE},
    {SVR_READ_RESPONSE},
    {SVR_GOTO_IF_EQ, 1, sServerScript_HasNews},
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_NewsReceived), .ptr = sClientScript_NewsReceived},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_READY_END},
...
static const struct MysteryGiftServerCmd sServerScript_SendCard[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_SaveCard), .ptr = sClientScript_SaveCard},
    {SVR_SEND},
    {SVR_LOAD_CARD},
    {SVR_SEND},
    {SVR_LOAD_RAM_SCRIPT},
...
static const struct MysteryGiftServerCmd sServerScript_TossPrompt[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_AskToss), .ptr = sClientScript_AskToss},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_RESPONSE},
    {SVR_READ_RESPONSE},
    {SVR_GOTO_IF_EQ, 0, sServerScript_SendCard},
    {SVR_GOTO, .ptr = gServerScript_ClientCanceledCard}
};

static const struct MysteryGiftServerCmd sServerScript_HasCard[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_HadCard), .ptr = sClientScript_HadCard},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_READY_END},
...
static const struct MysteryGiftServerCmd sServerScript_NothingSent[] = {
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_NothingSent), .ptr = sClientScript_NothingSent},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_READY_END},
...
const struct MysteryGiftServerCmd gMysteryGiftServerScript_SendWonderNews[] = {
    {SVR_COPY_SAVED_NEWS},
    {SVR_LOAD_CLIENT_SCRIPT, .param = sizeof(sClientScript_SendGameData), .ptr = sClientScript_SendGameData},
    {SVR_SEND},
    {SVR_RECV, MG_LINKID_GAME_DATA},
    {SVR_COPY_GAME_DATA},
    {SVR_CHECK_GAME_DATA},
    {SVR_GOTO_IF_EQ, 0, sServerScript_CantSend},
...
const struct MysteryGiftServerCmd gMysteryGiftServerScript_SendWonderCard[] = {
    ...
    {SVR_GOTO_IF_EQ, 0, sServerScript_CantSend},
    {SVR_CHECK_EXISTING_CARD},
    {SVR_GOTO_IF_EQ, 2, sServerScript_TossPrompt},
    {SVR_GOTO_IF_EQ, 0, sServerScript_SendCard},
    {SVR_GOTO, .ptr = sServerScript_HasCard}
};
