...
static __attribute__((section("ewram_data"))) struct ClearSaveDataStruct * sClearSaveDataState = ((void *)0);
...
static void Task_DrawClearSaveDataScreen(u8 taskId)
{
    ...
    case 2:
        ...
        break;
    case 3:
        LoadStdWindowGfx(0, 0x001, (0x000 + ((15) * 16)));
        LoadStdWindowGfx(1, 0x001, (0x000 + ((15) * 16)));
        break;
    case 4:
        DrawStdFrameWithCustomTileAndPalette(1, 1, 0x001, 15);
    ...
    case 5:
        ...
        break;
    default:
        BeginNormalPaletteFade(0xFFFF, 0, 16, 0, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
...
static void Task_CleanUpAndSoftReset(u8 taskId)
{
    ...
    {
    case 0:
        BeginNormalPaletteFade(0xFFFF, 0, 0, 16, (((31) | ((31) << 5) | ((31) << 10)) | (1 << 15)));
    ...
    case 1:
        if (!gPaletteFade.active)
        {
            ...
            { Free(sClearSaveDataState); sClearSaveDataState = ((void *)0); };
            DoSoftReset();
