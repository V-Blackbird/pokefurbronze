# 0 "src/braille_text.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/braille_text.c"
...
# 2 "src/braille_text.c" 2
# 1 "include/main.h" 1
# 3 "src/braille_text.c" 2
...
u16 FontFunc_Braille(struct TextPrinter *textPrinter)
{
    ...
    case RENDER_STATE_HANDLE_CHAR:
        if (({(gMain.heldKeys) & (0x0001 | 0x0002);}) && sub->hasPrintBeenSpedUp)
        {
    ...
    case RENDER_STATE_SCROLL:
        if (textPrinter->scrollDistance)
        {
            ...
            {
                ScrollWindow(textPrinter->printerTemplate.windowId, 0, sScrollDistances[gSaveBlock2Ptr->optionsTextSpeed], ((textPrinter->printerTemplate.bgColor) | ((textPrinter->printerTemplate.bgColor) << 4)));
