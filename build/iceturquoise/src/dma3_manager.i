# 0 "src/dma3_manager.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/dma3_manager.c"
...
void ClearDma3Requests(void)
{
    ...
    for(i = 0; i < (u8)(sizeof(gDma3Requests) / sizeof((gDma3Requests)[0])); i++)
    {
...
void ProcessDma3Requests(void)
{
    ...
    while (gDma3Requests[gDma3RequestCursor].size != 0)
    {
        ...
        {
        case 1:
            { const void *_src = gDma3Requests[gDma3RequestCursor].src; void *_dest = gDma3Requests[gDma3RequestCursor].dest; u32 _size = gDma3Requests[gDma3RequestCursor].size; while (1) { if (_size <= 0x1000) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((_size)/(32/8))); dmaRegs[2]; }; break; } { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0000 | 0x0000) << 16 | ((0x1000)/(32/8))); dmaRegs[2]; }; _src += 0x1000; _dest += 0x1000; _size -= 0x1000; } }

                                                                    ;
            break;
        case 2:
            { void *_dest = gDma3Requests[gDma3RequestCursor].dest; u32 _size = gDma3Requests[gDma3RequestCursor].size; while (1) { if (_size <= 0x1000) { { vu32 tmp = (vu32)(gDma3Requests[gDma3RequestCursor].value); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((_size)/(32/8))); dmaRegs[2]; }; }; break; } { vu32 tmp = (vu32)(gDma3Requests[gDma3RequestCursor].value); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0400 | 0x0100 | 0x0000) << 16 | ((0x1000)/(32/8))); dmaRegs[2]; }; }; _dest += 0x1000; _size -= 0x1000; } }

                                                                    ;
            break;
        case 3:
            { const void *_src = gDma3Requests[gDma3RequestCursor].src; void *_dest = gDma3Requests[gDma3RequestCursor].dest; u32 _size = gDma3Requests[gDma3RequestCursor].size; while (1) { if (_size <= 0x1000) { { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; break; } { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(_src); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | ((0x1000)/(16/8))); dmaRegs[2]; }; _src += 0x1000; _dest += 0x1000; _size -= 0x1000; } }

                                                                    ;
            break;
        case 4:
            { void *_dest = gDma3Requests[gDma3RequestCursor].dest; u32 _size = gDma3Requests[gDma3RequestCursor].size; while (1) { if (_size <= 0x1000) { { vu16 tmp = (vu16)(gDma3Requests[gDma3RequestCursor].value); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((_size)/(16/8))); dmaRegs[2]; }; }; break; } { vu16 tmp = (vu16)(gDma3Requests[gDma3RequestCursor].value); { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(&tmp); dmaRegs[1] = (vu32)(_dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0100 | 0x0000) << 16 | ((0x1000)/(16/8))); dmaRegs[2]; }; }; _dest += 0x1000; _size -= 0x1000; } }
