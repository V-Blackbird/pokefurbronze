...
int EReader_Send(size_t size, const void *src)
{
    ...
    while (1)
    {
        ...
        sSendRecvStatus = EReaderHandleTransfer(1, size, src, ((void *)0));
    ...
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &sSendRecvMgr, 0x04000000 | 0x01000000 | ((sizeof(sSendRecvMgr))/(32/8) & 0x1FFFFF)); };
...
int EReader_Recv(void *dest)
{
    ...
    while (1)
    {
        ...
        sSendRecvStatus = EReaderHandleTransfer(0, 0, ((void *)0), dest);
        if ((sSendRecvStatus & 0x13) == 0x10)
        {
            result = 0;
            break;
...
{
    (*(vu16 *)(0x4000000 + 0x134)) = 0;
    (*(vu16 *)(0x4000000 + 0x128)) = 0x4000 | 0x1000;
...
{
    bool16 resp;
    if ((*(vu32 *)(0x4000000 + 0x128) & (0x0004 | 0x0008)) == 0x0008 && mode)
        resp = sSendRecvMgr.master_slave = 1;
    else
        resp = sSendRecvMgr.master_slave = 0;
    return resp;
}
...
static void SetUpTransferManager(size_t size, const void *data, void *recvBuffer)
{
    if (sSendRecvMgr.master_slave)
    {
        ...
        (*(vu32 *)(0x4000000 + 0x120)) = size;
        sSendRecvMgr.size = size / 4 + 1;
        StartTm3();
    }
    else
    {
        (*(vu16 *)(0x4000000 + 0x128)) |= 0x0000;
...
void EReaderHelper_SerialCallback(void)
{
    ...
    case EREADER_XFR_STATE_TRANSFER:
        ...
        if (sSendRecvMgr.master_slave == 1)
        {
            ...
            {
                (*(vu32 *)(0x4000000 + 0x120)) = sSendRecvMgr.dataptr[sSendRecvMgr.cursor];
                sSendRecvMgr.checksum += sSendRecvMgr.dataptr[sSendRecvMgr.cursor];
            }
            else
                (*(vu32 *)(0x4000000 + 0x120)) = sSendRecvMgr.checksum;
        }
        else
        {
    ...
    case EREADER_XFR_STATE_CHECKSUM:
        if (sSendRecvMgr.master_slave == 0)
            ...
            (*(vu16 *)(0x4000000 + 0x12a)) = sSendRecvMgr.checksumResult;
        *(vu64 *)recv = (*(vu64 *)(0x4000000 + 0x120));
...
static void GetKeyInput(void)
{
    u16 rawKeys = (*(vu16 *)(0x4000000 + 0x130)) ^ 0x3FF;
...
void EReaderHelper_SaveRegsState(void)
{
    ...
    sSavedIe = (*(vu16 *)(0x4000000 + 0x200));
    sSavedTm3Cnt = (*(vu16 *)(0x4000000 + 0x10e));
    sSavedSioCnt = (*(vu16 *)(0x4000000 + 0x128));
    sSavedRCnt = (*(vu16 *)(0x4000000 + 0x134));
}

void EReaderHelper_RestoreRegsState(void)
{
    (*(vu16 *)(0x4000000 + 0x208)) = sSavedIme;
    (*(vu16 *)(0x4000000 + 0x200)) = sSavedIe;
    (*(vu16 *)(0x4000000 + 0x10e)) = sSavedTm3Cnt;
    (*(vu16 *)(0x4000000 + 0x128)) = sSavedSioCnt;
    (*(vu16 *)(0x4000000 + 0x134)) = sSavedRCnt;
}
