...
static __attribute__((section("ewram_data"))) struct UnionRoomBattleWork * sWork = ((void *)0);
...
static void UnionRoomBattle_CreateTextPrinter(u8 windowId, const u8 * str, u8 x, u8 y, s32 speed)
{
    s32 letterSpacing = 1;
    s32 lineSpacing = 1;
    FillWindowPixelBuffer(windowId, ((sTextColors[0]) | ((sTextColors[0]) << 4)));
...
void CB2_UnionRoomBattle(void)
{
    ...
    case 0:
        ...
        LoadStdWindowGfx(0, 1, (0x000 + ((13) * 16)));
        Menu_LoadStdPal();
    ...
    case 3:
        if (!UpdatePaletteFade())
        {
            ...
            {
                gBlockSendBuffer[0] = 18 | 0x40;
            }
            else
            {
                gBlockSendBuffer[0] = 17 | 0x40;
            }
    ...
    case 4:
        ...
        {
            if (gBlockRecvBuffer[0][0] == (17 | 0x40) && gBlockRecvBuffer[1][0] == (17 | 0x40))
            {
            ...
            else
            {
                ...
                if (gBlockRecvBuffer[GetMultiplayerId()][0] == (18 | 0x40))
                {
                    gMain.state = 6;
                }
                else
