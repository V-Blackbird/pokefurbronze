...
static void CreateNidoranFSprite(u8 taskId)
{
    ...
    DecompressPicFromTable(&gMonFrontPicTable[28], MonSpritesGfxManager_GetSpritePtr(0), 28);
    LoadCompressedSpritePaletteUsingHeap(&gMonPaletteTable[28]);
    SetMultiuseSpriteTemplateToPokemon(28, 0);
