...
const u16 gDISPCNTBGFlags[] = { 0x0100, 0x0200, 0x0400, 0x0800 };
const u16 gOverworldBackgroundLayerFlags[] = { (1 << 8), (1 << 9), (1 << 10), (1 << 11) };
const u16 gBLDCNTTarget1BGFlags[] = { (1 << 0), (1 << 1), (1 << 2), (1 << 3) };
