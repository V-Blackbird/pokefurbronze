# 0 "src/party_menu_specials.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/party_menu_specials.c"
...
void ClearTempFieldEventData(void);
# 10 "src/party_menu_specials.c" 2
# 1 "include/constants/moves.h" 1
# 11 "src/party_menu_specials.c" 2
