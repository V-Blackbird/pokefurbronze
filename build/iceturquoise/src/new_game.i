...
{
    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, &gSaveBlock2Ptr->battleTower, 0x04000000 | 0x01000000 | ((sizeof(gSaveBlock2Ptr->battleTower))/(32/8) & 0x1FFFFF)); };
}

static void WarpToPlayersRoom(void)
{
    SetWarpDestination(((67 | (3 << 8)) >> 8), ((67 | (3 << 8)) & 0xFF), -1, 5, 6);
    WarpIntoMap();
}
