# 0 "src/mystery_gift_show_news.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/mystery_gift_show_news.c"
...
# 2 "src/mystery_gift_show_news.c" 2
# 1 "include/gflib.h" 1
...
# 3 "src/mystery_gift_show_news.c" 2
...
# 4 "src/mystery_gift_show_news.c" 2
...
# 5 "src/mystery_gift_show_news.c" 2
...
# 6 "src/mystery_gift_show_news.c" 2
...
# 7 "src/mystery_gift_show_news.c" 2
# 1 "include/menu.h" 1
# 18 "include/menu.h"
struct MenuAction
{
...
# 8 "src/mystery_gift_show_news.c" 2
...
# 9 "src/mystery_gift_show_news.c" 2
...
# 10 "src/mystery_gift_show_news.c" 2
# 1 "include/constants/mystery_gift.h" 1
# 11 "src/mystery_gift_show_news.c" 2
...
static __attribute__((section("ewram_data"))) struct WonderNewsData * sWonderNewsData = ((void *)0);
...
static const struct WonderGraphics sNewsGraphics[8] = {
...
void WonderNews_Destroy(void)
{
    if (sWonderNewsData != ((void *)0))
    {
        *sWonderNewsData = (struct WonderNewsData){};
        { Free(sWonderNewsData); sWonderNewsData = ((void *)0); };
    }
}
...
s32 WonderNews_Enter(void)
{
    ...
    case 1:
        ...
        SetGpuReg(0x44, (((26) << 8) | (152)));
        SetGpuReg(0x48, ((1 << 0) | (1 << 1) | (1 << 2) | (1 << 3)) | (1 << 4));
        SetGpuReg(0x4a, (1 << 0) | (1 << 1) | (1 << 3) | (1 << 4));
    ...
    case 3:
        ...
        LoadPalette(sWonderNewsData->gfx->pal, (0x000 + ((1) * 16)), ((16) * sizeof(u16)));
...
void WonderNews_RemoveScrollIndicatorArrowPair(void)
{
    if (!sWonderNewsData->verticalScrollDisabled && sWonderNewsData->arrowTaskId != 0xFF)
    {
        RemoveScrollIndicatorArrowPair(sWonderNewsData->arrowTaskId);
        sWonderNewsData->arrowTaskId = 0xFF;
        sWonderNewsData->verticalScrollDisabled = 1;
    }
}
...
void WonderNews_AddScrollIndicatorArrowPair(void)
{
    ...
    {
        sWonderNewsData->arrowTaskId = AddScrollIndicatorArrowPair(&sWonderNewsData->arrowsTemplate, &sWonderNewsData->scrollOffset);
        sWonderNewsData->verticalScrollDisabled = 0;
    }
}
...
u32 WonderNews_GetInput(u16 input)
{
    ...
    case 0x0040:
        ...
        if (sWonderNewsData->verticalScrollDisabled)
            return NEWS_INPUT_NONE;
        sWonderNewsData->scrollingDown = 0;
        break;
    case 0x0080:
        ...
        if (sWonderNewsData->verticalScrollDisabled)
            return NEWS_INPUT_NONE;
        sWonderNewsData->scrollingDown = 1;
        break;
    default:
        return NEWS_INPUT_NONE;
    }
