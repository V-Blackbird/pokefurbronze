# 0 "src/cereader_tool.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/cereader_tool.c"
...
# 6 "src/cereader_tool.c" 2





typedef char EReaderTrainerTowerSetFreeSpace[((((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4])) + (sizeof(struct EReaderTrainerTowerSet) - (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4]))) <= ((size_t)&((struct SaveSector *)0)->counter) * 2) ? 1 : -1];;
...
static bool32 ValidateTrainerTowerTrainer(struct TrainerTowerFloor * floor)
{
    ...
    if (floor->challengeType > 2)
        return 0;
    if (CalcByteArraySum((const u8 *)floor, ((size_t)&((typeof(*floor) *)0)->checksum)) != floor->checksum)
        return 0;
    return 1;
}
...
{
    (ttdata->dummy == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "cereader_tool.c"), 198, "ttdata->dummy == 0", 1);;
    (ttdata->id == 0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "cereader_tool.c"), 199, "ttdata->id == 0", 1);

    memset(buffer, 0, (3968 + 128));
    memcpy(buffer, ttdata, (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4])));
    buffer[1] = GetTrainerHillUnkVal();
    if (TryWriteSpecialSaveSector(30, buffer) != 1)
        return 0;
    memset(buffer, 0, (3968 + 128));
    memcpy(buffer, (u8 *)ttdata + (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4])), (sizeof(struct EReaderTrainerTowerSet) - (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4]))));
    if (TryWriteSpecialSaveSector(31, buffer) != 1)
        return 0;
    return 1;
}
...
bool32 CEReaderTool_SaveTrainerTower(struct EReaderTrainerTowerSet * ttdata)
{
    u8 * buffer = AllocZeroed((3968 + 128));
...
static bool32 CEReaderTool_LoadTrainerTower_r(struct EReaderTrainerTowerSet * ttdata, void *buffer)
{
    if (TryReadSpecialSaveSector(30, buffer) != 1)
        return 0;
    memcpy(ttdata + 0x000, buffer, (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4])));

    if (TryReadSpecialSaveSector(31, buffer) != 1)
        return 0;
    memcpy((u8 *)ttdata + (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4])), buffer, (sizeof(struct EReaderTrainerTowerSet) - (((size_t)&((struct EReaderTrainerTowerSet *)0)->floors[4]))));
...
bool32 CEReaderTool_LoadTrainerTower(struct EReaderTrainerTowerSet * ttdata)
{
    void *buffer = AllocZeroed((3968 + 128));
