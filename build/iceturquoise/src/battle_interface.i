...
static const struct Subsprite sUnused_Subsprites_0[] = {
    { -16, 0, (((3 << 2) | (1)) & 0x03), ((((3 << 2) | (1)) >> 2) & 0x03), 0, 1 },
    { 48, 0, (((2 << 2) | (0)) & 0x03), ((((2 << 2) | (0)) >> 2) & 0x03), 32, 1 },
    { -16, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 48, 1 },
    { 16, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 52, 1 },
    { 48, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 56, 1 }
};

static const struct Subsprite sUnused_Subsprites_2[] = {
    { -16, 0, (((3 << 2) | (1)) & 0x03), ((((3 << 2) | (1)) >> 2) & 0x03), 64, 1 },
    { 48, 0, (((2 << 2) | (0)) & 0x03), ((((2 << 2) | (0)) >> 2) & 0x03), 96, 1 },
    { -16, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 112, 1 },
    { 16, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 116, 1 },
    { 48, 32, (((1 << 2) | (1)) & 0x03), ((((1 << 2) | (1)) >> 2) & 0x03), 120, 1 }
};
...
static const struct SubspriteTable sUnused_SubspriteTable[] = {
    {(sizeof(sUnused_Subsprites_0) / sizeof((sUnused_Subsprites_0)[0])), sUnused_Subsprites_0},
    {(sizeof(sUnused_Subsprites_1) / sizeof((sUnused_Subsprites_1)[0])), sUnused_Subsprites_1},
    {(sizeof(sUnused_Subsprites_2) / sizeof((sUnused_Subsprites_2)[0])), sUnused_Subsprites_2},
    {(sizeof(sUnused_Subsprites_3) / sizeof((sUnused_Subsprites_3)[0])), sUnused_Subsprites_3}
};

static const struct SubspriteTable sHealthBar_SubspriteTable[] = {
    [0] = {(sizeof(sHealthBar_Subsprites_Player) / sizeof((sHealthBar_Subsprites_Player)[0])), sHealthBar_Subsprites_Player},
    [1] = {(sizeof(sHealthBar_Subsprites_Opponent) / sizeof((sHealthBar_Subsprites_Opponent)[0])), sHealthBar_Subsprites_Opponent},
};
...
static const struct SubspriteTable sStatusSummaryBar_SubspriteTable_Enter[] = {
    {(sizeof(sStatusSummaryBar_Subsprites_Enter) / sizeof((sStatusSummaryBar_Subsprites_Enter)[0])), sStatusSummaryBar_Subsprites_Enter}
};

static const struct SubspriteTable sStatusSummaryBar_SubspriteTable_Exit[] = {
    {(sizeof(sStatusSummaryBar_Subsprites_Exit) / sizeof((sStatusSummaryBar_Subsprites_Exit)[0])), sStatusSummaryBar_Subsprites_Exit}
};
...
static const struct CompressedSpriteSheet sPartySummaryBarSpriteSheets[] = {
    {gBattleInterface_PartySummaryBar_Gfx, 16 * 32, 55052},
    {gBattleInterface_PartySummaryBar_Gfx, 16 * 32, 55053}
};
...
static const struct SpriteSheet sPartySummaryBallSpriteSheets[] = {
    {gBattleInterface_Gfx + 66, 4 * 32, 55060},
    {gBattleInterface_Gfx + 66, 4 * 32, 55061}
};
...
{
    dest[4] = 30;
    Debug_DrawNumber(num2, &dest[0], 0);
    Debug_DrawNumber(num1, &dest[5], 1);
}
# 533 "src/battle_interface.c"
enum
{
...
u8 CreateBattlerHealthboxSprites(u8 battlerId)
{
    ...
    if (!IsDoubleBattle())
    {
        ...
        {
            healthboxSpriteId = CreateSprite(&sHealthboxPlayerSpriteTemplates[0 / 2], 240, 160, 1);
            healthboxOtherSpriteId = CreateSpriteAtEnd(&sHealthboxPlayerSpriteTemplates[0 / 2], 240, 160, 1);

            gSprites[healthboxSpriteId].oam.shape = (((3 << 2) | (0)) & 0x03);
            gSprites[healthboxOtherSpriteId].oam.shape = (((3 << 2) | (0)) & 0x03);
            gSprites[healthboxOtherSpriteId].oam.tileNum += 2 * 32;
        }
        else
        {
            healthboxSpriteId = CreateSprite(&sHealthboxOpponentSpriteTemplates[1 / 2], 240, 160, 1);
            healthboxOtherSpriteId = CreateSpriteAtEnd(&sHealthboxOpponentSpriteTemplates[1 / 2], 240, 160, 1);

            gSprites[healthboxOtherSpriteId].oam.tileNum += 1 * 32;
    ...
    CpuSet(GetBattleInterfaceGfxPtr(1), (void *)(0x6000000 + 0x10000) + healthbarSprite->oam.tileNum * 32, 0x04000000 | ((2 * 32)/(32/8) & 0x1FFFFF));
...
void UpdateOamPriorityInAllHealthboxes(u8 priority)
{
    ...
    for (i = 0; i < gBattlersCount; i++)
    {
        ...
        u8 healthboxOtherSpriteId = gSprites[gHealthboxSpriteIds[i]].oam.affineParam;
...
static void UpdateLvlInHealthbox(u8 healthboxSpriteId, u8 lvl)
{
    ...
    {
        objVram = (void *)((void *)(0x6000000 + 0x10000));
        if (!IsDoubleBattle())
...
void UpdateHpTextInHealthbox(u8 healthboxSpriteId, s16 value, u8 maxOrCurrent)
{
    ...
    if (GetBattlerSide(gSprites[healthboxSpriteId].data[6]) == 0 && !IsDoubleBattle())
    {
        ...
        if (maxOrCurrent != HP_CURRENT)
        {
            ...
            TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000)) + spriteTileNum * 32 + 0xA40, windowTileData, 2);
            RemoveWindowOnHealthbox(windowId);
        }
        else
        {
            ...
            *strptr++ = 0xFF;
            ...
            spriteTileNum = gSprites[healthboxSpriteId].oam.tileNum;
            TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000)) + spriteTileNum * 32 + 0x2E0, windowTileData, 1);
            TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000)) + spriteTileNum * 32 + 0xA00, windowTileData + 0x20, 2);
            RemoveWindowOnHealthbox(windowId);
        }
    }
    else
    {
        ...
        else
        {
            ...
            for (i = 0; i < 3; i++)
            {
                CpuSet(&gMonSpritesGfxPtr->barFontGfx[i * 64 + 32], (void *)(((void *)(0x6000000 + 0x10000)) + 32 * (gSprites[healthboxSpriteId].oam.tileNum + var + i)), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
...
static void UpdateHpTextInHealthboxInDoubles(u8 healthboxSpriteId, s16 value, u8 maxOrCurrent)
{
    ...
    if (gBattleSpritesDataPtr->battlerData[battlerId].hpNumbersNoBars)
    {
        ...
        for (i = var; i < var + 3; i++)
        {
            if (i < 3)
            {
                CpuSet(&gMonSpritesGfxPtr->barFontGfx[((i - var) * 64) + 32], (void *)(((void *)(0x6000000 + 0x10000)) + (1 + gSprites[healthBarSpriteId].oam.tileNum + i) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))

                                             ;
            }
            else
            {
                CpuSet(&gMonSpritesGfxPtr->barFontGfx[((i - var) * 64) + 32], (void *)(((void *)(0x6000000 + 0x10000) + 0x20) + (i + gSprites[healthBarSpriteId].oam.tileNum) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
        ...
        if (maxOrCurrent == HP_CURRENT)
        {
            CpuSet(&gMonSpritesGfxPtr->barFontGfx[224], (void *)(((void *)(0x6000000 + 0x10000)) + ((gSprites[healthBarSpriteId].oam.tileNum + 4) * 32)), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))

                                         ;
            { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)(((void *)(0x6000000 + 0x10000)) + (gSprites[healthBarSpriteId].oam.tileNum * 32)), 0x04000000 | 0x01000000 | ((1 * 32)/(32/8) & 0x1FFFFF)); }
        ...
        else
        {
            if (GetBattlerSide(battlerId) == 0)
            {
                CpuSet(GetBattleInterfaceGfxPtr(116), (void *)((void *)(0x6000000 + 0x10000)) + ((gSprites[healthboxSpriteId].oam.tileNum + 52) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
...
static void PrintSafariMonInfo(u8 healthboxSpriteId, struct Pokemon *mon)
{
    ...
    for (j = 6, i = 0; i < var; i++, j++)
    {
        ...
        CpuSet(GetBattleInterfaceGfxPtr(elementId), barFontGfx + (i * 64), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF));
    }

    for (j = 1; j < var + 1; j++)
    {
        spriteTileNum = (gSprites[healthboxSpriteId].oam.tileNum + (j - (j / 8 * 8)) + (j / 8 * 64)) * 32;
        CpuSet(barFontGfx, (void *)((void *)(0x6000000 + 0x10000)) + (spriteTileNum), 0x04000000 | ((0x20)/(32/8) & 0x1FFFFF));
        barFontGfx += 0x20;
    ...
    for (j = 0; j < 5; j++)
    {
        if (j <= 1)
        {
            CpuSet(&gMonSpritesGfxPtr->barFontGfx[0x40 * j + 0x20], (void *)((void *)(0x6000000 + 0x10000)) + (gSprites[healthBarSpriteId].oam.tileNum + 2 + j) * 32, 0x04000000 | ((32)/(32/8) & 0x1FFFFF))

                         ;
        }
        else
        {
            CpuSet(&gMonSpritesGfxPtr->barFontGfx[0x40 * j + 0x20], (void *)((void *)(0x6000000 + 0x10000) + 0xC0) + (j + gSprites[healthBarSpriteId].oam.tileNum) * 32, 0x04000000 | ((32)/(32/8) & 0x1FFFFF))
            ...
            && (IsDoubleBattle() || GetBattlerSide(i) != 0))
        {
            ...
            if (GetBattlerSide(i) == 0)
            {
                ...
                if (noBars == 1)
                {
                    ...
                    { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)((void *)(0x6000000 + 0x10000) + gSprites[healthBarSpriteId].oam.tileNum * 32), 0x04000000 | 0x01000000 | ((8 * 32)/(32/8) & 0x1FFFFF)); };
                ...
                else
                {
                    ...
                    CpuSet(GetBattleInterfaceGfxPtr(117), (void *)((void *)(0x6000000 + 0x10000) + 0x680 + gSprites[gHealthboxSpriteIds[i]].oam.tileNum * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
...
u8 CreatePartyStatusSummarySprites(u8 battlerId, struct HpAndStatus *partyInfo, bool8 isSwitchingMons, bool8 isBattleStart)
{
    ...
    if (!isSwitchingMons || GetBattlerPosition(battlerId) != 3)
    {
        if (GetBattlerSide(battlerId) == 0)
        {
            isOpponent = 0;
...
static void SpriteCB_PartySummaryBall_OnBattleStart(struct Sprite *sprite)
{
    ...
    if (sprite->x2 == 0)
    {
        s8 pan = isOpponent ? -64 : 63;
        if (sprite->data[7] != 0)
            PlaySE2WithPanning(109, pan);
        else
            PlaySE1WithPanning(108, pan);
...
static void SpriteCB_PartySummaryBall_Exit(struct Sprite *sprite)
{
    ...
    if (sprite->x2 + sprite->x > 240 + 8 || sprite->x2 + sprite->x < -8)
    {
        sprite->invisible = 1;
        sprite->callback = SpriteCallbackDummy;
    }
...
void UpdateNickInHealthbox(u8 healthboxSpriteId, struct Pokemon *mon)
{
    ...
    *ptr++ = 0x01;
    ...
    if (CheckBattleTypeGhost(mon, gSprites[healthboxSpriteId].data[6]))
        gender = 100;
    ...
    if (GetBattlerSide(gSprites[healthboxSpriteId].data[6]) == 0)
    {
        TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000) + 0x40 + spriteTileNum), windowTileData, 6);
        ptr = (void *)((void *)(0x6000000 + 0x10000));
        if (!IsDoubleBattle())
        ...
        TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000) + 0x20 + spriteTileNum), windowTileData, 7);
...
void TryAddPokeballIconToHealthbox(u8 healthboxSpriteId, bool8 noStatus)
{
    ...
    if (gBattleTypeFlags & ((1 << 4) | (1 << 9) | (1 << 20) | (1 << 16)))
        return;
    ...
    if (noStatus)
        CpuSet(GetBattleInterfaceGfxPtr(70), (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthBarSpriteId].oam.tileNum + 8) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF));
    else
        { vu32 tmp = (vu32)(0); CpuSet((void *)&tmp, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthBarSpriteId].oam.tileNum + 8) * 32), 0x04000000 | 0x01000000 | ((1 * 32)/(32/8) & 0x1FFFFF)); };
}
...
static void UpdateStatusIconInHealthbox(u8 healthboxSpriteId)
{
    ...
    {
        statusGfxPtr = GetBattleInterfaceGfxPtr(GetStatusIconForBattlerId(27, battlerId));
        statusPalId = PAL_STATUS_SLP;
    }
    else if (status & ((1 << 3) | (1 << 7)))
    {
        statusGfxPtr = GetBattleInterfaceGfxPtr(GetStatusIconForBattlerId(21, battlerId));
        statusPalId = PAL_STATUS_PSN;
    }
    else if (status & (1 << 4))
    {
        statusGfxPtr = GetBattleInterfaceGfxPtr(GetStatusIconForBattlerId(33, battlerId));
        statusPalId = PAL_STATUS_BRN;
    }
    else if (status & (1 << 5))
    {
        statusGfxPtr = GetBattleInterfaceGfxPtr(GetStatusIconForBattlerId(30, battlerId));
        statusPalId = PAL_STATUS_FRZ;
    }
    else if (status & (1 << 6))
    {
        statusGfxPtr = GetBattleInterfaceGfxPtr(GetStatusIconForBattlerId(24, battlerId));
        statusPalId = PAL_STATUS_PAR;
    }
    else
    {
        statusGfxPtr = GetBattleInterfaceGfxPtr(39);

        for (i = 0; i < 3; i++)
            CpuSet(statusGfxPtr, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthboxSpriteId].oam.tileNum + tileNumAdder + i) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))

                                         ;

        if (!gBattleSpritesDataPtr->battlerData[battlerId].hpNumbersNoBars)
            CpuSet(GetBattleInterfaceGfxPtr(1), (void *)((void *)(0x6000000 + 0x10000) + gSprites[healthBarSpriteId].oam.tileNum * 32), 0x04000000 | ((2 * 32)/(32/8) & 0x1FFFFF))
    ...
    FillPalette(sStatusIconColors[statusPalId], pltAdder + 0x100, ((1) * sizeof(u16)));
    CpuSet(&gPlttBufferUnfaded[0x100 + pltAdder], (u16 *)(0x5000000 + 0x200) + pltAdder, 0x00000000 | ((((1) * sizeof(u16)))/(16/8) & 0x1FFFFF));
    CpuSet(statusGfxPtr, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthboxSpriteId].oam.tileNum + tileNumAdder) * 32), 0x04000000 | ((3 * 32)/(32/8) & 0x1FFFFF));
    if (IsDoubleBattle() == 1 || GetBattlerSide(battlerId) == 1)
    {
        if (!gBattleSpritesDataPtr->battlerData[battlerId].hpNumbersNoBars)
        {
            CpuSet(GetBattleInterfaceGfxPtr(0), (void *)((void *)(0x6000000 + 0x10000) + gSprites[healthBarSpriteId].oam.tileNum * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))

                                        ;
            CpuSet(GetBattleInterfaceGfxPtr(65), (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthBarSpriteId].oam.tileNum + 1) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
...
static void UpdateSafariBallsTextOnHealthbox(u8 healthboxSpriteId)
{
    ...
    spriteTileNum = gSprites[healthboxSpriteId].oam.tileNum * 32;
    TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000) + 0x40) + spriteTileNum, windowTileData, 6);
    TextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000) + 0x800) + spriteTileNum, windowTileData + 0xC0, 2);
    RemoveWindowOnHealthbox(windowId);
}
...
static void UpdateLeftNoOfBallsTextOnHealthbox(u8 healthboxSpriteId)
{
    ...
    spriteTileNum = gSprites[healthboxSpriteId].oam.tileNum * 32;
    SafariTextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000) + 0x2C0) + spriteTileNum, windowTileData, 2);
    SafariTextIntoHealthboxObject((void *)((void *)(0x6000000 + 0x10000) + 0xA00) + spriteTileNum, windowTileData + 0x40, 4);
    RemoveWindowOnHealthbox(windowId);
}
...
s32 MoveBattleBar(u8 battlerId, u8 healthboxSpriteId, u8 whichBar, u8 unused)
{
    ...
    else
    {
        ...
        if (increment == 0)
            increment = 1;
        increment = ((gBattleSpritesDataPtr->battleBars[battlerId].receivedValue / increment) < 0 ? -(gBattleSpritesDataPtr->battleBars[battlerId].receivedValue / increment) : (gBattleSpritesDataPtr->battleBars[battlerId].receivedValue / increment));
...
static void MoveBattleBarGraphically(u8 battlerId, u8 whichBar)
{
    u8 filledPixels[(48 / 8) > (64 / 8) ? (48 / 8) : (64 / 8)];
    ...
    case HEALTH_BAR:
        ...
        if (totalFilledPixels > (48 * 50 / 100))
            barElementId = 3;
        else if (totalFilledPixels > (48 * 20 / 100))
            barElementId = 47;
        else
            barElementId = 56;
        ...
        for (i = 0; i < (48 / 8); i++)
        {
            ...
            if (i < 2)
                CpuSet(GetBattleInterfaceGfxPtr(barElementId) + filledPixels[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[healthbarSpriteId].oam.tileNum + 2 + i) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))

                                             ;
            else
                CpuSet(GetBattleInterfaceGfxPtr(barElementId) + filledPixels[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + 64 + (i + gSprites[healthbarSpriteId].oam.tileNum) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
    ...
    case EXP_BAR:
        ...
        {
            if (i < 4)
                CpuSet(GetBattleInterfaceGfxPtr(12) + filledPixels[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + (gSprites[gBattleSpritesDataPtr->battleBars[battlerId].healthboxSpriteId].oam.tileNum + 36 + i) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))

                                             ;
            else
                CpuSet(GetBattleInterfaceGfxPtr(12) + filledPixels[i] * 32, (void *)((void *)(0x6000000 + 0x10000) + 0xB80 + (i + gSprites[gBattleSpritesDataPtr->battleBars[battlerId].healthboxSpriteId].oam.tileNum) * 32), 0x04000000 | ((1 * 32)/(32/8) & 0x1FFFFF))
...
static s32 CalcNewBarValue(s32 maxValue, s32 oldValue, s32 receivedValue, s32 *currValue, u8 totalPixels, u16 increment)
{
    ...
    if (maxValue < totalPixels)
    {
        if (newValue == ((s32)((*currValue) >> 8)) && (*currValue & 0xFF) == 0)
            return -1;
    }
    else
    {
    ...
    if (maxValue < totalPixels)
    {
        s32 incrementInQ = ((s32)((maxValue) << 8)) / totalPixels;
...
static u8 CalcBarFilledPixels(s32 maxValue, s32 oldValue, s32 receivedValue, s32 *currValue, u8 *filledPixels, u8 numTiles)
{
    ...
    if (maxValue < totalPixels)
        numPixelsToFill = ((s32)((*currValue * totalPixels / maxValue) >> 8));
    else
...
static u8 *AddTextPrinterAndCreateWindowOnHealthbox(const u8 *str, u32 x, u32 y, u32 *windowId)
{
    ...
    FillWindowPixelBuffer(winId, ((2) | ((2) << 4)));
