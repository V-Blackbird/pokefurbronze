...
bool8 SetUpFieldMove_Flash(void)
{
    if (gMapHeader.cave != 1)
        return 0;

    if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x6)))
        return 0;
...
static bool8 TryDoMapTransition(void)
{
    ...
    u8 i = 0;
    if (GetLastUsedWarpMapSectionId() != gMapHeader.regionMapSectionId && MapHasPreviewScreen_HandleQLState2(gMapHeader.regionMapSectionId, 0) == 1)
    {
...
{
    SetGpuReg(0x0, 0);
    LZ77UnCompVram(sCaveTransitionTiles, (void *)(void *)(0x6000000 + (0x4000 * (3))));
    LZ77UnCompVram(sCaveTransitionTilemap, (void *)(void *)(0x6000000 + (0x800 * (31))));
    LoadPalette(sCaveTransitionPalette_White, (0x000 + ((14) * 16)), sizeof(sCaveTransitionPalette_White));
    LoadPalette(sCaveTransitionPalette_Exit, (0x000 + ((14) * 16)), sizeof(sCaveTransitionPalette_Exit));
    SetGpuReg(0x50, (1 << 0) | (1 << 6) | (1 << 9) | (1 << 10) | (1 << 11) | (1 << 12) | (1 << 13));
    SetGpuReg(0x52, 0);
    SetGpuReg(0x54, 0);
    SetGpuReg(0x8, (0) | ((3) << 2) | ((31) << 8));
    SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0100 | 0x1000);
...
static void Task_FlashTransition_Exit_3(u8 taskId)
{
    ...
    if (count < 8)
    {
        ...
        LoadPalette(&sCaveTransitionPalette_Exit[count], (0x000 + ((14) * 16)), sizeof(sCaveTransitionPalette_Exit) - ((count) * sizeof(u16)));
    }
    else
    {
        LoadPalette(sCaveTransitionPalette_White, (0x000 + ((0) * 16)), sizeof(sCaveTransitionPalette_White));
...
static void Task_FlashTransition_Enter_1(u8 taskId)
{
    ...
    SetGpuReg(0x0, 0x0000 | 0x0040 | 0x0100 | 0x1000);
    LoadPalette(sCaveTransitionPalette_White, (0x000 + ((14) * 16)), sizeof(sCaveTransitionPalette_White));
    LoadPalette(sCaveTransitionPalette_Black, (0x000 + ((0) * 16)), sizeof(sCaveTransitionPalette_Black));
...
static void Task_FlashTransition_Enter_2(u8 taskId)
{
    ...
    if (count < 16)
    {
        gTasks[taskId].data[2]++;
        gTasks[taskId].data[2]++;
        LoadPalette(&sCaveTransitionPalette_Enter[15 - count], (0x000 + ((14) * 16)), ((count + 1) * sizeof(u16)));
    }
    else
    {
        SetGpuReg(0x52, (16 << 8) + 16);
...
static void Task_MapPreviewScreen_0(u8 taskId)
{
    ...
    case 4:
        data[1]++;
        if (data[1] > data[2] || ({(gMain.heldKeys) & (0x0002);}))
        {
            BeginNormalPaletteFade((0x0000FFFF | 0xFFFF0000), -2, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
            data[0]++;
        }
        break;
    case 5:
