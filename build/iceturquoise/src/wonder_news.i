...
# 6 "src/wonder_news.c" 2
# 1 "include/constants/items.h" 1
# 7 "src/wonder_news.c" 2
# 15 "src/wonder_news.c"
...
void WonderNews_SetReward(u32 newsType)
{
    ...
    case WONDER_NEWS_RECV_WIRELESS:
        ...
        data->berry = (Random() % 15) + (((149 - 134) + 1));
        break;
    case WONDER_NEWS_SENT:

        data->berry = (Random() % 15) + (((134 - 134) + 1));
        break;
    }
}
...
void WonderNews_IncrementStepCounter(void)
{
    u16 *stepCounter = GetVarPointer(0x4028);
    struct WonderNewsMetadata *data = GetSavedWonderNewsMetadata();
...
static u32 GetRewardType(struct WonderNewsMetadata *data)
{
    ...
    case WONDER_NEWS_SENT:
        ...
        return 5;
    default:
        (0) ? ((void *)0) : AGBAssert(("C:/WORK/POKeFRLG/src/pm_lgfr_ose/source/" "menews_jisan.c"), 383, "0", 1);;
        return 0;
    }
}
