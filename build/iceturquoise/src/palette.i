...
__attribute__((aligned(4))) __attribute__((section("ewram_data"))) u16 gPlttBufferUnfaded[((0x200 + 0x200) / sizeof(u16))] = {0};
__attribute__((aligned(4))) __attribute__((section("ewram_data"))) u16 gPlttBufferFaded[((0x200 + 0x200) / sizeof(u16))] = {0};
static __attribute__((section("ewram_data"))) struct PaletteStruct sPaletteStructs[16] = {0};
...
__attribute__((section("ewram_data"))) u8 gPaletteDecompressionBuffer[(0x200 + 0x200)] = {0};
...
void TransferPlttBuffer(void)
{
    if (!gPaletteFade.bufferTransferDisabled)
    {
        ...
        { vu32 *dmaRegs = (vu32 *)(0x4000000 + 0xd4); dmaRegs[0] = (vu32)(src); dmaRegs[1] = (vu32)(dest); dmaRegs[2] = (vu32)((0x8000 | 0x0000 | 0x0000 | 0x0000 | 0x0000) << 16 | (((0x200 + 0x200))/(16/8))); dmaRegs[2]; };
...
void ReadPlttIntoBuffers(void)
{
    ...
    for (i = 0; i < ((0x200 + 0x200) / sizeof(u16)); ++i)
    {
...
bool8 BeginNormalPaletteFade(u32 selectedPalettes, s8 delay, u8 startY, u8 targetY, u16 blendColor)
{
    ...
    else
    {
        ...
        CpuSet(gPlttBufferFaded, (void *)0x5000000, 0x04000000 | (((0x200 + 0x200))/(32/8) & 0x1FFFFF));
        sPlttBufferTransferPending = 0;
        if (gPaletteFade.mode == HARDWARE_FADE && gPaletteFade.active)
            UpdateBlendRegisters();
...
{
    if (gPaletteFade.active && ((1 << (palStruct->baseDestOffset >> 4)) & (gPaletteFade.multipurpose1)))
    {
        if (!palStruct->template->pst_field_8_0)
        {
...
static void PaletteStruct_Reset(u8 paletteNum)
{
    ...
    sPaletteStructs[paletteNum].active = 0;
...
static void PaletteStruct_SetUnusedFlag(u16 id)
{
    u8 paletteNum = PaletteStruct_GetPalNum(id);
    if (paletteNum != 16)
        sPaletteStructs[paletteNum].flag = 1;
}
...
static void BeginFastPaletteFadeInternal(u8 submode)
{
    ...
    if (submode == FAST_FADE_IN_FROM_BLACK)
        { vu16 tmp = (vu16)(((0) | ((0) << 5) | ((0) << 10))); CpuSet((void *)&tmp, gPlttBufferFaded, 0x00000000 | 0x01000000 | (((0x200 + 0x200))/(16/8) & 0x1FFFFF)); };
    if (submode == FAST_FADE_IN_FROM_WHITE)
        { vu16 tmp = (vu16)(((31) | ((31) << 5) | ((31) << 10))); CpuSet((void *)&tmp, gPlttBufferFaded, 0x00000000 | 0x01000000 | (((0x200 + 0x200))/(16/8) & 0x1FFFFF)); };
    UpdatePaletteFade();
}
...
static u8 UpdateFastPaletteFade(void)
{
    ...
    if (gPaletteFade.objPaletteToggle)
    {
        ...
        paletteOffsetEnd = ((0x200 + 0x200) / sizeof(u16));
    }
    else
    {
    ...
    if (gPaletteFade.y == 0)
    {
        ...
        case FAST_FADE_IN_FROM_WHITE:
        case FAST_FADE_IN_FROM_BLACK:
            CpuSet(gPlttBufferUnfaded, gPlttBufferFaded, 0x04000000 | (((0x200 + 0x200))/(32/8) & 0x1FFFFF));
            break;
        case FAST_FADE_OUT_TO_WHITE:
            { vu32 tmp = (vu32)(0xFFFFFFFF); CpuSet((void *)&tmp, gPlttBufferFaded, 0x04000000 | 0x01000000 | (((0x200 + 0x200))/(32/8) & 0x1FFFFF)); };
            break;
        case FAST_FADE_OUT_TO_BLACK:
            { vu32 tmp = (vu32)(0x00000000); CpuSet((void *)&tmp, gPlttBufferFaded, 0x04000000 | 0x01000000 | (((0x200 + 0x200))/(32/8) & 0x1FFFFF)); };
            break;
        }
        gPaletteFade.mode = NORMAL_FADE;
        gPaletteFade.softwareFadeFinishing = 1;
...
void BlendPalettesUnfaded(u32 selectedPalettes, u8 coeff, u16 color)
{
    ...
    CpuFastSet(gPlttBufferUnfaded, gPlttBufferFaded, (((0x200 + 0x200))/(32/8) & 0x1FFFFF));
