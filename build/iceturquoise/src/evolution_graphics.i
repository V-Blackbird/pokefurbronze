...
{
    u16 i;
    for (i = 0; i < (sizeof(sEvolutionSparkleMatrixScales) / sizeof((sEvolutionSparkleMatrixScales)[0])); i++)
...
static void EvoTask_PreEvoSparkleSet1Init(u8 taskId)
{
    ...
    BeginNormalPaletteFade(3 << gTasks[taskId].data[1], 10, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
...
static void EvoTask_PostEvoSparklesSet2Init(u8 taskId)
{
    ...
    CpuSet(&gPlttBufferFaded[(0x000 + ((2) * 16))], &gPlttBufferUnfaded[(0x000 + ((2) * 16))], 0x00000000 | ((3 * ((16) * sizeof(u16)))/(16/8) & 0x1FFFFF));
    BeginNormalPaletteFade(0xFFF90F1C, 0, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
...
static void EvoTask_CreatePostEvoSparklesSet2(u8 taskId)
{
    ...
    if (gTasks[taskId].data[15] < 128)
    {
        ...
        case 0:
            ...
            break;
        case 32:
            BeginNormalPaletteFade(0xFFFF0F1C, 16, 16, 0, ((31) | ((31) << 5) | ((31) << 10)));
            break;
        }
        gTasks[taskId].data[15]++;
    }
...
static void EvoTask_PostEvoSparklesSet2TradeInit(u8 taskId)
{
    ...
    IsMovingBackgroundTaskRunning();
    CpuSet(&gPlttBufferFaded[(0x000 + ((2) * 16))], &gPlttBufferUnfaded[(0x000 + ((2) * 16))], 0x00000000 | ((3 * ((16) * sizeof(u16)))/(16/8) & 0x1FFFFF));
    BeginNormalPaletteFade(0xFFF90F00, 0, 0, 16, ((31) | ((31) << 5) | ((31) << 10)));
...
static void EvoTask_CreatePostEvoSparklesSet2Trade(u8 taskId)
{
    ...
    if (gTasks[taskId].data[15] < 128)
    {
        ...
        case 0:
            ...
            break;
        case 32:
            BeginNormalPaletteFade(0xFFFF0F00, 16, 16, 0, ((31) | ((31) << 5) | ((31) << 10)));
            break;
        }
        gTasks[taskId].data[15]++;
    }
...
u8 CycleEvolutionMonSprite(u8 preEvoSpriteId, u8 postEvoSpriteId)
{
    ...
    CpuSet(palette, &gPlttBufferFaded[(0x100 + ((gSprites[preEvoSpriteId].oam.paletteNum) * 16))], 0x00000000 | ((((16) * sizeof(u16)))/(16/8) & 0x1FFFFF));
    ...
    CpuSet(palette, &gPlttBufferFaded[(0x100 + ((gSprites[postEvoSpriteId].oam.paletteNum) * 16))], 0x00000000 | ((((16) * sizeof(u16)))/(16/8) & 0x1FFFFF));
