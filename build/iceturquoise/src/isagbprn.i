...
# 6 "src/isagbprn.c" 2
# 1 "include/mini_printf.h" 1
# 39 "include/mini_printf.h"
# 1 "include/gba/types.h" 1
# 40 "include/mini_printf.h" 2
# 48 "include/mini_printf.h"
...
void AGBPrintInit(void)
{
    struct AGBPrintStruct *pPrint = (struct AGBPrintStruct *)0x9FE20F8;
    u16 *pWSCNT = (u16 *)(0x4000000 + 0x204);
    u16 *pProtect = (u16 *)0x9FE2FFE;
...
{
    volatile struct AGBPrintStruct *pPrint = (struct AGBPrintStruct *)0x9FE20F8;
...
void AGBPutc(const char cChr)
{
    ...
    *pWSCNT = nOldWSCNT;
    pPrint = (struct AGBPrintStruct *)0x9FE20F8;
...
void AGBPrintf(const char *pBuf, ...)
{
    char bufPrint[0x100];
    va_list vArgv;
    (vArgv = ((__gnuc_va_list) __builtin_next_arg(pBuf)));
...
static void AGBPrintTransferDataInternal(u32 bAllData)
{
    ...
    pProtect = (u16 *)0x9FE2FFE;
    pPrint = (struct AGBPrintStruct *)0x9FE20F8;
    lpfnFuncFlush = (LPFN_PRINT_FLUSH)0x9FE209D;
    pIME = (u16 *)(0x4000000 + 0x208);
    nIME = *pIME;
    pWSCNT = (u16 *)(0x4000000 + 0x204);
    nOldWSCNT = *pWSCNT;
    *pIME = nIME & ~1;
    *pWSCNT = ((3 << 11) | (0 << 4) | (0 << 2));
...
void AGBPrintFlush1Block(void)
{
    AGBPrintTransferDataInternal(0);
}

void AGBPrintFlush(void)
{
    AGBPrintTransferDataInternal(1);
}
