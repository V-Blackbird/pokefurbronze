...
static void OpponentBufferRunCommand(void)
{
    ...
    {
        if (gBattleBufferA[gActiveBattler][0] < (sizeof(sOpponentBufferCommands) / sizeof((sOpponentBufferCommands)[0])))
...
static void Intro_WaitForShinyAnimAndHealthbox(void)
{
    ...
    if (IsCryPlayingOrClearCrySongs())
        var = 0;
    if (var && gBattleSpritesDataPtr->healthBoxesData[gActiveBattler].finishedShinyMonAnim && gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].finishedShinyMonAnim)
    {
...
static void Intro_TryShinyAnimShowHealthbox(void)
{
    ...
    if (!gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].triedShinyMonAnim && !gBattleSpritesDataPtr->healthBoxesData[gActiveBattler ^ 2].ballAnimActive)
...
static void CompleteOnHealthbarDone(void)
{
    ...
    {
        if (!BtlCtrl_OakOldMan_TestState2Flag(1) && (gBattleTypeFlags & (1 << 4)))
        {
