...
const u16 gObjectEventPic_RedNormal[] = INCBIN_U16("graphics/object_events/pics/people/dan_normal.4bpp");
...
const u32 gObjectEventPic_Blackbird[] = INCBIN_U32("graphics/object_events/pics/people/blckbrd.4bpp");
const u16 gObjectEventPal_Blackbird[] = INCBIN_U16("graphics/object_events/pics/people/blckbrd.gbapal");
const u32 gObjectEventPic_BlackbirdLyingDown[] = INCBIN_U32("graphics/object_events/pics/people/blckbrd_lying_down.4bpp");
const u16 gObjectEventPal_BlackbirdLyingDown[] = INCBIN_U16("graphics/object_events/pics/people/blckbrd_lying_down.gbapal");
const u32 gObjectEventPic_Red2[] = INCBIN_U32("graphics/object_events/pics/people/red_normal.4bpp");
const u16 gObjectEventPal_Dan[] = INCBIN_U16("graphics/object_events/pics/people/dan_normal.gbapal");
const u32 gObjectEventPic_MartTruck[] = INCBIN_U32("graphics/object_events/pics/misc/truck.4bpp");
const u16 gObjectEventPal_Truck[] = INCBIN_U16("graphics/object_events/pics/misc/truck.gbapal");
# 211 "src/event_object_movement.c" 2
...
# 461 "src/event_object_movement.c"
...
const struct SpriteFrameImage gObjectEventPicTable_Eevee[] = {
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 1 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 2 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 3 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 4 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 5 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 6 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 7 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Eevee + (4 * 4 * 8 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 3 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 4 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 5 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 6 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 7 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 8 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 9 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 10 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 11 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 12 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_EeveeSurfRun + (4 * 4 * 13 * 64)/2, .size = (4 * 4 * 64)/2},
};

const struct SpriteFrameImage gObjectEventPicTable_Glaceon[] = {
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 1 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 2 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 3 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 4 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 5 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 6 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 7 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Glaceon + (4 * 4 * 8 * 64)/2, .size = (4 * 4 * 64)/2},
};

static const struct SpriteFrameImage sPicTable_Blackbird[] = {
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 0 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 1 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 2 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 3 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 4 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 5 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 6 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 7 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 8 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Blackbird + (2 * 4 * 9 * 64)/2, .size = (2 * 4 * 64)/2},
};

static const struct SpriteFrameImage sPicTable_BlackbirdLyingDown[] = {
    {.data = (u8 *)gObjectEventPic_BlackbirdLyingDown + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_BlackbirdLyingDown + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_BlackbirdLyingDown + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_BlackbirdLyingDown + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_BlackbirdLyingDown + (4 * 4 * 0 * 64)/2, .size = (4 * 4 * 64)/2},
...
static const struct SpriteFrameImage sPicTable_Red2[] = {
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 0 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 1 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 2 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 3 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 4 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 5 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 6 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 7 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 8 * 64)/2, .size = (2 * 4 * 64)/2},
    {.data = (u8 *)gObjectEventPic_Red2 + (2 * 4 * 9 * 64)/2, .size = (2 * 4 * 64)/2},
};

const struct SpriteFrameImage gObjectEventPicTable_MartTruck[] = {
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 1 * 64)/2, .size = (8 * 8 * 64)/2},
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 1 * 64)/2, .size = (8 * 8 * 64)/2},
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 0 * 64)/2, .size = (8 * 8 * 64)/2},
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 1 * 64)/2, .size = (8 * 8 * 64)/2},
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 1 * 64)/2, .size = (8 * 8 * 64)/2},
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 1 * 64)/2, .size = (8 * 8 * 64)/2},
    {.data = (u8 *)gObjectEventPic_MartTruck + (8 * 8 * 1 * 64)/2, .size = (8 * 8 * 64)/2},
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Glaceon = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_32x32,
    .anims = sAnimTable_Standard,
    .images = gObjectEventPicTable_Glaceon,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Blackbird = {
    .tileTag = 0xFFFF,
    .paletteTag = 0x111E,
    .reflectionPaletteTag = 0x11FF,
    .size = 256,
...
const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_BlackbirdLyingDown = {
    ...
    .subspriteTables = gObjectEventSpriteOamTables_32x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_BlackbirdLyingDown,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_Red2 = {
    .tileTag = 0xFFFF,
    .paletteTag = 0x1100,
    .reflectionPaletteTag = 0x1102,
    .size = 512,
    ...
    .subspriteTables = gObjectEventSpriteOamTables_16x32,
    .anims = sAnimTable_Standard,
    .images = sPicTable_Red2,
    .affineAnims = gDummySpriteAffineAnimTable,
};

const struct ObjectEventGraphicsInfo gObjectEventGraphicsInfo_MartTruck = {
    .tileTag = 0xFFFF,
    .paletteTag = 0x1121,
    .reflectionPaletteTag = 0x11FF,
    .size = 512,
    ...
    .subspriteTables = gObjectEventSpriteOamTables_64x64,
    .anims = sAnimTable_Standard,
    .images = gObjectEventPicTable_MartTruck,
    .affineAnims = gDummySpriteAffineAnimTable,
};
...
const struct ObjectEventGraphicsInfo *const gObjectEventGraphicsInfoPointers[158] = {
    ...
    [152] = &gObjectEventGraphicsInfo_Eevee,
    [153] = &gObjectEventGraphicsInfo_Glaceon,
    [154] = &gObjectEventGraphicsInfo_Blackbird,
    [155] = &gObjectEventGraphicsInfo_BlackbirdLyingDown,
    [156] = &gObjectEventGraphicsInfo_Red2,
    [157] = &gObjectEventGraphicsInfo_MartTruck,
};
...
static const struct SpritePalette sObjectEventSpritePalettes[] = {
    ...
    {gObjectEventPal_Eevee, 0x111C},
    {gObjectEventPal_Glaceon, 0x111D},
    {gObjectEventPal_BlackbirdLyingDown, 0x111F},
    {gObjectEventPal_Blackbird, 0x111E},
    {gObjectEventPal_Dan, 0x1120},
    {gObjectEventPal_Truck, 0x1121},
    {},
};
...
# 499 "src/event_object_movement.c" 2
...
# 505 "src/event_object_movement.c" 2
...
# 1026 "src/event_object_movement.c" 2
...
void CopyObjectGraphicsInfoToSpriteTemplate(u16 graphicsId, void (*callback)(struct Sprite *), struct SpriteTemplate *spriteTemplate, const struct SubspriteTable **subspriteTables)
{
    ...
    do
    {
        if (ScriptContext_IsEnabled() != 1 && sub_8112CAC() == 1)
...
static void SpawnObjectEventOnReturnToField(u8 objectEventId, s16 x, s16 y)
{
    ...
    if (graphicsInfo->paletteSlot != 0xFFFF)
        LoadObjectEventPalette(spriteTemplate.paletteTag);
        UpdatePaletteGammaType(IndexOfSpritePaletteTag(spriteTemplate.paletteTag), GAMMA_ALT);
...
# 4895 "src/event_object_movement.c"
...
# 8892 "src/event_object_movement.c"
