# 0 "src/quest_log_player.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/quest_log_player.c"
...
static void (*const sQLGfxTransitions[])(void) = {
    [0] = QL_GfxTransition_Normal,
    [1] = QL_GfxTransition_Bike,
    [2] = QL_GfxTransition_Fish,
    [3] = QL_GfxTransition_StartSurf,
    [4] = QL_GfxTransition_StopSurfSouth,
    [5] = QL_GfxTransition_StopSurfNorth,
    [6] = QL_GfxTransition_StopSurfWest,
    [7] = QL_GfxTransition_StopSurfEast,
    [8] = QL_GfxTransition_VSSeeker
};

void QuestLogUpdatePlayerSprite(u8 state)
{
    if (state < (sizeof(sQLGfxTransitions) / sizeof((sQLGfxTransitions)[0])))
...
static void QL_GfxTransition_StartSurf(void)
{
    ...
    if (!(gPlayerAvatar.flags & (1 << PLAYER_AVATAR_STATE_SURFING)))
    {
        ...
        fieldEffectId = FieldEffectStart(8);
