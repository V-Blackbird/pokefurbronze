...
int ProcessPlayerFieldInput(struct FieldInput *input)
{
    ...
    if (input->tookStep)
    {
        ...
        {
            gInputToStoreInQuestLogMaybe.tookStep = 1;
            return 1;
        }
    }
    if (input->checkStandardWildEncounter)
    {
        if (input->dpadDirection == 0 || input->dpadDirection == playerDirection)
        {
            ...
            {
                gInputToStoreInQuestLogMaybe.checkStandardWildEncounter = 1;
                return 1;
            }
            GetPlayerPosition(&position);
            metatileBehavior = MapGridGetMetatileBehaviorAt(position.x, position.y);
    ...
    if (input->heldDirection && input->dpadDirection == playerDirection)
    {
        ...
        {
            gInputToStoreInQuestLogMaybe.heldDirection = 1;
            return 1;
        }
    }
    ...
    {
        gInputToStoreInQuestLogMaybe.pressedAButton = 1;
        return 1;
    }
    ...
    if (input->heldDirection2 && input->dpadDirection == playerDirection)
    {
        ...
        {
            gInputToStoreInQuestLogMaybe.heldDirection2 = 1;
            return 1;
        }
    }
    ...
    {
        gInputToStoreInQuestLogMaybe.pressedStartButton = 1;
        FlagSet(((((0x4FF + 1) + 768 - 1) + 1) + 0x3E));
        PlaySE(6);
        ShowStartMenu();
        return 1;
    }
    ...
    {
        gInputToStoreInQuestLogMaybe.pressedSelectButton = 1;
        return 1;
    }
...
static const u8 *GetInteractedWaterScript(struct MapPosition *unused1, u8 metatileBehavior, u8 direction)
{
    ...
    if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x24)) == 1 && PartyHasMonWithSurf() == 1 && IsPlayerFacingSurfableFishableWater() == 1)
        return EventScript_UseSurf;

    if (MetatileBehavior_IsWaterfall(metatileBehavior) == 1)
    {
        if (FlagGet(((((0x4FF + 1) + 768 - 1) + 1) + 0x26)) == 1 && IsPlayerSurfingNorth() == 1)
