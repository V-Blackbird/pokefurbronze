...
static __attribute__((section("ewram_data"))) struct ECWork * sEasyChatGraphicsResources = ((void *)0);
...
static const u8 *const sEasyChatKeyboardAlphabet[4] = {
...
static const u8 sAlphabetKeyboardColumnOffsets[7] = {0, 12, 24, 56, 68, 80, 92};
...
bool8 LoadEasyChatGraphics(void)
{
    ...
    case 0:
        ...
        InitBgsFromTemplates(0, sEasyChatBgTemplates, (sizeof(sEasyChatBgTemplates) / sizeof((sEasyChatBgTemplates)[0])));
        ...
        { vu32 tmp = (vu32)(0); CpuFastSet((void *)&tmp, (void *)0x6000000 + 0x1000000, 0x01000000 | ((0x400)/(32/8) & 0x1FFFFF)); };
        break;
    case 1:
    ...
    case 5:
        ...
        else
        {
            ...
            SetGpuReg(0x48, (((0) << 8) | (63)));
            SetGpuReg(0x4a, (((0) << 8) | (59)));
            ShowBg(3);
            ShowBg(1);
            ShowBg(2);
            ShowBg(0);
...
static bool8 ECInterfaceCmd_10(void)
{
    ...
    case 0:
        ...
        break;
    case 1:
        if (RunModeIconHidingAnimation() == 1)
            break;
...
static bool8 InitEasyChatGraphicsWork_Internal(void)
{
    ...
    if (sEasyChatGraphicsResources == ((void *)0))
        return 0;

    sEasyChatGraphicsResources->state = 0;
    sEasyChatGraphicsResources->selectDestFieldCursorSprite = ((void *)0);
    sEasyChatGraphicsResources->rectCursorSpriteRight = ((void *)0);
    sEasyChatGraphicsResources->rectCursorSpriteLeft = ((void *)0);
    sEasyChatGraphicsResources->selectWordCursorSprite = ((void *)0);
    sEasyChatGraphicsResources->selectGroupHelpSprite = ((void *)0);
    sEasyChatGraphicsResources->modeIconsSprite = ((void *)0);
    sEasyChatGraphicsResources->upTriangleCursorSprite = ((void *)0);
    sEasyChatGraphicsResources->downTriangleCursorSprite = ((void *)0);
    sEasyChatGraphicsResources->startPgUpButtonSprite = ((void *)0);
    sEasyChatGraphicsResources->selectPgDnButtonSprite = ((void *)0);
    return 1;
}
...
{
    ResetPaletteFade();
    LoadPalette(gEasyChatWindow_Pal, (0x000 + ((0) * 16)), ((16) * sizeof(u16)));
    LoadPalette(sTextInputFrameOrange_Pal, (0x000 + ((1) * 16)), sizeof(sTextInputFrameOrange_Pal));
    LoadPalette(sTextInputFrameGreen_Pal, (0x000 + ((4) * 16)), sizeof(sTextInputFrameGreen_Pal));
    LoadPalette(sTitleText_Pal, (0x000 + ((10) * 16)), sizeof(sTitleText_Pal));
    LoadPalette(sText_Pal, (0x000 + ((11) * 16)), sizeof(sText_Pal));
    LoadPalette(sText_Pal, (0x000 + ((15) * 16)), sizeof(sText_Pal));
    LoadPalette(sText_Pal, (0x000 + ((3) * 16)), sizeof(sText_Pal));
}
...
static void PrintTitleText(void)
{
    ...
    EC_AddTextPrinterParameterized2(0, FONT_NORMAL_COPY_1, titleText, xOffset, 0, 0xFF, 0x0, 0x2, 0x3);
    PutWindowTilemap(0);
...
static void PrintECInstructionsText(void)
{
    ...
    LoadUserWindowGfx(1, 1, (0x000 + ((14) * 16)));
...
static void PrintECInterfaceTextById(u8 direction)
{
    ...
    if (text1)
        EC_AddTextPrinterParameterized(1, FONT_NORMAL_COPY_1, text1, 0, 0, 0xFF, ((void *)0));

    if (text2)
        EC_AddTextPrinterParameterized(1, FONT_NORMAL_COPY_1, text2, 0, 16, 0xFF, ((void *)0));
...
static void PrintECFields(void)
{
    ...
    numRows = GetNumRows();
    frameId = GetEasyChatScreenFrameId();
    FillWindowPixelBuffer(sEasyChatGraphicsResources->windowId, ((1) | ((1) << 4)));
    for (i = 0; i < numRows; i++)
    {
        ...
        for (j = 0; j < numColumns; j++)
        {
            ...
            {
                str = WriteColorChangeControlCode(str, 0, 0x4);
                ecWord++;
                for (k = 0; k < 7; k++)
                {
                    *str++ = 0xF9;
                ...
                str = WriteColorChangeControlCode(str, 0, 0x2);
            }
        ...
        *str = 0xFF;
        EC_AddTextPrinterParameterized(sEasyChatGraphicsResources->windowId, FONT_NORMAL_COPY_1, sEasyChatGraphicsResources->ecPrintBuffer, 0, i * 16, 0xFF, ((void *)0));
    }
...
static void PrintECGroupsMenu(void)
{
    ...
    while (1)
    {
        for (x = 0; x < 2; x++)
        {
            ...
            EC_AddTextPrinterParameterized(2, FONT_NORMAL_COPY_1, GetEasyChatWordGroupName(groupId), x * 84 + 10, y, 0xFF, ((void *)0));
        }
...
static void PrintEasyChatKeyboardText(void)
{
    ...
    for (i = 0; i < (sizeof(sEasyChatKeyboardAlphabet) / sizeof((sEasyChatKeyboardAlphabet)[0])); i++)
        EC_AddTextPrinterParameterized(2, FONT_NORMAL_COPY_1, sEasyChatKeyboardAlphabet[i], 10, 96 + i * 16, 0xFF, ((void *)0));
}
    ...
    for (i = 0; i < remrow; i++)
    {
        for (j = 0; j < 2; j++)
        {
            ...
            if (easyChatWord != 0xFFFF)
            {
                ...
                EC_AddTextPrinterParameterized(2, FONT_NORMAL_COPY_1, sEasyChatGraphicsResources->ecPaddedWordBuffer, (j * 13 + 3) * 8, y_, 0xFF, ((void *)0));
            }
        }
        y += 16;
...
static void ClearECRowsWin2(u8 row, u8 remrow)
{
    ...
    FillWindowPixelRect(2, ((1) | ((1) << 4)), 0, y, 224, heightToBottom);
    if (heightWrappedAround)
        FillWindowPixelRect(2, ((1) | ((1) << 4)), 0, 0, 224, heightWrappedAround);
}
...
static void LoadSpriteGfx(void)
{
    ...
    for (i = 0; i < (sizeof(sEasyChatCompressedSpriteSheets) / sizeof((sEasyChatCompressedSpriteSheets)[0])); i++)
...
static void CreateRedRectangularCursorSpritePair(void)
{
    ...
    sEasyChatGraphicsResources->rectCursorSpriteRight->hFlip = 1;
    EC_MoveCursor();
}
...
static void MoveCursor_Alpha(s8 cursorX, s8 cursorY)
{
    ...
    if (cursorX != -1)
    {
        ...
        {
            x += sAlphabetKeyboardColumnOffsets[cursorX < (sizeof(sAlphabetKeyboardColumnOffsets) / sizeof((sAlphabetKeyboardColumnOffsets)[0])) ? cursorX : 0];
...
static void CreateVerticalScrollArrowSprites(void)
{
    ...
    if (spriteId != 64)
    {
        ...
        sEasyChatGraphicsResources->downTriangleCursorSprite->vFlip = 1;
    }
...
static void HideVerticalScrollArrowSprites(void)
{
    sEasyChatGraphicsResources->upTriangleCursorSprite->invisible = 1;
    sEasyChatGraphicsResources->downTriangleCursorSprite->invisible = 1;
}
...
static void HideStartSelectButtonSprites(void)
{
    sEasyChatGraphicsResources->startPgUpButtonSprite->invisible = 1;
    sEasyChatGraphicsResources->selectPgDnButtonSprite->invisible = 1;
}
...
static void CreateFooterWindow(void)
{
    ...
    EC_AddTextPrinterParameterized(windowId, FONT_NORMAL_COPY_1, gText_DelAllCancelOk, 0, 0, 0, ((void *)0));
