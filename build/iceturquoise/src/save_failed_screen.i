...
static __attribute__((section("ewram_data"))) u16 sSaveType = SAVE_NORMAL;
static __attribute__((section("ewram_data"))) u16 sUnused = 0;
static __attribute__((section("ewram_data"))) u8 sSaveFailedScreenState = 0;
...
{
    sIsInSaveFailedScreen = 0;
}

void DoSaveFailedScreen(u8 saveType)
{
    sSaveType = saveType;
    sIsInSaveFailedScreen = 1;
}
...
bool32 RunSaveFailedScreen(void)
{
    ...
    case 2:
        ...
        RequestDma3Copy(sSaveFailedScreenPals, (void *)0x5000000, 0x20, 0);
...
{
    int i;
    for (i = 0; i < 0x200; i += sizeof(u16))
    {
        *((u16 *)(0x5000000 + i)) = ((0) | ((0) << 5) | ((0) << 10));
        *((u16 *)((0x5000000 + 0x200) + i)) = ((0) | ((0) << 5) | ((0) << 10));
    }
}

static void RequestDmaCopyFromScreenBuffer(void)
{
    RequestDma3Copy(gDecompressionBuffer + 0x3800, (void *)(void *)(0x6000000 + (0x800 * (31))), 0x500, 0);
}

static void RequestDmaCopyFromCharBuffer(void)
{
    RequestDma3Copy(gDecompressionBuffer + 0x020, (void *)(void *)(0x6000000 + (0x4000 * (3))) + 0x20, 0x2300, 0);
}
...
static void PrintTextOnSaveFailedScreen(const u8 *str)
{
    ...
    { vu16 tmp = (vu16)(((1) | ((1) << 4)) | (((1) | ((1) << 4)) << 8)); CpuSet((void *)&tmp, gDecompressionBuffer + 0x20, 0x00000000 | 0x01000000 | ((0x2300)/(16/8) & 0x1FFFFF)); };
