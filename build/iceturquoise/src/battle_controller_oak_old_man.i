# 0 "src/battle_controller_oak_old_man.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "src/battle_controller_oak_old_man.c"
...
# 2 "src/battle_controller_oak_old_man.c" 2
# 1 "include/gflib.h" 1
...
# 3 "src/battle_controller_oak_old_man.c" 2
# 1 "include/task.h" 1
# 13 "include/task.h"
...
# 4 "src/battle_controller_oak_old_man.c" 2
...
# 5 "src/battle_controller_oak_old_man.c" 2
...
# 6 "src/battle_controller_oak_old_man.c" 2
# 1 "include/util.h" 1
...
# 7 "src/battle_controller_oak_old_man.c" 2
# 1 "include/m4a.h" 1
...
# 8 "src/battle_controller_oak_old_man.c" 2
# 1 "include/link.h" 1
# 110 "include/link.h"
enum {
    BLOCK_REQ_SIZE_NONE,
...
# 9 "src/battle_controller_oak_old_man.c" 2
# 1 "include/item.h" 1
...
# 10 "src/battle_controller_oak_old_man.c" 2
...
# 11 "src/battle_controller_oak_old_man.c" 2
...
extern const u8 gText_PokeSum_EggOrigin_Trade[];
# 12 "src/battle_controller_oak_old_man.c" 2
...
# 13 "src/battle_controller_oak_old_man.c" 2
...
# 14 "src/battle_controller_oak_old_man.c" 2
...
# 15 "src/battle_controller_oak_old_man.c" 2
...
# 16 "src/battle_controller_oak_old_man.c" 2
...
# 17 "src/battle_controller_oak_old_man.c" 2
...
# 18 "src/battle_controller_oak_old_man.c" 2
# 1 "include/constants/songs.h" 1
# 19 "src/battle_controller_oak_old_man.c" 2
# 1 "include/constants/items.h" 1
# 20 "src/battle_controller_oak_old_man.c" 2
...
static void OakOldManBufferRunCommand(void)
{
    ...
    {
        if (gBattleBufferA[gActiveBattler][0] < (sizeof(sOakOldManBufferCommands) / sizeof((sOakOldManBufferCommands)[0])))
...
static void HandleInputChooseAction(void)
{
    ...
    if (({(gMain.newKeys) & (0x0001);}))
    {
...

        {
            ...
            {
            case 0:
                BtlController_EmitTwoReturnValues(1, 14, 0);
                break;
            case 1:
                BtlController_EmitTwoReturnValues(1, 1, 0);
                break;
            case 2:
                BtlController_EmitTwoReturnValues(1, 15, 0);
                break;
            case 3:
                BtlController_EmitTwoReturnValues(1, 16, 0);
                break;
            }
            OakOldManBufferExecCompleted();
        }
...
static void CompleteWhenChoseItem(void)
{
    if (gMain.callback2 == BattleMainCB2 && !gPaletteFade.active)
    {
        if (!BtlCtrl_OakOldMan_TestState2Flag(0x4)
         && gSpecialVar_ItemId == 14
         && gBattleTypeFlags & (1 << 4))
        {
            BtlCtrl_OakOldMan_SetState2Flag(0x4);
...
static void PrintOakText_ForPetesSake(void)
{
    ...
    case 0:
        if (!gPaletteFade.active)
        {
            DoLoadHealthboxPalsForLevelUp(&gBattleStruct->simulatedInputState[1], &gBattleStruct->simulatedInputState[3], GetBattlerAtPosition(1));
    ...
    case 8:
        if (!gPaletteFade.active)
        {
            DoFreeHealthboxPalsForLevelUp(GetBattlerAtPosition(1));
...
static u32 CopyOakOldManMonData(u8 monId, u8 *dst)
{
    ...
    case REQUEST_ALL_BATTLE:
        ...
        battleMon.isEgg = GetMonData(&gPlayerParty[monId], 45);
    ...
    case REQUEST_MOVE4_BATTLE:
        data16 = GetMonData(&gPlayerParty[monId], 13 + gBattleBufferA[gActiveBattler][1] - REQUEST_MOVE1_BATTLE);
        dst[0] = data16;
        dst[1] = data16 >> 8;
        size = 2;
        break;
    ...
    case REQUEST_PPMOVE4_BATTLE:
        dst[0] = GetMonData(&gPlayerParty[monId], 17 + gBattleBufferA[gActiveBattler][1] - REQUEST_PPMOVE1_BATTLE);
        size = 1;
        break;
...
static void SetOakOldManMonData(u8 monId)
{
    ...
    case REQUEST_ALL_BATTLE:
        {
            ...
            SetMonData(&gPlayerParty[monId], 11, &battlePokemon->species);
        ...
        break;
    case REQUEST_SPECIES_BATTLE:
        SetMonData(&gPlayerParty[monId], 11, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_HELDITEM_BATTLE:
        SetMonData(&gPlayerParty[monId], 12, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_MOVES_PP_BATTLE:
        for (i = 0; i < 4; ++i)
        {
    ...
    case REQUEST_MOVE3_BATTLE:
    case REQUEST_MOVE4_BATTLE:
        SetMonData(&gPlayerParty[monId], 13 + gBattleBufferA[gActiveBattler][1] - REQUEST_MOVE1_BATTLE, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_PP_DATA_BATTLE:
        SetMonData(&gPlayerParty[monId], 17, &gBattleBufferA[gActiveBattler][3]);
        SetMonData(&gPlayerParty[monId], 18, &gBattleBufferA[gActiveBattler][4]);
        SetMonData(&gPlayerParty[monId], 19, &gBattleBufferA[gActiveBattler][5]);
        SetMonData(&gPlayerParty[monId], 20, &gBattleBufferA[gActiveBattler][6]);
        SetMonData(&gPlayerParty[monId], 21, &gBattleBufferA[gActiveBattler][7]);
        break;
    case REQUEST_PPMOVE1_BATTLE:
    case REQUEST_PPMOVE2_BATTLE:
    case REQUEST_PPMOVE3_BATTLE:
    case REQUEST_PPMOVE4_BATTLE:
        SetMonData(&gPlayerParty[monId], 17 + gBattleBufferA[gActiveBattler][1] - REQUEST_PPMOVE1_BATTLE, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_OTID_BATTLE:
        SetMonData(&gPlayerParty[monId], 1, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_EXP_BATTLE:
        SetMonData(&gPlayerParty[monId], 25, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_HP_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 26, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 27, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 28, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 29, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 30, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_EV_BATTLE:
        SetMonData(&gPlayerParty[monId], 31, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_FRIENDSHIP_BATTLE:
        SetMonData(&gPlayerParty[monId], 32, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_POKERUS_BATTLE:
        SetMonData(&gPlayerParty[monId], 34, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_LOCATION_BATTLE:
        SetMonData(&gPlayerParty[monId], 35, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_LEVEL_BATTLE:
        SetMonData(&gPlayerParty[monId], 36, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_MET_GAME_BATTLE:
        SetMonData(&gPlayerParty[monId], 37, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_POKEBALL_BATTLE:
        SetMonData(&gPlayerParty[monId], 38, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_ALL_IVS_BATTLE:
        SetMonData(&gPlayerParty[monId], 39, &gBattleBufferA[gActiveBattler][3]);
        SetMonData(&gPlayerParty[monId], 40, &gBattleBufferA[gActiveBattler][4]);
        SetMonData(&gPlayerParty[monId], 41, &gBattleBufferA[gActiveBattler][5]);
        SetMonData(&gPlayerParty[monId], 42, &gBattleBufferA[gActiveBattler][6]);
        SetMonData(&gPlayerParty[monId], 43, &gBattleBufferA[gActiveBattler][7]);
        SetMonData(&gPlayerParty[monId], 44, &gBattleBufferA[gActiveBattler][8]);
        break;
    case REQUEST_HP_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 39, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 40, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 41, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 42, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 43, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_IV_BATTLE:
        SetMonData(&gPlayerParty[monId], 44, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_PERSONALITY_BATTLE:
        SetMonData(&gPlayerParty[monId], 0, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_CHECKSUM_BATTLE:
        SetMonData(&gPlayerParty[monId], 9, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_STATUS_BATTLE:
        SetMonData(&gPlayerParty[monId], 55, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_LEVEL_BATTLE:
        SetMonData(&gPlayerParty[monId], 56, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_HP_BATTLE:
        SetMonData(&gPlayerParty[monId], 57, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_MAX_HP_BATTLE:
        SetMonData(&gPlayerParty[monId], 58, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_ATK_BATTLE:
        SetMonData(&gPlayerParty[monId], 59, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_DEF_BATTLE:
        SetMonData(&gPlayerParty[monId], 60, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPEED_BATTLE:
        SetMonData(&gPlayerParty[monId], 61, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPATK_BATTLE:
        SetMonData(&gPlayerParty[monId], 62, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SPDEF_BATTLE:
        SetMonData(&gPlayerParty[monId], 63, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_COOL_BATTLE:
        SetMonData(&gPlayerParty[monId], 22, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_BEAUTY_BATTLE:
        SetMonData(&gPlayerParty[monId], 23, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_CUTE_BATTLE:
        SetMonData(&gPlayerParty[monId], 24, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SMART_BATTLE:
        SetMonData(&gPlayerParty[monId], 33, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_TOUGH_BATTLE:
        SetMonData(&gPlayerParty[monId], 47, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SHEEN_BATTLE:
        SetMonData(&gPlayerParty[monId], 48, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_COOL_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 50, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_BEAUTY_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 51, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_CUTE_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 52, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_SMART_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 53, &gBattleBufferA[gActiveBattler][3]);
        break;
    case REQUEST_TOUGH_RIBBON_BATTLE:
        SetMonData(&gPlayerParty[monId], 54, &gBattleBufferA[gActiveBattler][3]);
        break;
    }
    HandleLowHpMusicChange(&gPlayerParty[gBattlerPartyIndexes[gActiveBattler]], gActiveBattler);
}
...
static void OakOldManHandlePrintString(void)
{
    ...
    if (gBattleTypeFlags & (1 << 9) && *stringId == 1)
    {
        OakOldManBufferExecCompleted();
    }
    else if (gBattleTypeFlags & (1 << 20) && *stringId == 1)
    {
        OakOldManBufferExecCompleted();
    }
    else
    {
        ...
        if (gBattleTypeFlags & (1 << 4))
        {
            ...
            {
            case 216:
                if (!BtlCtrl_OakOldMan_TestState2Flag(0x2))
                {
                    BtlCtrl_OakOldMan_SetState2Flag(0x2);
...
static void OakOldManHandleIntroTrainerBallThrow(void)
{
    ...
    if (gBattleTypeFlags & (1 << 4))
    {
        ...
        LoadCompressedPalette(gTrainerBackPicPaletteTable[gSaveBlock2Ptr->playerGender].data, (0x100 + ((paletteNum) * 16)), ((16) * sizeof(u16)));
...
void BtlCtrl_DrawVoiceoverMessageFrame(void)
{
    ...
    FillBgTilemapBufferRect(0, (0x800 + (0x3A)), 0, 0x11, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x3B)), 1, 0x11, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x3C)), 0x1C, 0x11, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x3D)), 0x1D, 0x11, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x35)), 0, 0x12, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x36)), 1, 0x12, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x38)), 0x1C, 0x12, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x39)), 0x1D, 0x12, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x30)), 0, 0x13, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x31)), 1, 0x13, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x32)), 2, 0x13, width, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x33)), 0x1C, 0x13, 1, 1, pal);
    FillBgTilemapBufferRect(0, (0x800 + (0x34)), 0x1D, 0x13, 1, 1, pal);
}
