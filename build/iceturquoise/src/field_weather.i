...
# 1 "include/field_weather_util.h" 1
...
static __attribute__((section("ewram_data"))) struct Weather sWeather = {};
static __attribute__((section("ewram_data"))) u8 sFieldEffectPaletteGammaTypes[32] = {};
static __attribute__((section("ewram_data"))) const u8 *sPaletteGammaTypes = ((void *)0);
static __attribute__((section("ewram_data"))) u16 sDroughtFrameDelay = 0;
...
__attribute__((section("ewram_data"))) u8 sBasePaletteGammaTypes[32] = {
...
void StartWeather(void)
{
    ...
    {
        u8 index = 15;
        CpuSet(gDefaultWeatherSpritePalette, &gPlttBufferUnfaded[(0x100 + ((index) * 16))], 0x04000000 | ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
...
void UpdateSpritePaletteWithWeather(u8 spritePaletteIndex)
{
    ...
    case 2:
        paletteIndex = ((paletteIndex) * 16);
        CpuFastSet(&gPlttBufferFaded[paletteIndex], &gPlttBufferUnfaded[paletteIndex], ((((16) * sizeof(u16)))/(32/8) & 0x1FFFFF));
...
void SlightlyDarkenPalsInWeather(u16 *palbuf, u16 *unused, u32 size)
{
    ...
    case 11:
    case 13:
        BlendPalettesAt(palbuf, ((0) | ((0) << 5) | ((0) << 10)), 3, size);
        break;
    }
}
