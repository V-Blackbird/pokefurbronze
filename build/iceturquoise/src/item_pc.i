...
static __attribute__((section("ewram_data"))) struct ItemPcResources * sStateDataPtr = ((void *)0);
static __attribute__((section("ewram_data"))) u8 * sBg1TilemapBuffer = ((void *)0);
static __attribute__((section("ewram_data"))) struct ListMenuItem * sListMenuItems = ((void *)0);
static __attribute__((section("ewram_data"))) u8 * sUnusedStringAllocation = ((void *)0);
static __attribute__((section("ewram_data"))) struct ItemPcStaticResources sListMenuState = {};
static __attribute__((section("ewram_data"))) u8 sSubmenuWindowIds[3] = {};
...
void ItemPc_Init(u8 kind, MainCallback callback)
{
    ...
    if ((sStateDataPtr = Alloc(sizeof(struct ItemPcResources))) == ((void *)0))
    {
        SetMainCallback2(callback);
        return;
    }
...
static bool8 ItemPc_LoadGraphics(void)
{
    ...
    case 1:
        ...
        break;
    case 2:
        LoadCompressedPalette(gItemPcBgPals, (0x000 + ((0) * 16)), 3 * ((16) * sizeof(u16)));
        sStateDataPtr->data[0]++;
        break;
    case 3:
...
static bool8 ItemPc_AllocateResourcesForListMenu(void)
{
    ({ void ** ptr = (void **)&(sListMenuItems); *ptr = Alloc(sizeof(struct ListMenuItem) * (30 + 1)); if (*ptr == ((void *)0)) { ItemPc_FreeResources(); ItemPc_FadeAndBail(); return 0; } });
    ({ void ** ptr = (void **)&(sUnusedStringAllocation); *ptr = Alloc(14 * (30 + 1)); if (*ptr == ((void *)0)) { ItemPc_FreeResources(); ItemPc_FadeAndBail(); return 0; } });
    return 1;
}
...
static void ItemPc_MoveCursorFunc(s32 itemIndex, bool8 onInit, struct ListMenu * list)
{
    ...
    if (sStateDataPtr->moveModeOrigPos == 0xFF)
    {
        ...
        {
            CreateItemMenuIcon(376, sStateDataPtr->itemMenuIconSlot);
...
static void ItemPc_FreeResources(void)
{
    ({ void ** ptr__ = (void **)&(sStateDataPtr); if (*ptr__ != ((void *)0)) Free(*ptr__); });
    ({ void ** ptr__ = (void **)&(sBg1TilemapBuffer); if (*ptr__ != ((void *)0)) Free(*ptr__); });
    ({ void ** ptr__ = (void **)&(sListMenuItems); if (*ptr__ != ((void *)0)) Free(*ptr__); });
    ({ void ** ptr__ = (void **)&(sUnusedStringAllocation); if (*ptr__ != ((void *)0)) Free(*ptr__); });
...
static void Task_ItemPcTurnOff2(u8 taskId)
{
    ...
    if (!gPaletteFade.active && !IsPCScreenEffectRunning_TurnOff())
    {
        ...
        if (sStateDataPtr->savedCallback != ((void *)0))
...
static void ItemPc_CountPcItems(void)
{
    ...
    for (i = 0; i < 30; sStateDataPtr->nItems++, i++)
    {
...
static void ItemPc_DoWithdraw(u8 taskId)
{
    ...
    if (AddBagItem(itemId, data[8]) == 1)
    {
        ItemUse_SetQuestLogEvent(29, ((void *)0), itemId, 0xFFFF);
        CopyItemName(itemId, gStringVar1);
        ConvertIntToDecimalStringN(gStringVar2, data[8], STR_CONV_MODE_LEFT_ALIGN, 3);
        StringExpandPlaceholders(gStringVar4, gText_WithdrewQuantItem);
        windowId = ItemPc_GetOrCreateSubwindow(2);
        AddTextPrinterParameterized(windowId, FONT_NORMAL, gStringVar4, 0, 2, 0, ((void *)0));
        gTasks[taskId].func = Task_ItemPcWaitButtonAndFinishWithdrawMultiple;
    }
    else
    {
        windowId = ItemPc_GetOrCreateSubwindow(2);
        AddTextPrinterParameterized(windowId, FONT_NORMAL, gText_NoMoreRoomInBag, 0, 2, 0, ((void *)0));
...
static void ItemPc_WithdrawMultipleInitWindow(u16 slotId)
{
    ...
    AddTextPrinterParameterized(ItemPc_GetOrCreateSubwindow(1), FONT_NORMAL, gStringVar4, 0, 2, 0, ((void *)0));
...
{
    FillWindowPixelRect(3, ((1) | ((1) << 4)), 10, 10, 28, 12);
...
static void ItemPc_InitWindows(void)
{
    ...
    LoadUserWindowGfx(0, 0x3C0, (0x000 + ((14) * 16)));
    LoadStdWindowGfx(0, 0x3A3, (0x000 + ((12) * 16)));
    LoadMenuMessageWindowGfx(0, 0x3AC, (0x000 + ((11) * 16)));
...
static void unused_ItemPc_AddTextPrinterParameterized(u8 windowId, const u8 * string, u8 x, u8 y, u8 letterSpacing, u8 lineSpacing, u8 speed)
{
    ...
    AddTextPrinter(&template, speed, ((void *)0));
}
...
static void ItemPc_SetBorderStyleOnWindow(u8 windowId)
{
    DrawStdFrameWithCustomTileAndPalette(windowId, 0, 0x3C0, 14);
}
...
static u8 ItemPc_GetOrCreateSubwindow(u8 idx)
{
    if (sSubmenuWindowIds[idx] == 0xFF)
    {
        ...
        DrawStdFrameWithCustomTileAndPalette(sSubmenuWindowIds[idx], 1, 0x3A3, 12);
    }
...
static void ItemPc_DestroySubwindow(u8 idx)
{
    ClearStdWindowAndFrameToTransparent(sSubmenuWindowIds[idx], 0);
    ClearWindowTilemap(sSubmenuWindowIds[idx]);
