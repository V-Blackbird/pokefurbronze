static const struct HealLocation sSpawnPoints[] =
{
    ...
    [SPAWN_KAILO_TOWN - 1] = {MAP_GROUP(MAP_KAILO_TOWN), MAP_NUM(MAP_KAILO_TOWN), 21, 18},
    [SPAWN_HOME - 1] = {MAP_GROUP(MAP_KAILO_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(MAP_KAILO_TOWN_PLAYERS_HOUSE_2F), 1, 5},
};
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_KAILO_TOWN - 1] = {MAP_GROUP(MAP_KAILO_TOWN_POKEMON_CENTER_1F), MAP_NUM(MAP_KAILO_TOWN_POKEMON_CENTER_1F)},
    [SPAWN_HOME - 1] = {MAP_GROUP(MAP_KAILO_TOWN_PLAYERS_HOUSE_2F), MAP_NUM(MAP_KAILO_TOWN_PLAYERS_HOUSE_2F)},
};
