const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(VILL, gMonPalette_Glaceon),
    SPECIES_PAL(MARIE, gMonPalette_Eevee),
    SPECIES_PAL(MARIEF, gMonPalette_Flareon),
    SPECIES_PAL(GILAN, gMonPalette_Eevee),
    SPECIES_PAL(GILANG, gMonPalette_Glaceon),
    SPECIES_PAL(EVEREST, gMonPalette_Eevee),
    SPECIES_PAL(EVERESTL, gMonPalette_Leafeon),
