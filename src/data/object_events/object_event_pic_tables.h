...
const struct SpriteFrameImage gObjectEventPicTable_Glaceon[] = {
    ...
    overworld_frame(gObjectEventPic_Glaceon, 4, 4, 6),
    overworld_frame(gObjectEventPic_Glaceon, 4, 4, 7),
    overworld_frame(gObjectEventPic_Glaceon, 4, 4, 8),
};

static const struct SpriteFrameImage sPicTable_Blackbird[] = {
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 0),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 1),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 2),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 3),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 4),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 5),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 6),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 7),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 8),
    overworld_frame(gObjectEventPic_Blackbird, 2, 4, 9),
};

static const struct SpriteFrameImage sPicTable_BlackbirdLyingDown[] = {
    overworld_frame(gObjectEventPic_BlackbirdLyingDown, 4, 4, 0),
    overworld_frame(gObjectEventPic_BlackbirdLyingDown, 4, 4, 0),
    overworld_frame(gObjectEventPic_BlackbirdLyingDown, 4, 4, 0),
    overworld_frame(gObjectEventPic_BlackbirdLyingDown, 4, 4, 0),
    overworld_frame(gObjectEventPic_BlackbirdLyingDown, 4, 4, 0),
...
static const struct SpriteFrameImage sPicTable_Red2[] = {
    overworld_frame(gObjectEventPic_Red2, 2, 4, 0),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 1),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 2),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 3),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 4),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 5),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 6),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 7),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 8),
    overworld_frame(gObjectEventPic_Red2, 2, 4, 9),
};
...
const struct SpriteFrameImage gObjectEventPicTable_MartTruck[] = {
    ...
    overworld_frame(gObjectEventPic_MartTruck, 8, 8, 0), // west walk 2
};
