...
const u8 gCharizardPokedexText[] = _(
    "It spits fire that is hot enough to\n"
    "melt boulders. It may cause forest\n"
    "fires by blowing flames.");
const u8 gCharizardPokedexTextUnused[] = _("");
const u8 gSquirtlePokedexText[] = _(
    "After birth, its back swells and\n"
    "hardens into a shell. It powerfully\n"
...
const u8 gMetapodPokedexText[] = _(
    ...
    "while its shell is soft, exposing its\n"
...
const u8 gButterfreePokedexText[] = _(
    ...
    "speed to release highly toxic dust\n"
    "into the air.");
...
const u8 gKakunaPokedexText[] = _(
    "Almost incapable of moving, this\n"
    "POKéMON can only harden its shell to\n"
    "protect itself when it is in danger.");
const u8 gKakunaPokedexTextUnused[] = _("");
const u8 gBeedrillPokedexText[] = _(
    "It flies at high speed and attacks\n"
    "using the large venomous stingers on\n"
...
const u8 gPidgeyPokedexText[] = _(
    ...
    "It flaps its wings at ground level to\n"
...
const u8 gRattataPokedexText[] = _(
    "Bites anything when it attacks. Small\n"
    "and very quick, it is a common sight\n"
    "in many places.");
...
const u8 gNidoranFPokedexText[] = _(
    ...
    "render this POKéMON dangerous. The\n"
...
const u8 gNidoqueenPokedexText[] = _(
    "Its hard scales provide strong\n"
    "protection. It uses its hefty bulk to\n"
...
const u8 gGolbatPokedexText[] = _(
    "Once it bites, it will not stop\n"
    "draining energy from the victim even\n"
    "if it gets too heavy to fly.");
const u8 gGolbatPokedexTextUnused[] = _("");
const u8 gOddishPokedexText[] = _(
    "During the day, it keeps its face\n"
    "buried in the ground. At night, it\n"
    "wanders around sowing its seeds.");
const u8 gOddishPokedexTextUnused[] = _("");
const u8 gGloomPokedexText[] = _(
    "The fluid that oozes from its mouth\n"
    "isn't drool. It is a nectar that is\n"
...
const u8 gVenonatPokedexText[] = _(
    "Lives in the shadows of tall trees\n"
    "where it eats bugs. It is attracted by\n"
    "light at night.");
const u8 gVenonatPokedexTextUnused[] = _("");
const u8 gVenomothPokedexText[] = _(
    "The dustlike scales covering its wings\n"
    "are color-coded to indicate the kinds\n"
    "of poison it has.");
const u8 gVenomothPokedexTextUnused[] = _("");
const u8 gDiglettPokedexText[] = _(
    "Lives about one yard underground where\n"
    "it feeds on plant roots. It sometimes\n"
    "appears aboveground.");
const u8 gDiglettPokedexTextUnused[] = _("");
const u8 gDugtrioPokedexText[] = _(
    "A team of DIGLETT triplets. It\n"
    "triggers huge earthquakes by burrowing\n"
...
const u8 gPersianPokedexText[] = _(
    "Although its fur has many admirers, it\n"
    "is tough to raise as a pet because of\n"
    "its fickle meanness.");
const u8 gPersianPokedexTextUnused[] = _("");
const u8 gPsyduckPokedexText[] = _(
    "While lulling its enemies with its\n"
...
const u8 gGolduckPokedexText[] = _(
    ...
    "lakeshores. It is often mistaken for\n"
...
const u8 gGrowlithePokedexText[] = _(
    "It is very protective of its\n"
    "territory. It will bark and bite to\n"
...
const u8 gPoliwhirlPokedexText[] = _(
    "It can live in or out of water. When\n"
    "out of water, it constantly sweats to\n"
    "keep its body slimy.");
const u8 gPoliwhirlPokedexTextUnused[] = _("");
const u8 gPoliwrathPokedexText[] = _(
    "A swimmer adept at both the front\n"
    "crawl and breaststroke. Easily\n"
...
const u8 gBellsproutPokedexText[] = _(
    "A carnivorous POKéMON that traps and\n"
    "eats bugs. It appears to use its root\n"
    "feet to replenish moisture.");
const u8 gBellsproutPokedexTextUnused[] = _("");
const u8 gWeepinbellPokedexText[] = _(
    "It spits out POISONPOWDER to\n"
    "immobilize the enemy and then finishes\n"
...
const u8 gTentacoolPokedexText[] = _(
    "Drifts in shallow seas. Anglers who\n"
    "hook them by accident are often\n"
    "punished by their stingers.");
...
const u8 gGeodudePokedexText[] = _(
    ...
    "Mistaking them for boulders, people\n"
    "often step or trip on them.");
const u8 gGeodudePokedexTextUnused[] = _("");
const u8 gGravelerPokedexText[] = _(
    "Rolls down slopes to move. It rolls\n"
    "over any obstacle without slowing or\n"
    "changing its direction.");
const u8 gGravelerPokedexTextUnused[] = _("");
const u8 gGolemPokedexText[] = _(
    "Its boulder-like body is extremely\n"
    "hard. It can easily withstand dynamite\n"
    "blasts without taking damage.");
...
const u8 gRapidashPokedexText[] = _(
    "Very competitive, this POKéMON will\n"
    "chase anything that moves fast in the\n"
    "hopes of racing it.");
const u8 gRapidashPokedexTextUnused[] = _("");
const u8 gSlowpokePokedexText[] = _(
    "Incredibly slow and dopey. It takes\n"
    "five seconds for it to feel pain when\n"
    "under attack.");
...
const u8 gElectrodePokedexText[] = _(
    "It stores electric energy under very\n"
    "high pressure. It often explodes with\n"
...
const u8 gHitmonchanPokedexText[] = _(
    "While apparently doing nothing, it\n"
...
const u8 gKoffingPokedexText[] = _(
    "Because it stores several kinds of\n"
    "toxic gases in its body, it is prone\n"
...
const u8 gChanseyPokedexText[] = _(
    "A rare and elusive POKéMON that is\n"
    "said to bring happiness to those who\n"
    "manage to catch one.");
const u8 gChanseyPokedexTextUnused[] = _("");
const u8 gTangelaPokedexText[] = _(
    "The whole body is swathed with wide\n"
    "vines that are similar to seaweed. The\n"
    "vines sway as it walks.");
...
const u8 gMagmarPokedexText[] = _(
    "Its body always burns with an orange\n"
    "glow that enables it to hide perfectly\n"
    "amidst flames.");
...
const u8 gTaurosPokedexText[] = _(
    ...
    "furiously while whipping its body with\n"
    "its long tails.");
...
const u8 gGyaradosPokedexText[] = _(
    "Rarely seen in the wild. Huge and\n"
    "vicious, it is capable of destroying\n"
...
const u8 gLaprasPokedexText[] = _(
    ...
    "almost to extinction. It can ferry\n"
    "people on its back.");
const u8 gLaprasPokedexTextUnused[] = _("");
const u8 gDittoPokedexText[] = _(
    "Capable of copying an opponent's\n"
    "genetic code to instantly transform\n"
...
const u8 gFlareonPokedexText[] = _(
    "When storing thermal energy in its\n"
    "body, its temperature can soar to over\n"
...
const u8 gPorygonPokedexText[] = _(
    ...
    "programming code. It is capable of\n"
...
const u8 gOmanytePokedexText[] = _(
    ...
    "it can be genetically regenerated from\n"
    "fossils.");
const u8 gOmanytePokedexTextUnused[] = _("");
const u8 gOmastarPokedexText[] = _(
    "Despite having strong fangs and\n"
    "tentacles, it went extinct when its\n"
    "heavy shell made it unable to catch\n"
    "prey.");
const u8 gOmastarPokedexTextUnused[] = _("");
const u8 gKabutoPokedexText[] = _(
    "A POKéMON that was regenerated from a\n"
    "fossil found in what was once the\n"
    "ocean floor long ago.");
const u8 gKabutoPokedexTextUnused[] = _("");
const u8 gKabutopsPokedexText[] = _(
    "Its sleek shape is perfect for\n"
    "swimming. It slashes prey with its\n"
    "claws and drains their fluids.");
...
const u8 gSnorlaxPokedexText[] = _(
    "Very lazy. Just eats and sleeps. As\n"
    "its rotund bulk builds, it becomes\n"
    "steadily more slothful.");
const u8 gSnorlaxPokedexTextUnused[] = _("");
const u8 gArticunoPokedexText[] = _(
    "A legendary bird POKéMON that is said\n"
    "to appear to doomed people who are\n"
    "lost in icy mountains.");
const u8 gArticunoPokedexTextUnused[] = _("");
const u8 gZapdosPokedexText[] = _(
    "A legendary bird POKéMON that is said\n"
    "to appear from clouds while dropping\n"
...
const u8 gMoltresPokedexText[] = _(
    ...
    "POKéMON of fire. Every flap of its\n"
    "wings creates a dazzling flare of\n"
    "flames.");
const u8 gMoltresPokedexTextUnused[] = _("");
const u8 gDratiniPokedexText[] = _(
    "Long considered a mythical POKéMON\n"
    "until recently, when a small colony\n"
    "was found living underwater.");
const u8 gDratiniPokedexTextUnused[] = _("");
const u8 gDragonairPokedexText[] = _(
    "A mystical POKéMON that exudes a\n"
    "gentle aura. It is said to have the\n"
...
const u8 gMewtwoPokedexText[] = _(
    "It was created by a scientist after\n"
...
const u8 gMewPokedexText[] = _(
    ...
    "mirage by many experts. Only a few\n"
...
const u8 gTotodilePokedexText[] = _(
    "Its well-developed jaws are powerful\n"
    "and capable of crushing anything. Even\n"
    "its TRAINER must be careful.");
const u8 gTotodilePokedexTextUnused[] = _("");
const u8 gCroconawPokedexText[] = _(
    "If it loses a fang, a new one grows\n"
    "back in its place. There are always 48\n"
    "fangs lining its mouth.");
...
const u8 gLedybaPokedexText[] = _(
    ...
    "move if it is alone. But it will be\n"
    "active if it is in a group.");
const u8 gLedybaPokedexTextUnused[] = _("");
const u8 gLedianPokedexText[] = _(
    "When the stars flicker in the night\n"
...
const u8 gAriadosPokedexText[] = _(
    "It spins string not only from its rear\n"
    "but also from its mouth. It is hard to\n"
    "tell which end is which.");
const u8 gAriadosPokedexTextUnused[] = _("");
const u8 gCrobatPokedexText[] = _(
    "It flies so silently through the dark\n"
    "on its four wings that it may not be\n"
    "noticed even when nearby.");
...
const u8 gIgglybuffPokedexText[] = _(
    "It has a very soft body. If it starts\n"
    "to roll, it will bounce all over and\n"
...
const u8 gNatuPokedexText[] = _(
    ...
    "grown, it has to hop to get around. It\n"
    "is always staring at something.");
...
const u8 gAmpharosPokedexText[] = _(
    "The tail's tip shines brightly and can\n"
    "be seen from far away. It acts as a\n"
    "beacon for lost people.");
const u8 gAmpharosPokedexTextUnused[] = _("");
const u8 gBellossomPokedexText[] = _(
    "BELLOSSOM gather at times and appear\n"
    "to dance. They say that the dance is a\n"
...
const u8 gSudowoodoPokedexText[] = _(
    ...
    "tree, its composition appears to be\n"
    "closer to a rock than a plant.");
...
const u8 gSunfloraPokedexText[] = _(
    "It converts sunlight into energy. In\n"
    "the darkness after sunset, it closes\n"
    "its petals and becomes still.");
const u8 gSunfloraPokedexTextUnused[] = _("");
const u8 gYanmaPokedexText[] = _(
    "If it flaps its wings really fast, it\n"
    "can generate shock waves that will\n"
    "shatter windows in the area.");
const u8 gYanmaPokedexTextUnused[] = _("");
const u8 gWooperPokedexText[] = _(
    "This POKéMON lives in cold water. It\n"
    "will leave the water to search for\n"
    "food when it gets cold outside.");
const u8 gWooperPokedexTextUnused[] = _("");
const u8 gQuagsirePokedexText[] = _(
    "This carefree POKéMON has an easygoing\n"
    "nature. While swimming, it always\n"
    "bumps into boat hulls.");
const u8 gQuagsirePokedexTextUnused[] = _("");
const u8 gEspeonPokedexText[] = _(
    "It uses the fine hair that covers its\n"
    "body to sense air currents and predict\n"
    "its enemy's actions.");
const u8 gEspeonPokedexTextUnused[] = _("");
const u8 gUmbreonPokedexText[] = _(
    "When agitated, this POKéMON protects\n"
    "itself by spraying poisonous sweat\n"
    "from its pores.");
...
const u8 gSlowkingPokedexText[] = _(
    ...
    "intuition. Whatever the situation, it\n"
...
const u8 gUnownPokedexText[] = _(
    ...
    "ancient tablets. It is said that the\n"
...
const u8 gGligarPokedexText[] = _(
    ...
    "face, then clamps down on the startled\n"
...
const u8 gGranbullPokedexText[] = _(
    ...
    "spooked. If attacked, it flails about\n"
...
const u8 gQwilfishPokedexText[] = _(
    ...
    "inflate its body by drinking over 2.6\n"
    "gallons of water all at once.");
const u8 gQwilfishPokedexTextUnused[] = _("");
const u8 gScizorPokedexText[] = _(
    "It swings its eye-patterned pincers up\n"
    "to scare its foes. This makes it look\n"
    "like it has three heads.");
...
const u8 gHeracrossPokedexText[] = _(
    "This powerful POKéMON thrusts its\n"
    "prized horn under its enemies'\n"
...
const u8 gUrsaringPokedexText[] = _(
    "Although it is a good climber, it\n"
    "prefers to snap stout trees with its\n"
...
const u8 gPiloswinePokedexText[] = _(
    ...
    "body obscures its sight, it just keeps\n"
    "charging repeatedly.");
const u8 gPiloswinePokedexTextUnused[] = _("");
const u8 gCorsolaPokedexText[] = _(
    "It continuously sheds and grows. The\n"
    "tip of its head is prized as a\n"
...
const u8 gOctilleryPokedexText[] = _(
    "It traps enemies with its\n"
    "suction-cupped tentacles, then smashes\n"
    "them with its rock-hard head.");
const u8 gOctilleryPokedexTextUnused[] = _("");
const u8 gDelibirdPokedexText[] = _(
    "It carries food all day long. There\n"
    "are tales about lost people who were\n"
    "saved by the food it had.");
const u8 gDelibirdPokedexTextUnused[] = _("");
const u8 gMantinePokedexText[] = _(
    "As it majestically swims, it doesn't\n"
    "care if REMORAID attach to it to\n"
    "scavenge for its leftovers.");
const u8 gMantinePokedexTextUnused[] = _("");
const u8 gSkarmoryPokedexText[] = _(
    "Its sturdy wings look heavy, but its\n"
    "bones are hollow and light, allowing\n"
...
const u8 gHoundourPokedexText[] = _(
    ...
    "and for pursuing prey.");
const u8 gHoundourPokedexTextUnused[] = _("");
const u8 gHoundoomPokedexText[] = _(
    "If you are burned by the flames it\n"
    "shoots from its mouth, the pain will\n"
    "never go away.");
...
const u8 gStantlerPokedexText[] = _(
    "Its curved antlers subtly change the\n"
    "flow of air to create a strange space\n"
    "where reality is distorted.");
const u8 gStantlerPokedexTextUnused[] = _("");
const u8 gSmearglePokedexText[] = _(
    "A special fluid oozes from the tip of\n"
    "its tail. It paints the fluid\n"
    "everywhere to mark its territory.");
const u8 gSmearglePokedexTextUnused[] = _("");
const u8 gTyroguePokedexText[] = _(
    "It is always bursting with energy. To\n"
    "make itself stronger, it keeps on\n"
    "fighting even if it loses.");
...
const u8 gSmoochumPokedexText[] = _(
    "Its lips are the most sensitive parts\n"
    "on its body. It always uses its lips\n"
    "first to examine things.");
const u8 gSmoochumPokedexTextUnused[] = _("");
const u8 gElekidPokedexText[] = _(
    "It rotates its arms to generate\n"
    "electricity, but it tires easily, so\n"
...
const u8 gMiltankPokedexText[] = _(
    ...
    "making it the ultimate beverage for\n"
    "the sick or weary.");
...
const u8 gEnteiPokedexText[] = _(
    "Volcanoes erupt when it barks. Unable\n"
    "to restrain its extreme power, it\n"
...
const u8 gLarvitarPokedexText[] = _(
    ...
    "large mountain, it will fall asleep so\n"
    "it can grow.");
...
const u8 gMarieFPokedexText[] = _(
    ...
    "evolved into FLAREON. Strange that she\n"
    "evolved without FIRE STONE...");
const u8 gMarieFPokedexTextUnused[] = _("");
const u8 gGilanPokedexText[] = _(
    "One of PROF. BLACKBIRD's POKéMON. That\n"
    "brown crazy furball knows never when\n"
    "to slow down.");
const u8 gGilanPokedexTextUnused[] = _("");
const u8 gGilanGPokedexText[] = _(
    "EEVEE that PROF. BLACKBIRD gave me\n"
    "evolved into a... GLACEON? Looks like\n"
    "PROF's blue POKéMON now...");
const u8 gGilanGPokedexTextUnused[] = _("");
const u8 gEverestPokedexText[] = _(
    "One of PROF. BLACKBIRD's POKéMON. He's\n"
    "quite sleepy but very tough when he\n"
...
const u8 gGlaceonPokedexText[] = _(
    ...
    "creating\pflurries of diamond dust.");
