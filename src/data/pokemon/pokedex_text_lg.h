...
const u8 gIvysaurPokedexText[] = _(
    ...
    "it appears to lose the ability to stand\n"
    "on its hind legs.");
...
const u8 gPidgeyPokedexText[] = _(
    "A common sight in forests and woods. It\n"
    "flaps its wings at ground level to kick\n"
    "up blinding sand.");
...
const u8 gRattataPokedexText[] = _(
    ...
    "and very quick, it is a common sight in\n"
    "many places.");
...
const u8 gFearowPokedexText[] = _(
    "With its huge and magnificent wings, it\n"
    "can keep aloft without ever having to\n"
    "land for rest.");
const u8 gFearowPokedexTextUnused[] = _("");
const u8 gEkansPokedexText[] = _(
    "Moving silently and stealthily, it eats\n"
    "the eggs of birds, such as PIDGEY and\n"
    "SPEAROW, whole.");
...
const u8 gNidoranMPokedexText[] = _(
    ...
    "The larger its horns, the more powerful\n"
    "its secreted venom.");
...
const u8 gClefairyPokedexText[] = _(
    ...
    "has many admirers. It is rare and found\n"
...
const u8 gGolbatPokedexText[] = _(
    ...
    "draining energy from the victim even if\n"
    "it gets too heavy to fly.");
...
const u8 gPsyduckPokedexText[] = _(
    ...
    "vacant look, this wily POKéMON will use\n"
...
const u8 gMachopPokedexText[] = _(
    ...
    "in all styles of martial arts to become\n"
    "even stronger.");
...
const u8 gSeelPokedexText[] = _(
    ...
    "hard. It is used for bashing through\n"
    "thick icebergs.");
...
const u8 gCloysterPokedexText[] = _(
    ...
    "quick volleys. Its innards have never\n"
    "been seen.");
...
const u8 gKrabbyPokedexText[] = _(
    ...
    "weapons, they are used for balance when\n"
    "walking sideways.");
...
const u8 gVoltorbPokedexText[] = _(
    ...
    "mistaken for a POKé BALL, it has zapped\n"
    "many people.");
...
const u8 gExeggutorPokedexText[] = _(
    ...
    "of its heads will drop off and continue\n"
    "on as an EXEGGCUTE.");
...
const u8 gMarowakPokedexText[] = _(
    "The bone it holds is its key weapon. It\n"
    "throws the bone skillfully like a\n"
...
const u8 gHitmonchanPokedexText[] = _(
    ...
    "fires punches in lightning-fast volleys\n"
...
const u8 gKoffingPokedexText[] = _(
    ...
    "toxic gases in its body, it is prone to\n"
...
const u8 gRhyhornPokedexText[] = _(
    ...
    "harder than human bones. Its TACKLE can\n"
    "knock a semitrailer flying.");
...
const u8 gChanseyPokedexText[] = _(
    ...
    "to bring happiness to those who manage\n"
    "to catch one.");
...
const u8 gSeakingPokedexText[] = _(
    ...
    "be seen swimming powerfully up rivers\n"
    "and creeks.");
...
const u8 gArticunoPokedexText[] = _(
    ...
    "to appear to doomed people who are lost\n"
    "in icy mountains.");
...
const u8 gDratiniPokedexText[] = _(
    ...
    "until recently, when a small colony was\n"
...
const u8 gFurretPokedexText[] = _(
    ...
    "skinny body. The nest is impossible for\n"
    "other POKéMON to enter.");
...
const u8 gNoctowlPokedexText[] = _(
    ...
    "concentrate even faint light and enable\n"
...
const u8 gIgglybuffPokedexText[] = _(
    ...
    "to roll, it will bounce all over and be\n"
    "impossible to stop.");
...
const u8 gMarillPokedexText[] = _(
    ...
    "that is lighter than water, lets it\n"
...
const u8 gAipomPokedexText[] = _(
    "Its tail is so powerful that it can use\n"
    "it to grab a tree branch and hold\n"
...
const u8 gWooperPokedexText[] = _(
    ...
    "will leave the water to search for food\n"
...
const u8 gForretressPokedexText[] = _(
    ...
    "hard shell. What lurks inside the armor\n"
    "is a total mystery.");
...
const u8 gHeracrossPokedexText[] = _(
    ...
    "prized horn under its enemies' bellies,\n"
...
const u8 gTeddiursaPokedexText[] = _(
    ...
    "glows. It always licks its paws because\n"
...
const u8 gMagcargoPokedexText[] = _(
    ...
    "has cooled and hardened. It breaks\n"
    "easily with a slight touch.");
...
const u8 gSkarmoryPokedexText[] = _(
    ...
    "bones are hollow and light, allowing it\n"
...
const u8 gPhanpyPokedexText[] = _(
    ...
    "playfully, but because it is so strong,\n"
...
const u8 gMiltankPokedexText[] = _(
    ...
    "making it the ultimate beverage for the\n"
    "sick or weary.");
...
const u8 gEnteiPokedexText[] = _(
    ...
    "to restrain its extreme power, it races\n"
...
const u8 gPupitarPokedexText[] = _(
    "Its shell is as hard as sheet rock, and\n"
    "it is also very strong. Its THRASHING\n"
...
const u8 gCelebiPokedexText[] = _(
    "This POKéMON wanders across time. Grass\n"
...
const u8 gDeoxysPokedexText[] = _(
    ...
    "appears. It absorbs attacks by altering\n"
...
const u8 gMariePokedexText[] = _(
    "One of PROF. BLACKBIRD's POKéMON. She's\n"
    "quite hardy and when bites it's somehow\n"
    "more painful.");
...
const u8 gGilanPokedexText[] = _(
    ...
    "brown crazy furball knows never when to\n"
    "slow down.");
