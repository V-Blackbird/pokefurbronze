...
const u8 gIvysaurPokedexText[] = _(
    "There is a plant bulb on its back. When"\n
    "it absorbs nutrients, the bulb is said"\n
...
const u8 gCharmanderPokedexText[] = _(
    ...
    "at the tip of its tail. Its life would"\n
    "end if the flame were to go out.");
...
const u8 gCaterpiePokedexText[] = _(
    ...
    "itself with silk, and becomes a cocoon.");
...
const u8 gPidgeottoPokedexText[] = _(
    ...
    "developed. It can carry prey such as an"\n
    "EXEGGCUTE to its nest over 60 miles"\n
    "away.");
...
const u8 gPidgeotPokedexText[] = _(
    ...
    "intimidate enemies. It races through"\n
    "the skies at Mach-2 speed.");

const u8 gPidgeotPokedexTextUnused[] = _("");

const u8 gRattataPokedexText[] = _(
    "Its fangs are long and very sharp. They"\n
    "grow continuously, so it gnaws on hard"\n
    "things to whittle them down.");
...
const u8 gFearowPokedexText[] = _(
    "Its huge and magnificent wings can keep"\n
    "it aloft in the sky. It can remain"\n
    "flying a whole day without landing.");
...
const u8 gArbokPokedexText[] = _(
    ...
    "a frightening face. Weak foes will flee"\n
    "just at the sight of the pattern.");
...
const u8 gRaichuPokedexText[] = _(
    ...
    "cause even an Indian elephant to faint.");
...
const u8 gNidorinaPokedexText[] = _(
    ...
    "emits ultrasonic cries that have the"\n
...
const u8 gNidoqueenPokedexText[] = _(
    ...
    "like scales. If it becomes excited, the"\n
    "needles bristle outwards.");
...
const u8 gGolbatPokedexText[] = _(
    ...
    "sharp fangs and drains over 10 ounces"\n
...
const u8 gOddishPokedexText[] = _(
    ...
    "Wanderus.” At night, it is said to walk"\n
    "nearly 1,000 feet on its two roots.");
...
const u8 gVileplumePokedexText[] = _(
    ...
    "allergy-causing pollen from its petals.");
...
const u8 gPersianPokedexText[] = _(
    ...
    "raises its tail straight up. It is a"\n
    "signal that it is about to pounce and"\n
    "bite.");
...
const u8 gPsyduckPokedexText[] = _(
    ...
    "When the headache turns intense, it"\n
    "begins using mysterious powers.");
...
const u8 gMankeyPokedexText[] = _(
    ...
    "ferocious in temperament. When angered,"\n
    "it flies into an uncontrollable frenzy.");
...
const u8 gBellsproutPokedexText[] = _(
    ...
    "Because of the bud, it is rumored to be"\n
    "a type of legendary mandrake plant.");
...
const u8 gPonytaPokedexText[] = _(
    ...
    "incredibly powerful. It can clear Ayers"\n
    "Rock in one leap.");
...
const u8 gSlowbroPokedexText[] = _(
    ...
    "sea, its tail was bitten by a SHELLDER."\n
    "That made it evolve into SLOWBRO.");
...
const u8 gFarfetchdPokedexText[] = _(
    ...
    "stalk clamped in its beak. The stalk is"\n
    "used for building its nest.");
...
const u8 gKrabbyPokedexText[] = _(
    ...
    "pincers grow back if they are torn out"\n
    "of their sockets.");
...
const u8 gKoffingPokedexText[] = _(
    ...
    "by horribly toxic gases. It reeks when"\n
    "it is nearby.");
...
const u8 gGoldeenPokedexText[] = _(
    ...
    "strongly developed like muscles. It can"\n
    "swim at a speed of five knots.");
...
const u8 gMagmarPokedexText[] = _(
    "Found near the mouth of a volcano. This"\n
    "fire-breather's body temperature is"\n
...
const u8 gTaurosPokedexText[] = _(
    ...
    "its body repeatedly with its three long"\n
    "tails.");
...
const u8 gMagikarpPokedexText[] = _(
    ...
    "weak and pathetic POKéMON in the world.");
...
const u8 gVaporeonPokedexText[] = _(
    ...
    "similar to the molecular composition of"\n
    "water. It can melt invisibly in water.");
...
const u8 gOmanytePokedexText[] = _(
    ...
    "primordial sea, it swims by twisting"\n
    "its 10 tentacles about.");
...
const u8 gSnorlaxPokedexText[] = _(
    ...
    "880 pounds of food every day. When it"\n
    "is done eating, it goes promptly to"\n
    "sleep.");

const u8 gSnorlaxPokedexTextUnused[] = _("");

const u8 gArticunoPokedexText[] = _(
    "One of the legendary bird POKéMON. With"\n
    "its long tail trailing behind, its"\n
...
const u8 gDragonitePokedexText[] = _(
    ...
    "bulky physique. It circles the globe in"\n
    "just 16 hours.");
...
const u8 gChikoritaPokedexText[] = _(
    ...
    "temperature. A spicy aroma emanates"\n
    "from around its neck. The aroma acts as"\n
    "a stimulant to restore health.");
...
const u8 gCyndaquilPokedexText[] = _(
    ...
    "angry or surprised, it shoots flames"\n
    "out of its back.");
...
const u8 gLanturnPokedexText[] = _(
    ...
    "light, then swallows the immobilized"\n
    "prey in a single gulp.");

const u8 gLanturnPokedexTextUnused[] = _("");

const u8 gPichuPokedexText[] = _(
    "Despite its small size, it can zap even"\n
    "adult humans. However, if it does so,"\n
    "it also surprises itself.");
...
const u8 gYanmaPokedexText[] = _(
    ...
    "looks in all directions to seek out"\n
    "insects as its prey.");
...
const u8 gSlowkingPokedexText[] = _(
    ...
    "entered SLOWPOKE's head and unlocked an"\n
    "extraordinary power.");
...
const u8 gMisdreavusPokedexText[] = _(
    ...
    "from behind without warning, just to"\n
    "see their shocked reactions.");
...
const u8 gWobbuffetPokedexText[] = _(
    ...
    "lives quietly in the darkness. It is"\n
    "never first to attack.");
...
const u8 gSteelixPokedexText[] = _(
    ...
    "over 100 years, its composition changes"\n
    "to become diamond-like.");
...
const u8 gSneaselPokedexText[] = _(
    ...
    "from their nests and feasts on the eggs"\n
...
const u8 gCorsolaPokedexText[] = _(
    ...
    "in communities that are built on groups"\n
    "of these POKéMON.");
...
const u8 gOctilleryPokedexText[] = _(
    ...
    "holes. If it gets sleepy, it steals the"\n
    "nest of a fellow OCTILLERY.");
...
const u8 gMantinePokedexText[] = _(
    ...
    "fly out of the water and over the waves"\n
    "if it builds up enough speed.");
...
const u8 gTyranitarPokedexText[] = _(
    ...
    "impudent nature. Having great strength,"\n
    "it can even change surrounding"\n
    "landforms. It is said to be the"\n
    "guardian of the seas. It is rumored to"\n
    "have been seen on the night of a storm.");
...
const u8 gSwampertPokedexText[] = _(
    ...
    "they can batter down its foe. It makes"\n
...
const u8 gLinoonePokedexText[] = _(
    "When running in a straight line, it can"\n
    "top 60 miles per hour. However, it has"\n
...
const u8 gDustoxPokedexText[] = _(
    ...
    "senses danger. They tend to gather in"\n
    "the glow of streetlamps at night.");
...
const u8 gPelipperPokedexText[] = _(
    ...
    "small POKéMON in its beak. It bobs on"\n
    "the waves to rest its wings.");
...
const u8 gGardevoirPokedexText[] = _(
    ...
    "Its power peaks when it is protecting"\n
    "its TRAINER.");
...
const u8 gNinjaskPokedexText[] = _(
    ...
    "be able to avoid any attack. It loves"\n
    "to feed on tree sap.");
...
const u8 gLoudredPokedexText[] = _(
    ...
    "generates ultrasonic waves that can"\n
    "blow apart a house.");
...
const u8 gHariyamaPokedexText[] = _(
    ...
    "It can send a 10-ton truck flying with"\n
    "a straight-arm punch.");

const u8 gHariyamaPokedexTextUnused[] = _("");

const u8 gAzurillPokedexText[] = _(
    "It battles by flinging around its tail,"\n
    "which is bigger than its body. The tail"\n
    "is a flotation device in water.");
...
const u8 gMawilePokedexText[] = _(
    ...
    "foes into complacency, then bites with"\n
...
const u8 gElectrikePokedexText[] = _(
    ...
    "for discharging. It gives off sparks if"\n
    "a storm approaches.");
...
const u8 gWailordPokedexText[] = _(
    ...
    "It herds prey in a pack then swallows"\n
    "the massed prey in one gulp.");
...
const u8 gSolrockPokedexText[] = _(
    ...
    "Always expressionless, it can sense"\n
    "what its foe is thinking.");
...
const u8 gFeebasPokedexText[] = _(
    "Ridiculed for its shabby appearance, it"\n
    "is ignored by researchers. It lives in"\n
...
const u8 gKecleonPokedexText[] = _(
    ...
    "its surroundings. It also changes color"\n
...
const u8 gDusclopsPokedexText[] = _(
    ...
    "opens its mouth, it sucks everything in"\n
...
const u8 gWynautPokedexText[] = _(
    ...
    "They cluster in a tight group to sleep"\n
    "in a cave.");
...
const u8 gSphealPokedexText[] = _(
    ...
    "fur keeps it from feeling cold while it"\n
    "is rolling on ice.");
...
const u8 gClamperlPokedexText[] = _(
    "It is protected by a sturdy shell. Once"\n
    "in a lifetime, it makes a magnificent"\n
    "pearl.");
...
const u8 gHuntailPokedexText[] = _(
    ...
    "ever filters down. It lights up its"\n
    "small fishlike tail to attract prey.");
...
const u8 gRelicanthPokedexText[] = _(
    ...
    "million years. It was discovered during"\n
...
const u8 gRegicePokedexText[] = _(
    ...
    "of the same kind of ice that is found"\n
    "at the South Pole.");
...
const u8 gKyogrePokedexText[] = _(
    ...
    "the sea by bringing heavy rains. It has"\n
...
const u8 gRayquazaPokedexText[] = _(
    ...
    "of years in the ozone layer. Its flying"\n
    "form looks like a meteor.");
...
const u8 gVillPokedexText[] = _(
    "PROF. BLACKBIRD said that this ICE type"\n
    "POKéMON evolved from EEVEE in Sinnoh."\n
    "Strange.");
...
const u8 gMarieFPokedexText[] = _(
    ...
    "BLACKBIRD gave to me. Now it's my warm,"\n
    "fluffy FLAREON!");
