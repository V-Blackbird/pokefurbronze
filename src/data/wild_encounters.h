...
const struct WildPokemon gKailoTown_LandMons[] =
{
    ...
    { 2, 7, SPECIES_PIDGEY },
    { 2, 7, SPECIES_RATTATA },
    { 2, 7, SPECIES_NIDORAN_F },
    { 2, 7, SPECIES_NIDORAN_M },
    { 2, 7, SPECIES_NIDORAN_F },
    { 2, 7, SPECIES_NIDORAN_M },
...
const struct WildPokemonHeader gWildMonHeaders[] =
{
...
#endif
    {
        .mapGroup = MAP_GROUP(KAILO_TOWN),
        .mapNum = MAP_NUM(KAILO_TOWN),
    ...
    {
        .mapGroup = MAP_GROUP(DYERS_TUNNEL),
        .mapNum = MAP_NUM(DYERS_TUNNEL),
