...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT - BATTLESTRINGS_TABLE_START] = {
    ...
    [STRINGID_STARTERPKMNFLED - BATTLESTRINGS_TABLE_START]               = sText_StarterPkmnFled,
    ...
    [STRINGID_PLAYERUSED - BATTLESTRINGS_TABLE_START]                    = sText_PlayerUsed,
    [STRINGID_WAITEDFORTHAT - BATTLESTRINGS_TABLE_START]                 = sText_WaitedForThat
};
    ...
    *(&gBattleStruct->stringMoveType) = sBattleMsgDataPtr->moveType;
    ...
    case STRINGID_INTROMSG: // first battle msg
        ...
        else
        {
            ...
            else if (gBattleTypeFlags & BATTLE_TYPE_STARTER)
                stringPtr = sText_WildPkmnAppearedPause;
            else
