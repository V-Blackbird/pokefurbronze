...
#define KANTO_TO_NATIONAL(name)     NATIONAL_DEX_##name
...
// In FireRed/LeafGreen, Kanto Dex entries map 1:1 to the first 151 National Dex entries
...
// Returns the variant number for Fabular Pokemon that are variants of existing species
// Returns 0 for non-variant Pokemon
