...
u8 FldEff_ExclamationMarkIcon1(void)
{
    ...
    LoadObjectEventPalette(0x1100); //LoadObjectEventPalette(OBJ_EVENT_PAL_TAG_PLAYER_RED)
...
u8 FldEff_DoubleExclMarkIcon(void)
{
    ...
    LoadObjectEventPalette(0x1100); //LoadObjectEventPalette(OBJ_EVENT_PAL_TAG_RED)
    UpdatePaletteGammaType(IndexOfSpritePaletteTag(0x1100), GAMMA_ALT);
    UpdateSpritePaletteWithWeather(IndexOfSpritePaletteTag(0x1100));
