...
static void HandleInputChooseAction(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        if (gBattleTypeFlags & BATTLE_TYPE_STARTER)
        // Handle starter battle actions
        {
            PlaySE(SE_SELECT);
            ...
            {
            case 0:
                BtlController_EmitTwoReturnValues(1, B_ACTION_STARTER_USE_MOVE, 0);
                break;
            case 1:
                BtlController_EmitTwoReturnValues(1, B_ACTION_USE_ITEM, 0);
                break;
            case 2:
                BtlController_EmitTwoReturnValues(1, B_ACTION_STARTER_SWITCH, 0);
                break;
            case 3:
                BtlController_EmitTwoReturnValues(1, B_ACTION_STARTER_RUN, 0);
                break;
            }
            OakOldManBufferExecCompleted();
        }
...
static void OakOldManHandlePrintString(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_STARTER && *stringId == 1)
    {
        OakOldManBufferExecCompleted();
    }
    else
