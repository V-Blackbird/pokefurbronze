...
const u8 gText_PokemonHabitats[] = _("{PKMN} HABITATS");
const u8 gText_DexCategory_GrasslandPkmn[] = _("MEADOW");
const u8 gText_DexCategory_ForestPkmn[] = _("FOREST");
const u8 gText_DexCategory_WatersEdgePkmn[] = _("LAKE");
const u8 gText_DexCategory_SeaPkmn[] = _("SEA");
const u8 gText_DexCategory_CavePkmn[] = _("CAVE");
const u8 gText_DexCategory_MountainPkmn[] = _("MOUNTAIN");
const u8 gText_DexCategory_RoughTerrainPkmn[] = _("TERRAIN");
const u8 gText_DexCategory_UrbanPkmn[] = _("URBAN");
const u8 gText_DexCategory_RarePkmn[] = _("RARE");
const u8 gText_Search[] = _("SEARCH");
const u8 gText_NumericalMode[] = _("NUMERICAL MODE");
const u8 gText_AToZMode[] = _("A TO Z");
const u8 gText_PokedexOther[] = _("OTHER");
const u8 gTextJP_HowToUsePokedex[] = _("ずかんの つかいかた");
const u8 gText_ClosePokedex[] = _("CLOSE POKéDEX");
const u8 gText_TypeMode[] = _("BY TYPE");
const u8 gText_LightestMode[] = _("BY WEIGHT");
const u8 gText_SmallestMode[] = _("BY SIZE");
const u8 gText_PokemonList[] = _("{PKMN} LIST");
const u8 gText_NumericalModeKanto[] = _("KANTO {PKMN}");
const u8 gText_NumericalModeNational[] = _("NATIONAL {PKMN}");
const u8 gText_PokemonListNoColor[] = _("POKéMON DeX '80");
