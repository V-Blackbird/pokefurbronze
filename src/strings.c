...
const u8 gText_PokemonHabitats[] = _("POKéMON HABITATS");
...
const u8 gText_LightestMode[] = _("WEIGHTMODE");
const u8 gText_SmallestMode[] = _("SIZE MODE");
const u8 gText_PokemonList[] = _("POKéMON LIST");
const u8 gText_NumericalModeKanto[] = _("KANTO");
const u8 gText_NumericalModeNational[] = _("NATIONAL");
