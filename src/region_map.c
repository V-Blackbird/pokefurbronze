...
static const u8 sMapFlyDestinations[][3] = {
    ...
    [MAPSEC_KAILO_TOWN          - MAPSECS_KANTO] = {MAP(MAP_KAILO_TOWN),                            SPAWN_KAILO_TOWN},
    [MAPSEC_DYERS_TUNNEL        - MAPSECS_KANTO] = {MAP(MAP_DYERS_TUNNEL),                          0},
};
...
static void InitRegionMapType(void)
{
    ...
    j = REGIONMAP_KANTO;
    if (gMapHeader.regionMapSectionId >= MAPSECS_SEVII_123 && gMapHeader.regionMapSectionId <= MAPSECS_SEVII_123)
    {
