...
static const u8 sMapFlyDestinations[][3] = {
    ...
    [MAPSEC_KAILO_TOWN          - KANTO_MAPSEC_START] = {MAP(MAP_KAILO_TOWN),                            HEAL_LOCATION_KAILO_TOWN},
    [MAPSEC_DYERS_TUNNEL        - KANTO_MAPSEC_START] = {MAP(MAP_DYERS_TUNNEL),                          HEAL_LOCATION_NONE},
};
...
static void InitRegionMapType(void)
{
    ...
    j = REGIONMAP_KANTO;
    if (gMapHeader.regionMapSectionId >= SEVII_MAPSEC_START && gMapHeader.regionMapSectionId <= SEVII_MAPSEC_START)
    {
...
static u8 GetDungeonMapsecType(u8 mapsec)
{
    ...
    case MAPSEC_DYERS_TUNNEL:
        return FlagGet(FLAG_WORLD_MAP_DYERS_TUNNEL) ? MAPSECTYPE_VISITED : MAPSECTYPE_NOT_VISITED;
    default:
        return MAPSECTYPE_ROUTE;
    }
}
