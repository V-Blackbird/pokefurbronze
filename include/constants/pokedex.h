...
enum {
    ...
    //Fabular (starts at 656 for Gen 5 compatibility and performance, reserves 650-655 for future additions)
    NATIONAL_DEX_VILL = 656,
    NATIONAL_DEX_MARIE,
    NATIONAL_DEX_MARIEF,
    NATIONAL_DEX_GILAN,
    NATIONAL_DEX_GILANG,
...
#define NATIONAL_DEX_COUNT  NATIONAL_DEX_EVERESTL
...
enum {
    ...
    KANTO_DEX_DITTO,
    KANTO_DEX_EEVEE,
    KANTO_DEX_MARIE,        // 133.1
    KANTO_DEX_GILAN,        // 133.2
    KANTO_DEX_EVEREST,      // 133.3
    KANTO_DEX_VAPOREON,
    KANTO_DEX_JOLTEON,
    KANTO_DEX_FLAREON,
    KANTO_DEX_MARIEF,       // 136.1
    KANTO_DEX_PORYGON,
    KANTO_DEX_OMANYTE,
    KANTO_DEX_OMASTAR,
    KANTO_DEX_KABUTO,
    ...
    KANTO_DEX_MEWTWO,
    KANTO_DEX_MEW,
    KANTO_DEX_LEAFEON,      // 470
    KANTO_DEX_EVERESTL,     // 470.1
    KANTO_DEX_GLACEON,      // 471
    KANTO_DEX_VILL,         // 471.1
    KANTO_DEX_GILANG,       // 471.2
};

#define KANTO_DEX_COUNT KANTO_DEX_GILANG
